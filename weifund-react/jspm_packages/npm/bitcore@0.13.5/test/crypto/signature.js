...
(function(Buffer) {
  ...
  var sig_canonical = require('../data/bitcoind/sig_canonical.json!systemjs-json');
  var sig_noncanonical = require('../data/bitcoind/sig_noncanonical.json!systemjs-json');
  describe('Signature', function() {
    ...
    describe('#set', function() {
      ...
      it('should set nhashtype', function() {
        var sig = Signature().set({nhashtype: Signature.SIGHASH_ALL});
        sig.nhashtype.should.equal(Signature.SIGHASH_ALL);
        sig.set({nhashtype: Signature.SIGHASH_ALL | Signature.SIGHASH_ANYONECANPAY});
    ...
    describe('#fromCompact', function() {
      it('should create a signature from a compressed signature', function() {
        ...
        blank.fill(0);
        var compressed = Buffer.concat([new Buffer([0 + 27 + 4]), blank, blank]);
      ...
      it('should create a signature from an uncompressed signature', function() {
        var sigHexaStr = '1cd5e61ab5bfd0d1450997894cb1a53e917f89d82eb43f06fa96f32c96e061aec12fc1188e8b' + '0dc553a2588be2b5b68dbbd7f092894aa3397786e9c769c5348dc6';
    ...
    describe('#toTxFormat', function() {
      it('should parse this known signature and rebuild it with updated zero-padded sighash types', function() {
        ...
        sig.set({nhashtype: Signature.SIGHASH_SINGLE});
    ...
    describe('#hasDefinedHashtype', function() {
      it('should reject invalid sighash types and accept valid ones', function() {
        ...
        var testCases = [[undefined, false], [null, false], [0, false], [1.1, false], [-1, false], [-1.1, false], ['', false], ['1', false], [Signature.SIGHASH_ANYONECANPAY, false], [Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_ALL, true], [Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_NONE, true], [Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_SINGLE, true], [Signature.SIGHASH_ALL, true], [Signature.SIGHASH_NONE, true], [Signature.SIGHASH_SINGLE, true], [Signature.SIGHASH_SINGLE + 1, false], [(Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_SINGLE) + 1, false], [(Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_ALL) - 1, false]];
