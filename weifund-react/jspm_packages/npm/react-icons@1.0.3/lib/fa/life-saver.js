...
var FaLifeSaver = (function (_React$Component) {
    _inherits(FaLifeSaver, _React$Component);

    function FaLifeSaver() {
        _classCallCheck(this, FaLifeSaver);

        _React$Component.apply(this, arguments);
    }

    FaLifeSaver.prototype.render = function render() {
