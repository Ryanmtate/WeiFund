...
var FaInstitution = (function (_React$Component) {
    _inherits(FaInstitution, _React$Component);

    function FaInstitution() {
        _classCallCheck(this, FaInstitution);

        _React$Component.apply(this, arguments);
    }

    FaInstitution.prototype.render = function render() {
