...
var GoOcticonPersonFollow = (function (_React$Component) {
    _inherits(GoOcticonPersonFollow, _React$Component);

    function GoOcticonPersonFollow() {
        _classCallCheck(this, GoOcticonPersonFollow);

        _React$Component.apply(this, arguments);
    }

    GoOcticonPersonFollow.prototype.render = function render() {
    ...
    return GoOcticonPersonFollow;
})(React.Component);

exports['default'] = GoOcticonPersonFollow;
