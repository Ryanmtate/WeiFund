...
var GoOcticonGitPullRequestAbandoned = (function (_React$Component) {
    _inherits(GoOcticonGitPullRequestAbandoned, _React$Component);

    function GoOcticonGitPullRequestAbandoned() {
        _classCallCheck(this, GoOcticonGitPullRequestAbandoned);

        _React$Component.apply(this, arguments);
    }

    GoOcticonGitPullRequestAbandoned.prototype.render = function render() {
    ...
    return GoOcticonGitPullRequestAbandoned;
})(React.Component);

exports['default'] = GoOcticonGitPullRequestAbandoned;
