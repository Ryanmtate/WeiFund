...
var GoOcticonRadioTower = (function (_React$Component) {
    _inherits(GoOcticonRadioTower, _React$Component);

    function GoOcticonRadioTower() {
        _classCallCheck(this, GoOcticonRadioTower);

        _React$Component.apply(this, arguments);
    }

    GoOcticonRadioTower.prototype.render = function render() {
