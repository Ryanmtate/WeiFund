...
var GoOcticonSearchSave = (function (_React$Component) {
    _inherits(GoOcticonSearchSave, _React$Component);

    function GoOcticonSearchSave() {
        _classCallCheck(this, GoOcticonSearchSave);

        _React$Component.apply(this, arguments);
    }

    GoOcticonSearchSave.prototype.render = function render() {
    ...
    return GoOcticonSearchSave;
})(React.Component);

exports['default'] = GoOcticonSearchSave;
