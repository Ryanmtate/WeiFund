...
!function(e) {
  ...
  function n(e) {
    function a(e, n) {
      ...
      if (null != n && H(n, 2, 64, M, "base")) {
        if (n = 0 | n, s = e + "", 10 == n)
          return f = new a(e instanceof a ? e : s), U(f, P + f.e + 1, k);
        if ((o = "number" == typeof e) && 0 * e != 0 || !new RegExp("^-?" + (t = "[" + O.slice(0, n) + "]+") + "(?:\\." + t + ")?$", 37 > n ? "i" : "").test(s))
          return g(f, s, o, n);
      ...
      for (u = s.length; 48 === s.charCodeAt(--u); )
        ;
      if (s = s.slice(i, u + 1))
        if (u = s.length, o && j && u > 15 && L(M, b, f.s * e), r = r - i - 1, r > z)
          f.c = f.e = null;
        else if (G > r)
          f.c = [f.e = 0];
        else {
    ...
    function D(e, n, t, i) {
      ...
      if (!g[0])
        return "0";
      if (0 > d ? --u : (h.c = g, h.e = u, h.s = i, h = C(h, p, m, w, n), g = h.c, c = h.r, u = h.e), o = u + m + 1, d = g[o], f = n / 2, c = c || 0 > o || null != g[o + 1], c = 4 > w ? (null != d || c) && (0 == w || w == (h.s < 0 ? 3 : 2)) : d > f || d == f && (4 == w || c || 6 == w && 1 & g[o - 1] || w == (h.s < 0 ? 8 : 7)), 1 > o || !g[0])
        e = c ? l("1", -m) : "0";
      else {
        if (g.length = o, c)
          for (--n; ++g[--o] > n; )
    ...
    function _(e, n, t, i) {
      var o,
          ...
          c,
          h;
      if (t = null != t && H(t, 0, 8, i, v) ? 0 | t : k, !e.c)
        return e.toString();
      if (o = e.c[0], s = e.e, null == n)
        h = r(e.c), h = 19 == i || 24 == i && B >= s ? f(h, s) : l(h, s);
      ...
      if (a) {
        e: {
          for (i = 1, s = a[0]; s >= 10; s /= 10, i++)
            ;
          if (o = n - i, 0 > o)
            o += y, u = n, f = a[l = 0], c = f / h[i - u - 1] % 10 | 0;
          ...
          if (r = r || 0 > n || null != a[l + 1] || (0 > u ? f : f % h[i - u - 1]), r = 4 > t ? (c || r) && (0 == t || t == (e.s < 0 ? 3 : 2)) : c > 5 || 5 == c && (4 == t || r || 6 == t && (o > 0 ? u > 0 ? f / h[i - u] : 0 : a[l - 1]) % 10 & 1 || t == (e.s < 0 ? 8 : 7)), 1 > n || !a[0])
            return a.length = 0, r ? (n -= e.e + 1, a[0] = h[n % y], e.e = -n || 0) : a[0] = e.e = 0, e;
    ...
    return a.another = n, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.EUCLID = 9, a.config = function() {
      ...
      return function(i, o, u, s, f) {
        var l,
            ...
            L = o.c;
        if (!(I && I[0] && L && L[0]))
          return new a(i.s && o.s && (I ? !L || I[0] != L[0] : L) ? I && 0 == I[0] || !L ? 0 * F : F / 0 : 0 / 0);
        ...
        if (L[h] > (I[h] || 0) && c--, 0 > F)
          ...
          do {
            if (p = 0, l = n(L, O, _, S), 0 > l) {
              if (R = O[0], _ != S && (R = R * f + (O[1] || 0)), p = m(R / D), p > 1 ? (p >= f && (p = f - 1), d = e(L, p, f), w = d.length, S = O.length, l = n(d, O, w, S), 1 == l && (p--, r(d, w > _ ? x : L, w, f))) : (0 == p && (l = p = 1), d = L.slice()), w = d.length, S > w && d.unshift(0), r(O, d, S, f), S = O.length, -1 == l)
                for (; (l = n(L, O, _, S)) < 1; )
                  p++, r(O, S > _ ? x : L, S, f), S = O.length;
            } else
              0 === l && (p++, O = [0]);
            b[h++] = p, l && O[0] ? O[S++] = I[A] || 0 : (O = [I[A]], S = 1);
      ...
      if (!l || !c) {
        if (!h || !g)
          return h ? (e.s = -n, e) : new a(g ? s : 0 / 0);
        if (!h[0] || !g[0])
          return g[0] ? (e.s = -n, e) : new a(h[0] ? s : 3 == k ? -0 : 0);
      }
      ...
      var n,
          ...
          r = this,
          i = r.c;
      if (null != e && e !== !!e && 1 !== e && 0 !== e && (j && L(13, "argument" + w, e), e != !!e && (e = null)), !i)
        return null;
      ...
      var e,
          ...
          g = new a("0.5");
      if (1 !== l || !f || !f[0])
        return new a(!l || 0 > l && (!f || f[0]) ? 0 / 0 : f ? s : 1 / 0);
      ...
      if (!(O && S && O[0] && S[0]))
        return !b.s || !e.s || O && !O[0] && !S || S && !S[0] && !O ? e.c = e.e = e.s = null : (e.s *= b.s, O && S ? (e.c = [0], e.e = 0) : e.c = e.e = null), e;
      ...
      for (w = N, v = A, o = g; --o >= 0; ) {
        for (r = 0, p = S[o] % v, d = S[o] / v | 0, s = l, u = o + s; u > o; )
          c = O[--s] % v, h = O[s] / v | 0, f = d * c + h * p, c = p * c + f % v * v + m[u] + r, r = (c / w | 0) + (f / v | 0) + d * h, m[u--] = c % w;
        m[u] = r;
      }
      ...
      var n,
          ...
          m = t = new a(q),
          w = f = new a(q);
      if (null != e && (j = !1, s = new a(e), j = h, (!(h = s.isInt()) || s.lt(q)) && (j && L(22, "max denominator " + (h ? "out of range" : "not an integer"), e), e = !h && s.c && U(s, s.e + 1, 1).gte(q) ? s : null)), !p)
        return g.toString();
      ...
      var n,
          ...
          r = m(0 > e ? -e : +e),
          i = this;
      if (!H(e, -S, S, 23, "exponent") && (!isFinite(e) || r > S && (e /= 0) || parseFloat(e) != e && !(e = 0 / 0)))
        return new a(Math.pow(+i, e));
  ...
  function s(e, n, t) {
    for (var r,
      ...
      for (i = o.length; i--; o[i] *= n)
        ;
      for (o[r = 0] += O.indexOf(e.charAt(u++)); r < o.length; r++)
  ...
  var a,
      ...
      A = 1e7,
      E = 1e9;
  if (a = n(), "function" == typeof define && define.amd)
    define(function() {
      return a;
    });
