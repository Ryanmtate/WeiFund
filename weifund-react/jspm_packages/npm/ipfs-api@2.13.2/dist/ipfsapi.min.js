...
(function(Buffer, process) {
  var ipfsAPI = function(modules) {
    ...
    return __webpack_require__.m = modules, __webpack_require__.c = installedModules, __webpack_require__.p = "/_karma_webpack_//", __webpack_require__(0);
    ...
    (function(Buffer) {
      ...
      function IpfsAPI(host_or_multiaddr, port, opts) {
        ...
        try {
          ...
          config.host = maddr.address, config.port = maddr.port;
        } catch (e) {
          "string" == typeof host_or_multiaddr && (config.host = host_or_multiaddr, config.port = port && "object" !== ("undefined" == typeof port ? "undefined" : (0, _typeof3["default"])(port)) ? port : config.port);
        }
        for (var lastIndex = arguments.length; !opts && lastIndex-- > 0 && !(opts = arguments[lastIndex]); )
          ;
        if ((0, _assign2["default"])(config, opts), !config.host && "undefined" != typeof window) {
          var split = window.location.host.split(":");
          config.host = split[0], config.port = split[1];
        }
        var requestAPI = getRequestAPI(config),
            cmds = loadCommands(requestAPI);
        return cmds.send = requestAPI, cmds.Buffer = Buffer, cmds;
      }
      var _assign = __webpack_require__(149),
          _assign2 = _interopRequireDefault(_assign),
          _typeof2 = __webpack_require__(19),
          _typeof3 = _interopRequireDefault(_typeof2),
          multiaddr = __webpack_require__(269),
          loadCommands = __webpack_require__(146),
          getConfig = __webpack_require__(144),
          getRequestAPI = __webpack_require__(147);
    ...
    (function(Buffer, global) {
      ...
      function utf16leSlice(buf, start, end) {
        for (var bytes = buf.slice(start, end),
            res = "",
      ...
      var base64 = __webpack_require__(158),
          ieee754 = __webpack_require__(237),
      ...
      Buffer.TYPED_ARRAY_SUPPORT = void 0 !== global.TYPED_ARRAY_SUPPORT ? global.TYPED_ARRAY_SUPPORT : typedArraySupport(), Buffer.TYPED_ARRAY_SUPPORT ? (Buffer.prototype.__proto__ = Uint8Array.prototype, Buffer.__proto__ = Uint8Array) : (Buffer.prototype.length = void 0, Buffer.prototype.parent = void 0), Buffer.isBuffer = function(b) {
        ...
        for (var x = a.length,
            y = b.length,
            i = 0,
            len = Math.min(x, y); len > i && a[i] === b[i]; )
          ++i;
        ...
        function arrayIndexOf(arr, val, byteOffset) {
          for (var foundIndex = -1,
              i = 0; byteOffset + i < arr.length; i++)
            if (arr[byteOffset + i] === val[-1 === foundIndex ? 0 : i - foundIndex]) {
              if (-1 === foundIndex && (foundIndex = i), i - foundIndex + 1 === val.length)
                return byteOffset + foundIndex;
            } else
              foundIndex = -1;
          return -1;
        }
        if (byteOffset > 2147483647 ? byteOffset = 2147483647 : -2147483648 > byteOffset && (byteOffset = -2147483648), byteOffset >>= 0, 0 === this.length)
          return -1;
        if (byteOffset >= this.length)
          return -1;
        if (0 > byteOffset && (byteOffset = Math.max(this.length + byteOffset, 0)), "string" == typeof val)
          return 0 === val.length ? -1 : String.prototype.indexOf.call(this, val, byteOffset);
        if (Buffer.isBuffer(val))
          return arrayIndexOf(this, val, byteOffset);
        if ("number" == typeof val)
          return Buffer.TYPED_ARRAY_SUPPORT && "function" === Uint8Array.prototype.indexOf ? Uint8Array.prototype.indexOf.call(this, val, byteOffset) : arrayIndexOf(this, [val], byteOffset);
      ...
      Buffer.prototype.slice = function(start, end) {
        ...
        for (var val = this[offset],
            mul = 1,
            i = 0; ++i < byteLength && (mul *= 256); )
          val += this[offset + i] * mul;
        return val;
      }, Buffer.prototype.readUIntBE = function(offset, byteLength, noAssert) {
        offset = 0 | offset, byteLength = 0 | byteLength, noAssert || checkOffset(offset, byteLength, this.length);
        for (var val = this[offset + --byteLength],
            mul = 1; byteLength > 0 && (mul *= 256); )
        ...
        if (value || (value = 0), start || (start = 0), end || (end = this.length), start > end)
        ...
        if ("undefined" != typeof Uint8Array) {
          ...
          for (var buf = new Uint8Array(this.length),
              i = 0,
              len = buf.length; len > i; i += 1)
            buf[i] = this[i];
          return buf.buffer;
        }
    ...
    inherits(Stream, EE), Stream.Readable = __webpack_require__(294), Stream.Writable = __webpack_require__(296), Stream.Duplex = __webpack_require__(292), Stream.Transform = __webpack_require__(295), Stream.PassThrough = __webpack_require__(293), Stream.Stream = Stream, Stream.prototype.pipe = function(dest, options) {
    ...
    "function" == typeof Object.create ? module.exports = function(ctor, superCtor) {
      ctor.super_ = superCtor, ctor.prototype = Object.create(superCtor.prototype, {constructor: {
          value: ctor,
          enumerable: !1,
          writable: !0,
          configurable: !0
    ...
    (function(process) {
      ...
      exports.resolve = function() {
        ...
        for (var fromParts = trim(from.split("/")),
        ...
        for (var outputParts = [],
            i = samePartsLength; i < fromParts.length; i++)
          outputParts.push("..");
    ...
    (function(global, process) {
      ...
      }, exports.inherits = __webpack_require__(4), exports._extend = function(origin, add) {
        if (!add || !isObject(add))
          return origin;
        for (var keys = Object.keys(add),
            i = keys.length; i--; )
    ...
    "use strict";
    exports.command = function(send, name) {
      return function(opts, cb) {
        return "function" == typeof opts && (cb = opts, opts = {}), send(name, null, opts, null, cb);
      };
    }, exports.argCommand = function(send, name) {
      return function(arg, opts, cb) {
        return "function" == typeof opts && (cb = opts, opts = {}), send(name, arg, opts, null, cb);
      };
    };
  }, function(module, exports) {
    ...
    (function(process) {
      ...
      function patch(fs) {
        function readFile(path, options, cb) {
          ...
          return "function" == typeof options && (cb = options, options = null), go$readFile(path, options, cb);
        }
        function writeFile(path, data, options, cb) {
          ...
          return "function" == typeof options && (cb = options, options = null), go$writeFile(path, data, options, cb);
        }
        function appendFile(path, data, options, cb) {
          ...
          return "function" == typeof options && (cb = options, options = null), go$appendFile(path, data, options, cb);
        }
        function readdir(path, cb) {
          function go$readdir() {
            return fs$readdir(path, function(err, files) {
              files && files.sort && files.sort(), !err || "EMFILE" !== err.code && "ENFILE" !== err.code ? ("function" == typeof cb && cb.apply(this, arguments), retry()) : enqueue([go$readdir, [path, cb]]);
            });
          }
        ...
        function open(path, flags, mode, cb) {
          ...
          return "function" == typeof mode && (cb = mode, mode = null), go$open(path, flags, mode, cb);
        }
        polyfills(fs), fs.gracefulify = patch, fs.FileReadStream = ReadStream, fs.FileWriteStream = WriteStream, fs.createReadStream = createReadStream, fs.createWriteStream = createWriteStream;
        var fs$readFile = fs.readFile;
        fs.readFile = readFile;
        var fs$writeFile = fs.writeFile;
        fs.writeFile = writeFile;
        var fs$appendFile = fs.appendFile;
        fs$appendFile && (fs.appendFile = appendFile);
        var fs$readdir = fs.readdir;
        if (fs.readdir = readdir, "v0.8" === process.version.substr(0, 4)) {
        ...
        WriteStream.prototype = Object.create(fs$WriteStream.prototype), WriteStream.prototype.open = WriteStream$open, fs.ReadStream = ReadStream, fs.WriteStream = WriteStream;
        var fs$open = fs.open;
      ...
      var fs = __webpack_require__(6),
          polyfills = __webpack_require__(234),
          legacy = __webpack_require__(233),
          queue = [],
      ...
      util.debuglog ? debug = util.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (debug = function() {
        ...
        debug(queue), __webpack_require__(41).equal(queue.length, 0);
      }), module.exports = patch(__webpack_require__(86)), process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && (module.exports = patch(fs)), module.exports.close = fs.close = function(fs$close) {
        return function(fd, cb) {
          return fs$close.call(fs, fd, function(err) {
            err || retry(), "function" == typeof cb && cb.apply(this, arguments);
          });
        };
      }(fs.close), module.exports.closeSync = fs.closeSync = function(fs$closeSync) {
        return function(fd) {
    ...
    module.exports = EventEmitter, EventEmitter.EventEmitter = EventEmitter, EventEmitter.prototype._events = void 0, EventEmitter.prototype._maxListeners = void 0, EventEmitter.defaultMaxListeners = 10, EventEmitter.prototype.setMaxListeners = function(n) {
      ...
      if (isFunction(handler))
        ...
        for (args = Array.prototype.slice.call(arguments, 1), listeners = handler.slice(), len = listeners.length, i = 0; len > i; i++)
      ...
      if (!this._events || !this._events[type])
        return this;
      if (list = this._events[type], length = list.length, position = -1, list === listener || isFunction(list.listener) && list.listener === listener)
        delete this._events[type], this._events.removeListener && this.emit("removeListener", type, listener);
    ...
    (function(process) {
      ...
      var Readable = __webpack_require__(105),
          Writable = __webpack_require__(63);
    ...
    var _typeof = "function" == typeof _Symbol && "symbol" == typeof _Symbol$iterator ? function(obj) {
      return typeof obj;
    } : function(obj) {
      return obj && "function" == typeof _Symbol && obj.constructor === _Symbol ? "symbol" : typeof obj;
    };
    exports.__esModule = !0;
    var _iterator = __webpack_require__(156),
        _iterator2 = _interopRequireDefault(_iterator),
        _symbol = __webpack_require__(155),
    ...
    var global = __webpack_require__(14),
        ...
        $export = function(type, name, source) {
          ...
          for (key in source)
            own = !IS_FORCED && target && key in target, own && key in exports || (out = own ? target[key] : source[key], exports[key] = IS_GLOBAL && "function" != typeof target[key] ? source[key] : IS_BIND && own ? ctx(out, global) : IS_WRAP && target[key] == out ? function(C) {
    ...
    var Readable = __webpack_require__(100),
        Writable = __webpack_require__(101);
    util.inherits(Duplex, Readable);
    for (var keys = objectKeys(Writable.prototype),
        v = 0; v < keys.length; v++) {
      var method = keys[v];
      Duplex.prototype[method] || (Duplex.prototype[method] = Writable.prototype[method]);
    }
    ...
    (function(Buffer, process) {
      ...
      var _stringify = __webpack_require__(148),
          ...
          _keys = __webpack_require__(18),
          _keys2 = _interopRequireDefault(_keys),
          _defineProperty = __webpack_require__(150),
          _defineProperty2 = _interopRequireDefault(_defineProperty),
          _getOwnPropertyDescriptor = __webpack_require__(151),
          _getOwnPropertyDescriptor2 = _interopRequireDefault(_getOwnPropertyDescriptor),
          _getOwnPropertyNames = __webpack_require__(152),
          ...
          _getPrototypeOf = __webpack_require__(153),
          _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf),
          _typeof2 = __webpack_require__(19),
          _typeof3 = _interopRequireDefault(_typeof2),
          Crypto = __webpack_require__(215),
          Path = __webpack_require__(5),
          Util = __webpack_require__(8),
          Escape = __webpack_require__(119),
          internals = {};
      exports.clone = function(obj, seen) {
        if ("object" !== ("undefined" == typeof obj ? "undefined" : (0, _typeof3["default"])(obj)) || null === obj)
          return obj;
        seen = seen || {
          orig: [],
          copy: []
        ...
        if (Array.isArray(obj))
          ...
          proto && proto.isImmutable ? newObj = obj : (newObj = (0, _create2["default"])(proto), cloneDeep = !0);
        }
        if (seen.orig.push(obj), seen.copy.push(newObj), cloneDeep)
          for (var keys = (0, _getOwnPropertyNames2["default"])(obj),
              i = 0; i < keys.length; ++i) {
            var key = keys[i],
                descriptor = (0, _getOwnPropertyDescriptor2["default"])(obj, key);
            descriptor && (descriptor.get || descriptor.set) ? (0, _defineProperty2["default"])(newObj, key, descriptor) : newObj[key] = exports.clone(obj[key], seen);
          }
        return newObj;
      }, exports.merge = function(target, source, isNullOverride, isMergeArrays) {
        if (exports.assert(target && "object" === ("undefined" == typeof target ? "undefined" : (0, _typeof3["default"])(target)), "Invalid target value: must be an object"), exports.assert(null === source || void 0 === source || "object" === ("undefined" == typeof source ? "undefined" : (0, _typeof3["default"])(source)), "Invalid source value: must be null, undefined, or an object"), !source)
          return target;
        if (Array.isArray(source)) {
          exports.assert(Array.isArray(target), "Cannot merge array onto an object"), isMergeArrays === !1 && (target.length = 0);
          for (var i = 0; i < source.length; ++i)
            target.push(exports.clone(source[i]));
          return target;
        }
        for (var keys = (0, _keys2["default"])(source),
            i = 0; i < keys.length; ++i) {
          var key = keys[i],
              value = source[key];
          value && "object" === ("undefined" == typeof value ? "undefined" : (0, _typeof3["default"])(value)) ? !target[key] || "object" !== (0, _typeof3["default"])(target[key]) || Array.isArray(target[key]) ^ Array.isArray(value) || value instanceof Date || Buffer.isBuffer(value) || value instanceof RegExp ? target[key] = exports.clone(value) : exports.merge(target[key], value, isNullOverride, isMergeArrays) : null !== value && void 0 !== value ? target[key] = value : isNullOverride !== !1 && (target[key] = value);
        }
        return target;
      }, exports.applyToDefaults = function(defaults, options, isNullOverride) {
        if (exports.assert(defaults && "object" === ("undefined" == typeof defaults ? "undefined" : (0, _typeof3["default"])(defaults)), "Invalid defaults value: must be an object"), exports.assert(!options || options === !0 || "object" === ("undefined" == typeof options ? "undefined" : (0, _typeof3["default"])(options)), "Invalid options value: must be true, falsy or an object"), !options)
          return null;
        var copy = exports.clone(defaults);
        return options === !0 ? copy : exports.merge(copy, options, isNullOverride === !0, !1);
      }, exports.cloneWithShallow = function(source, keys) {
        if (!source || "object" !== ("undefined" == typeof source ? "undefined" : (0, _typeof3["default"])(source)))
          return source;
        var storage = internals.store(source, keys),
            copy = exports.clone(source);
        return internals.restore(copy, source, storage), copy;
      }, internals.store = function(source, keys) {
        for (var storage = {},
            i = 0; i < keys.length; ++i) {
          var key = keys[i],
              value = exports.reach(source, key);
          void 0 !== value && (storage[key] = value, internals.reachSet(source, key, void 0));
        }
        return storage;
      }, internals.restore = function(copy, source, storage) {
        for (var keys = (0, _keys2["default"])(storage),
            i = 0; i < keys.length; ++i) {
          var key = keys[i];
          internals.reachSet(copy, key, storage[key]), internals.reachSet(source, key, storage[key]);
        }
      }, internals.reachSet = function(obj, key, value) {
        for (var path = key.split("."),
            ref = obj,
            i = 0; i < path.length; ++i) {
          var segment = path[i];
          i + 1 === path.length && (ref[segment] = value), ref = ref[segment];
        }
        ...
        return exports.merge(copy, options, !1, !1), internals.restore(copy, options, storage), copy;
      }, exports.deepEqual = function(obj, ref, options, seen) {
        options = options || {prototype: !0};
        var type = "undefined" == typeof obj ? "undefined" : (0, _typeof3["default"])(obj);
        if (type !== ("undefined" == typeof ref ? "undefined" : (0, _typeof3["default"])(ref)))
          return !1;
        if ("object" !== type || null === obj || null === ref)
          return obj === ref ? 0 !== obj || 1 / obj === 1 / ref : obj !== obj && ref !== ref;
        if (seen = seen || [], -1 !== seen.indexOf(obj))
          return !0;
        if (seen.push(obj), Array.isArray(obj)) {
        ...
        if (options.prototype && (0, _getPrototypeOf2["default"])(obj) !== (0, _getPrototypeOf2["default"])(ref))
          return !1;
        ...
        for (var index = {},
          ...
          index[id] !== !0 && (result.push(array[i]), index[id] = !0);
        }
        return result;
        ...
        if (options.deep) {
          ...
          compareFlags = {
            prototype: hasOnly ? options.only : hasPart ? !options.part : !1,
            part: hasOnly ? !options.only : hasPart ? options.part : !0
          };
        } else
        ...
        for (var misses = !1,
            matches = new Array(values.length),
        ...
        if ("string" == typeof ref) {
          for (var pattern = "(",
            ...
            var value = values[i];
            exports.assert("string" == typeof value, "Cannot compare string reference to non-string value"), pattern += (i ? "|" : "") + exports.escapeRegex(value);
          }
          var regex = new RegExp(pattern + ")", "g"),
              leftovers = ref.replace(regex, function($0, $1) {
          ...
          for (var i = 0; i < ref.length; ++i) {
            for (var matched = !1,
                j = 0; j < values.length && matched === !1; ++j)
              matched = compare(values[j], ref[i], compareFlags) && j;
            matched !== !1 ? ++matches[matched] : misses = !0;
          }
        else
          for (var keys = (0, _keys2["default"])(ref),
              i = 0; i < keys.length; ++i) {
            var key = keys[i],
                pos = values.indexOf(key);
            if (-1 !== pos) {
        ...
        for (var result = !1,
            i = 0; i < matches.length; ++i)
          if (result = result || !!matches[i], options.once && matches[i] > 1 || !options.part && !matches[i])
            return !1;
        return options.only && misses ? !1 : result;
      }, exports.flatten = function(array, target) {
        for (var result = target || [],
            i = 0; i < array.length; ++i)
          Array.isArray(array[i]) ? exports.flatten(array[i], result) : result.push(array[i]);
        return result;
      }, exports.reach = function(obj, chain, options) {
        if (chain === !1 || null === chain || "undefined" == typeof chain)
          return obj;
        options = options || {}, "string" == typeof options && (options = {separator: options});
        for (var path = chain.split(options.separator || "."),
            ref = obj,
            i = 0; i < path.length; ++i) {
          var key = path[i];
          if ("-" === key[0] && Array.isArray(ref) && (key = key.slice(1, key.length), key = ref.length - key), !ref || "object" !== ("undefined" == typeof ref ? "undefined" : (0, _typeof3["default"])(ref)) && "function" != typeof ref || !(key in ref) || "object" !== ("undefined" == typeof ref ? "undefined" : (0, _typeof3["default"])(ref)) && options.functions === !1) {
            exports.assert(!options.strict || i + 1 === path.length, "Missing segment", key, "in reach path ", chain), exports.assert("object" === ("undefined" == typeof ref ? "undefined" : (0, _typeof3["default"])(ref)) || options.functions === !0 || "function" != typeof ref, "Invalid segment", key, "in reach path ", chain), ref = options["default"];
            break;
          }
          ref = ref[key];
        }
        ...
        var trace = exports.callStack(void 0 === slice ? 1 : slice + 1);
        return exports.formatTrace(trace);
      }, exports.abortThrow = !1, exports.abort = function(message, hideStack) {
        if ("test" === process.env.NODE_ENV || exports.abortThrow === !0)
          throw new Error(message || "Unknown error");
        var stack = "";
        hideStack || (stack = exports.displayStack(1).join("\n	")), console.log("ABORT: " + message + "\n	" + stack), process.exit(1);
      }, exports.assert = function(condition) {
        if (!condition) {
          if (2 === arguments.length && arguments[1] instanceof Error)
            throw arguments[1];
          for (var msgs = [],
              i = 1; i < arguments.length; ++i)
            "" !== arguments[i] && msgs.push(arguments[i]);
          throw msgs = msgs.map(function(msg) {
            return "string" == typeof msg ? msg : msg instanceof Error ? msg.message : exports.stringify(msg);
          }), new Error(msgs.join(" ") || "Unknown error");
        }
        ...
        try {
          ...
          return "buffer" === encoding ? buf : buf.toString(encoding || "binary");
        } catch (err) {
          return err;
        }
      }, exports.escapeHeaderAttribute = function(attribute) {
        return exports.assert(/^[ \w\!#\$%&'\(\)\*\+,\-\.\/\:;<\=>\?@\[\]\^`\{\|\}~\"\\]*$/.test(attribute), "Bad attribute value (" + attribute + ")"), attribute.replace(/\\/g, "\\\\").replace(/\"/g, '\\"');
        ...
        return wrapped._hoekOnce = !0, wrapped;
      }, exports.isAbsolutePath = function(path, platform) {
        return path ? Path.isAbsolute ? Path.isAbsolute(path) : (platform = platform || process.platform, "win32" !== platform ? "/" === path[0] : !!/^(?:[a-zA-Z]:[\\\/])|(?:[\\\/]{2}[^\\\/]+[\\\/]+[^\\\/])/.test(path)) : !1;
      }, exports.isInteger = function(value) {
        return "number" == typeof value && parseFloat(value) === parseInt(value, 10) && !isNaN(value);
      }, exports.ignore = function() {}, exports.inherits = Util.inherits, exports.format = Util.format, exports.transform = function(source, transform, options) {
        if (exports.assert(null === source || void 0 === source || "object" === ("undefined" == typeof source ? "undefined" : (0, _typeof3["default"])(source)) || Array.isArray(source), "Invalid source object: must be null, undefined, an object, or an array"), Array.isArray(source)) {
          for (var results = [],
        ...
        for (var result = {},
            keys = (0, _keys2["default"])(transform),
            i = 0; i < keys.length; ++i) {
          var key = keys[i],
              path = key.split("."),
              sourcePath = transform[key];
          exports.assert("string" == typeof sourcePath, 'All mappings must be "." delineated strings');
          for (var segment = void 0,
              res = result; path.length > 1; )
            segment = path.shift(), res[segment] || (res[segment] = {}), res = res[segment];
          segment = path.shift(), res[segment] = exports.reach(source, sourcePath, options);
        }
        return result;
      }, exports.uniqueFilename = function(path, extension) {
        extension = extension ? "." !== extension[0] ? "." + extension : extension : "", path = Path.resolve(path);
    ...
    }).call(exports, __webpack_require__(1).Buffer, __webpack_require__(2));
  }, function(module, exports) {
    ...
    (function(process) {
      ...
      function through2(construct) {
        return function(options, transform, flush) {
          return "function" == typeof options && (flush = transform, transform = options, options = {}), "function" != typeof transform && (transform = noop), "function" != typeof flush && (flush = null), construct(options, transform, flush);
        };
      }
      ...
      inherits(DestroyableTransform, Transform), DestroyableTransform.prototype.destroy = function(err) {
        ...
        function Through2(override) {
          return this instanceof Through2 ? (this.options = xtend(options, override), void DestroyableTransform.call(this, this.options)) : new Through2(override);
        }
        return inherits(Through2, DestroyableTransform), Through2.prototype._transform = transform, flush && (Through2.prototype._flush = flush), Through2;
    ...
    (function(Buffer, process) {
      var stream = __webpack_require__(102),
          ...
          destroyer = function(self, end) {
            return function(err) {
              err ? self.destroy("premature close" === err.message ? null : err) : end && !self._ended && self.end();
            };
          },
          end = function(ws, fn) {
            return ws ? ws._writableState && ws._writableState.finished ? fn() : ws._writableState ? ws.end(fn) : (ws.end(), void fn()) : fn();
          },
          toStreams2 = function(rs) {
          ...
          Duplexify = function(writable, readable, opts) {
            return this instanceof Duplexify ? (stream.Duplex.call(this, opts), this._writable = null, this._readable = null, this._readable2 = null, this._forwardDestroy = !opts || opts.destroy !== !1, this._forwardEnd = !opts || opts.end !== !1, this._corked = 1, this._ondrain = null, this._drained = !1, this._forwarding = !1, this._unwrite = null, this._unread = null, this._ended = !1, this.destroyed = !1, writable && this.setWritable(writable), void(readable && this.setReadable(readable))) : new Duplexify(writable, readable, opts);
          };
      util.inherits(Duplexify, stream.Duplex), Duplexify.obj = function(writable, readable, opts) {
        ...
        if (this._unwrite && this._unwrite(), this.destroyed)
          return void(writable && writable.destroy && writable.destroy());
        if (null === writable || writable === !1)
        ...
        this._unwrite && process.nextTick(ondrain), this._writable = writable, this._writable.on("drain", ondrain), this._unwrite = clear, this.uncork();
      }, Duplexify.prototype.setReadable = function(readable) {
        if (this._unread && this._unread(), this.destroyed)
          return void(readable && readable.destroy && readable.destroy());
        if (null === readable || readable === !1)
        ...
        var self = this,
            ...
            clear = function() {
              self._readable2.removeListener("readable", onreadable), self._readable2.removeListener("end", onend), unend();
            };
        this._drained = !0, this._readable = readable, this._readable2 = readable._readableState ? readable : toStreams2(readable), this._readable2.on("readable", onreadable), this._readable2.on("end", onend), this._unread = clear, this._forward();
        ...
        if (!this._forwarding && this._readable2 && this._drained) {
          this._forwarding = !0;
          for (var data,
              state = this._readable2._readableState; null !== (data = this._readable2.read(state.buffer.length ? state.buffer[0].length : state.length)); )
        ...
        return this.destroyed ? cb() : this._corked ? onuncork(this, this._write.bind(this, data, enc, cb)) : data === SIGNAL_FLUSH ? this._finish(cb) : this._writable ? void(this._writable.write(data) === !1 ? this._ondrain = cb : cb()) : cb();
      }, Duplexify.prototype._finish = function(cb) {
        var self = this;
        this.emit("preend"), onuncork(this, function() {
          end(self._forwardEnd && self._writable, function() {
            self._writableState.prefinished === !1 && (self._writableState.prefinished = !0), self.emit("prefinish"), onuncork(self, cb);
          });
        });
      }, Duplexify.prototype.end = function(data, enc, cb) {
        return "function" == typeof data ? this.end(null, null, data) : "function" == typeof enc ? this.end(data, null, enc) : (this._ended = !0, data && this.write(data), this._writableState.ending || this.write(SIGNAL_FLUSH), stream.Writable.prototype.end.call(this, cb));
    ...
    function objEquiv(a, b) {
      ...
      for (i = ka.length - 1; i >= 0; i--)
        if (key = ka[i], !_deepEqual(a[key], b[key]))
          return !1;
      return !0;
    }
    ...
    (function(Buffer) {
      ...
      module.exports = function(val) {
        ...
        if (null === val)
          return "null";
        if (val === !0 || val === !1 || val instanceof Boolean)
          return "boolean";
        if ("string" == typeof val || val instanceof String)
          return "string";
        if ("number" == typeof val || val instanceof Number)
          return "number";
        if ("function" == typeof val || val instanceof Function)
          return "function";
        if ("undefined" != typeof Array.isArray && Array.isArray(val))
          return "array";
    ...
    function shimKeys(object) {
      for (var props = keysIn(object),
          propsLength = props.length,
          length = propsLength && object.length,
          allowIndexes = !!length && isLength(length) && (isArray(object) || isArguments(object)),
          index = -1,
          result = []; ++index < propsLength; ) {
        var key = props[index];
    ...
    function keysIn(object) {
      ...
      for (var Ctor = object.constructor,
          ...
          result = Array(length),
          skipIndexes = length > 0; ++index < length; )
        result[index] = index + "";
    ...
    (function(process) {
      ...
      utils.diff = __webpack_require__(116), utils.unique = __webpack_require__(118), utils.braces = __webpack_require__(160), utils.brackets = __webpack_require__(220), utils.extglob = __webpack_require__(224), utils.isExtglob = __webpack_require__(38), utils.isGlob = __webpack_require__(39), utils.typeOf = __webpack_require__(51), utils.normalize = __webpack_require__(270), utils.omit = __webpack_require__(271), utils.parseGlob = __webpack_require__(273), utils.cache = __webpack_require__(281), utils.filename = function(fp) {
        ...
        return function(fp) {
          return -1 !== utils.unixify(pattern, opts).indexOf(fp);
        };
        ...
        return opts && opts.unixify === !1 ? fp : opts && opts.unixify === !0 || win32 || "\\" === path.sep ? utils.normalize(fp, !1) : opts && opts.unescape === !0 ? fp ? fp.toString().replace(/\\(\w)/g, "$1") : "" : fp;
    ...
    function minimatch(p, pattern, options) {
      ...
      return options || (options = {}), options.nocomment || "#" !== pattern.charAt(0) ? "" === pattern.trim() ? "" === p : new Minimatch(pattern, options).match(p) : !1;
    }
    ...
    function parseNegate() {
      ...
      if (!options.nonegate) {
        for (var i = 0,
            l = pattern.length; l > i && "!" === pattern.charAt(i); i++)
          negate = !negate, negateOffset++;
        negateOffset && (this.pattern = pattern.substr(negateOffset)), this.negate = negate;
      }
    }
    function braceExpand(pattern, options) {
      if (options || (options = this instanceof Minimatch ? this.options : {}), pattern = "undefined" == typeof pattern ? this.pattern : pattern, "undefined" == typeof pattern)
    ...
    function parse(pattern, isSub) {
      ...
      for (var plType,
          ...
          self = this,
          i = 0,
          len = pattern.length; len > i && (c = pattern.charAt(i)); i++)
        if (this.debug("%s	%s %s %j", pattern, i, re, c), escaping && reSpecials[c])
          ...
          switch (c) {
            ...
            case ")":
              ...
              clearStateChar(), hasMagic = !0, re += ")";
              var pl = patternListStack.pop();
              switch (plType = pl.type) {
                case "!":
                  negativeLists.push(pl), re += ")[^/]*?)", pl.reEnd = re.length;
                  break;
                case "?":
                case "+":
                case "*":
    ...
    var GLOBSTAR = minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {},
        expand = __webpack_require__(159),
        qmark = "[^/]",
        star = qmark + "*?",
        twoStarDot = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?",
        twoStarNoDot = "(?:(?!(?:\\/|^)\\.).)*?",
        reSpecials = charSet("().*{}+?[]^$\\!"),
        slashSplit = /\/+/;
    minimatch.filter = filter, minimatch.defaults = function(def) {
    ...
    }, Minimatch.prototype.debug = function() {}, Minimatch.prototype.make = make, Minimatch.prototype.parseNegate = parseNegate, minimatch.braceExpand = function(pattern, options) {
      return braceExpand(pattern, options);
    }, Minimatch.prototype.braceExpand = braceExpand, Minimatch.prototype.parse = parse;
    var SUBPARSE = {};
    minimatch.makeRe = function(pattern, options) {
      return new Minimatch(pattern, options || {}).makeRe();
    }, Minimatch.prototype.makeRe = makeRe, minimatch.match = function(list, pattern, options) {
      options = options || {};
      var mm = new Minimatch(pattern, options);
      return list = list.filter(function(f) {
        return mm.match(f);
      }), mm.options.nonull && !list.length && list.push(pattern), list;
    }, Minimatch.prototype.match = match, Minimatch.prototype.matchOne = function(file, pattern, partial) {
      var options = this.options;
      this.debug("matchOne", {
        "this": this,
        file: file,
      ...
      for (var fi = 0,
          pi = 0,
          fl = file.length,
          pl = pattern.length; fl > fi && pl > pi; fi++, pi++) {
        ...
        if (p === GLOBSTAR) {
          ...
          var fr = fi,
              pr = pi + 1;
          if (pr === pl) {
            for (this.debug("** at the end"); fl > fi; fi++)
          ...
          return partial && (this.debug("\n>>> no match, partial?", file, fr, pattern, pr), fr === fl) ? !0 : !1;
        }
        var hit;
        if ("string" == typeof p ? (hit = options.nocase ? f.toLowerCase() === p.toLowerCase() : f === p, this.debug("string match", p, f, hit)) : (hit = f.match(p), this.debug("pattern match", p, f, hit)), !hit)
          return !1;
      }
      if (fi === fl && pi === pl)
        return !0;
    ...
    function Protocols(proto) {
      if ("number" == typeof proto) {
        if (Protocols.codes[proto])
          return Protocols.codes[proto];
        throw new Error("no protocol with code: " + proto);
      }
      if ("string" == typeof proto || proto instanceof String) {
    ...
    module.exports = Protocols, Protocols.table = [[4, 32, "ip4"], [6, 16, "tcp"], [17, 16, "udp"], [33, 16, "dccp"], [41, 128, "ip6"], [132, 16, "sctp"]], Protocols.names = {}, Protocols.codes = {}, map(Protocols.table, function(e) {
      var proto = p.apply(this, e);
      Protocols.codes[proto.code] = proto, Protocols.names[proto.name] = proto;
    }), Protocols.object = p;
  }, function(module, exports, __webpack_require__) {
    function once(fn) {
      var f = function() {
    ...
    (function(process) {
      ...
      module.exports = "win32" === process.platform ? win32 : posix, module.exports.posix = posix, module.exports.win32 = win32;
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      "use strict";
      function nextTick(fn) {
        for (var args = new Array(arguments.length - 1),
            i = 0; i < args.length; )
          args[i++] = arguments[i];
        process.nextTick(function() {
          fn.apply(null, args);
    ...
    function afterTransform(stream, er, data) {
      ...
      ts.writechunk = null, ts.writecb = null, null !== data && void 0 !== data && stream.push(data), cb && cb(er);
    ...
    var Duplex = __webpack_require__(22),
        util = __webpack_require__(9);
    util.inherits = __webpack_require__(4), util.inherits(Transform, Duplex), Transform.prototype.push = function(chunk, encoding) {
    ...
    function afterTransform(stream, er, data) {
      ...
      if (!cb)
        return stream.emit("error", new Error("no writecb in Transform class"));
      ts.writechunk = null, ts.writecb = null, util.isNullOrUndefined(data) || stream.push(data), cb && cb(er);
      var rs = stream._readableState;
      rs.reading = !1, (rs.needReadable || rs.length < rs.highWaterMark) && stream._read(rs.highWaterMark);
    }
    function Transform(options) {
    ...
    util.inherits = __webpack_require__(4), util.inherits(Transform, Duplex), Transform.prototype.push = function(chunk, encoding) {
      ...
      var ts = this._transformState;
      util.isNull(ts.writechunk) || !ts.writecb || ts.transforming ? ts.needTransform = !0 : (ts.transforming = !0, this._transform(ts.writechunk, ts.writeencoding, ts.afterTransform));
    };
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      ...
      function WritableState(options, stream) {
        ...
        var hwm = options.highWaterMark,
            defaultHwm = options.objectMode ? 16 : 16384;
        this.highWaterMark = hwm || 0 === hwm ? hwm : defaultHwm, this.objectMode = !!options.objectMode, stream instanceof Duplex && (this.objectMode = this.objectMode || !!options.writableObjectMode), this.highWaterMark = ~~this.highWaterMark, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1;
      ...
      function Writable(options) {
        var Duplex = __webpack_require__(16);
        return this instanceof Writable || this instanceof Duplex ? (this._writableState = new WritableState(options, this), this.writable = !0, void Stream.call(this)) : new Writable(options);
      }
      ...
      function decodeChunk(state, chunk, encoding) {
        return !state.objectMode && state.decodeStrings !== !1 && util.isString(chunk) && (chunk = new Buffer(chunk, encoding)), chunk;
      }
      function writeOrBuffer(stream, state, chunk, encoding, cb) {
        ...
        return ret || (state.needDrain = !0), state.writing || state.corked ? state.buffer.push(new WriteReq(chunk, encoding, cb)) : doWrite(stream, state, !1, len, chunk, encoding, cb), ret;
      }
      ...
      function onwrite(stream, er) {
        ...
        if (onwriteStateUpdate(state), er)
          ...
          finished || state.corked || state.bufferProcessing || !state.buffer.length || clearBuffer(stream, state), sync ? process.nextTick(function() {
      ...
      function endWritable(stream, state, cb) {
        state.ending = !0, finishMaybe(stream, state), cb && (state.finished ? process.nextTick(cb) : stream.once("finish", cb)), state.ended = !0;
      }
      ...
      util.inherits(Writable, Stream), Writable.prototype.pipe = function() {
        ...
        var state = this._writableState,
            ret = !1;
        return util.isFunction(encoding) && (cb = encoding, encoding = null), util.isBuffer(chunk) ? encoding = "buffer" : encoding || (encoding = state.defaultEncoding), util.isFunction(cb) || (cb = function() {}), state.ended ? writeAfterEnd(this, state, cb) : validChunk(this, state, chunk, cb) && (state.pendingcb++, ret = writeOrBuffer(this, state, chunk, encoding, cb)), ret;
        ...
        var state = this._writableState;
        util.isFunction(chunk) ? (cb = chunk, chunk = null, encoding = null) : util.isFunction(encoding) && (cb = encoding, encoding = null), util.isNullOrUndefined(chunk) || this.write(chunk, encoding), state.corked && (state.corked = 1, this.uncork()), state.ending || state.finished || endWritable(this, state, cb);
      };
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    (function(Buffer) {
      "use strict";
      var isUtf8 = __webpack_require__(244);
      module.exports = function(x) {
        return "string" == typeof x && 65279 === x.charCodeAt(0) ? x.slice(1) : Buffer.isBuffer(x) && isUtf8(x) && 239 === x[0] && 187 === x[1] && 191 === x[2] ? x.slice(3) : x;
      };
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports, __webpack_require__) {
    (function(process) {
    ...
    (function(process) {
      function File(file) {
        ...
        this.history = history || [], this.cwd = file.cwd || process.cwd(), this.base = file.base || this.cwd, this.stat = file.stat || null, this.contents = file.contents || null, this._isVinyl = !0;
      }
      var path = __webpack_require__(5),
          clone = __webpack_require__(165),
          cloneStats = __webpack_require__(164),
          cloneBuffer = __webpack_require__(330),
          isBuffer = __webpack_require__(332),
          isStream = __webpack_require__(114),
          isNull = __webpack_require__(333),
          inspectStream = __webpack_require__(331),
          Stream = __webpack_require__(3),
          replaceExt = __webpack_require__(283);
      File.prototype.isBuffer = function() {
        ...
        "boolean" == typeof opt ? opt = {
          deep: opt,
          contents: !0
        } : opt ? (opt.deep = opt.deep === !0, opt.contents = opt.contents !== !1) : opt = {
          deep: !0,
          contents: !0
        };
        var contents;
        this.isStream() ? (contents = this.contents.pipe(new Stream.PassThrough), this.contents = this.contents.pipe(new Stream.PassThrough)) : this.isBuffer() && (contents = opt.contents ? cloneBuffer(this.contents) : this.contents);
        var file = new File({
          cwd: this.cwd,
          base: this.base,
        ...
        return Object.keys(this).forEach(function(key) {
          "_contents" !== key && "stat" !== key && "history" !== key && "path" !== key && "base" !== key && "cwd" !== key && (file[key] = opt.deep ? clone(this[key], !0) : this[key]);
        }, this), file;
      }, File.prototype.pipe = function(stream, opt) {
        return opt || (opt = {}), "undefined" == typeof opt.end && (opt.end = !0), this.isStream() ? this.contents.pipe(stream, opt) : this.isBuffer() ? (opt.end ? stream.end(this.contents) : stream.write(this.contents), stream) : (opt.end && stream.end(), stream);
      }, File.prototype.inspect = function() {
        var inspect = [],
            filePath = this.base && this.path ? this.relative : this.path;
        return filePath && inspect.push('"' + filePath + '"'), this.isBuffer() && inspect.push(this.contents.inspect()), this.isStream() && inspect.push(inspectStream(this.contents)), "<File " + inspect.join(" ") + ">";
      }, File.isVinyl = function(file) {
        return file && file._isVinyl === !0 || !1;
        ...
        set: function(path) {
          ...
          path && path !== this.path && this.history.push(path);
        }
      }), module.exports = File;
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    ...
    var _keys = __webpack_require__(18),
        _keys2 = _interopRequireDefault(_keys),
        _setPrototypeOf = __webpack_require__(154),
        _setPrototypeOf2 = _interopRequireDefault(_setPrototypeOf),
        Hoek = __webpack_require__(24),
        internals = {STATUS_CODES: (0, _setPrototypeOf2["default"])({
            100: "Continue",
    ...
    exports.wrap = function(error, statusCode, message) {
      return Hoek.assert(error instanceof Error, "Cannot wrap non-Error object"), error.isBoom ? error : internals.initialize(error, statusCode || 500, message);
      ...
      var error = new Error(message ? message : void 0);
      return Error.captureStackTrace(error, ctor), error.data = data || null, internals.initialize(error, statusCode), error;
    }, internals.initialize = function(error, statusCode, message) {
      var numberCode = parseInt(statusCode, 10);
      return Hoek.assert(!isNaN(numberCode) && numberCode >= 400, "First argument must be a number (400+):", statusCode), error.isBoom = !0, error.isServer = numberCode >= 500, error.hasOwnProperty("data") || (error.data = null), error.output = {
        statusCode: numberCode,
        payload: {},
        headers: {}
      }, error.reformat = internals.reformat, error.reformat(), message || error.message || (message = error.output.payload.error), message && (error.message = message + (error.message ? ": " + error.message : "")), error;
    }, internals.reformat = function() {
      this.output.payload.statusCode = this.output.statusCode, this.output.payload.error = internals.STATUS_CODES[this.output.statusCode] || "Unknown", 500 === this.output.statusCode ? this.output.payload.message = "An internal server error occurred" : this.message && (this.output.payload.message = this.message);
      ...
      var err = internals.create(401, message, void 0, exports.unauthorized);
      if (!scheme)
        return err;
      var wwwAuthenticate = "";
      if ("string" == typeof scheme) {
        if (wwwAuthenticate = scheme, (attributes || message) && (err.output.payload.attributes = {}), attributes)
          for (var names = (0, _keys2["default"])(attributes),
              i = 0; i < names.length; ++i) {
            var name = names[i];
            i && (wwwAuthenticate += ",");
            var value = attributes[name];
            (null === value || void 0 === value) && (value = ""), wwwAuthenticate = wwwAuthenticate + " " + name + '="' + Hoek.escapeHeaderAttribute(value.toString()) + '"', err.output.payload.attributes[name] = value;
          }
        message ? (attributes && (wwwAuthenticate += ","), wwwAuthenticate = wwwAuthenticate + ' error="' + Hoek.escapeHeaderAttribute(message) + '"', err.output.payload.attributes.error = message) : err.isMissing = !0;
      } else
        for (var wwwArray = scheme,
            i = 0; i < wwwArray.length; ++i)
          i && (wwwAuthenticate += ", "), wwwAuthenticate += wwwArray[i];
      return err.output.headers["WWW-Authenticate"] = wwwAuthenticate, err;
      ...
      var error = void 0;
      return data instanceof Error ? error = exports.wrap(data, statusCode, message) : (error = internals.create(statusCode || 500, message, void 0, ctor), error.data = data), error;
      ...
      return err.isDeveloperError = !0, err;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function _interopRequireDefault(obj) {
    ...
    var _keys = __webpack_require__(18),
        ...
        _create2 = _interopRequireDefault(_create),
        hexTable = function() {
          for (var array = new Array(256),
              i = 0; 256 > i; ++i)
            array[i] = "%" + ((16 > i ? "0" : "") + i.toString(16)).toUpperCase();
          return array;
        }();
    exports.arrayToObject = function(source, options) {
      for (var obj = options.plainObjects ? (0, _create2["default"])(null) : {},
          i = 0; i < source.length; ++i)
      ...
      if (!source)
        return target;
      if ("object" !== ("undefined" == typeof source ? "undefined" : (0, _typeof3["default"])(source))) {
        if (Array.isArray(target))
          target.push(source);
        else {
          if ("object" !== ("undefined" == typeof target ? "undefined" : (0, _typeof3["default"])(target)))
      ...
      return Array.isArray(target) && !Array.isArray(source) && (mergeTarget = exports.arrayToObject(target, options)), (0, _keys2["default"])(source).reduce(function(acc, key) {
      ...
      if (0 === str.length)
        return str;
      for (var string = "string" == typeof str ? str : String(str),
          out = "",
      ...
      if (refs.push(obj), Array.isArray(obj)) {
        for (var compacted = [],
            i = 0; i < obj.length; ++i)
          "undefined" != typeof obj[i] && compacted.push(obj[i]);
        return compacted;
      }
      for (var keys = (0, _keys2["default"])(obj),
          j = 0; j < keys.length; ++j) {
        var key = keys[j];
    ...
    (function(Buffer, process) {
      ...
      var Events = __webpack_require__(15),
          ...
          Https = __webpack_require__(236),
          Stream = __webpack_require__(3),
          Hoek = __webpack_require__(24),
          Boom = __webpack_require__(67),
          Payload = __webpack_require__(70),
          Recorder = __webpack_require__(123),
          Tap = __webpack_require__(124),
          internals = {
      ...
      internals.Client = function(defaults) {
        ...
        var start = Date.now(),
            ...
            finish = function(err, res) {
              return (!callback || err) && req.abort(), req.removeListener("response", onResponse), req.removeListener("error", onError), req.on("error", Hoek.ignore), clearTimeout(timeoutId), _this.emit("response", err, req, res, start, uri), callback ? callback(err, res) : void 0;
            },
            finishOnce = Hoek.once(finish);
        if (onError = function(err) {
          return err.trace = _trace, finishOnce(Boom.badGateway("Client request error", err));
        }, req.once("error", onError), onResponse = function(res) {
          var statusCode = res.statusCode;
          if (redirects === !1 || -1 === [301, 302, 307, 308].indexOf(statusCode))
            return finishOnce(null, res);
          var redirectMethod = 301 === statusCode || 302 === statusCode ? "GET" : uri.method,
              location = res.headers.location;
          if (res.destroy(), 0 === redirects)
          ...
          /^https?:/i.test(location) || (location = Url.resolve(uri.href, location));
          var redirectOptions = Hoek.cloneWithShallow(options, internals.shallowOptions);
          redirectOptions.payload = shadow || options.payload, redirectOptions.redirects = --redirects, options.beforeRedirect && options.beforeRedirect(redirectMethod, statusCode, location, redirectOptions);
          var redirectReq = _this.request(redirectMethod, location, redirectOptions, finishOnce, _trace);
          options.redirected && options.redirected(statusCode, location, redirectReq);
        }, req.once("response", onResponse), options.timeout && (timeoutId = setTimeout(function() {
          return finishOnce(Boom.gatewayTimeout("Client request timeout"));
        }, options.timeout), delete options.timeout), payloadSupported) {
          if (options.payload instanceof Stream) {
            ...
            }(), void stream.pipe(req);
          }
          req.write(options.payload);
        }
        var _abort = req.abort,
            aborted = !1;
        return req.abort = function() {
          return aborted || req.res || req.socket || process.nextTick(function() {
            var error = new Error("socket hang up");
            error.code = "ECONNRESET", finishOnce(error);
          }), aborted = !0, _abort.call(req);
        }, req.end(), req;
        ...
        var clientTimeout = options.timeout,
            ...
            finish = function(err, buffer) {
              if (clearTimeout(clientTimeoutId), reader.removeListener("error", onReaderError), reader.removeListener("finish", onReaderFinish), res.removeListener("error", onResError), res.removeListener("close", onResClose), res.on("error", Hoek.ignore), err || !options.json)
                return callback(err, buffer);
              var result = void 0;
              if (0 === buffer.length)
                return callback(null, null);
              if ("force" === options.json)
                return result = internals.tryParseBuffer(buffer), callback(result.err, result.json);
              var contentType = res.headers && res.headers["content-type"] || "",
                  mime = contentType.split(";")[0].trim().toLowerCase();
              return internals.jsonRegex.test(mime) ? (result = internals.tryParseBuffer(buffer), callback(result.err, result.json)) : callback(null, buffer);
            },
            finishOnce = Hoek.once(finish);
        clientTimeout && clientTimeout > 0 && (clientTimeoutId = setTimeout(function() {
        ...
        res.once("error", onResError), res.once("close", onResClose);
        var reader = new Recorder({maxBytes: options.maxBytes}),
            onReaderError = function(err) {
              return res.destroy && res.destroy(), finishOnce(err);
            };
        reader.once("error", onReaderError);
        var onReaderFinish = function() {
          return finishOnce(null, reader.collect());
        };
        reader.once("finish", onReaderFinish), res.pipe(reader);
        ...
        var regex = /(?:^|(?:\s*\,\s*))([^\x00-\x20\(\)<>@\,;\:\\"\/\[\]\?\=\{\}\x7F]+)(?:\=(?:([^\x00-\x20\(\)<>@\,;\:\\"\/\[\]\?\=\{\}\x7F]+)|(?:\"((?:[^"\\]|\\.)*)\")))?/g,
            header = {},
            error = field.replace(regex, function($0, $1, $2, $3) {
              var value = $2 || $3;
              return header[$1] = value ? value.toLowerCase() : !0, "";
            });
        if (header["max-age"])
          try {
        ...
        var options = "function" == typeof arguments[2] ? {} : arguments[2],
            callback = "function" == typeof arguments[2] ? arguments[2] : arguments[3];
        ...
        return this.request(method, uri, options, function(err, res) {
          return err ? callback(err) : void _this2.read(res, options, function(err, payload) {
    ...
    (function(Buffer) {
      "use strict";
      var Hoek = __webpack_require__(24),
          Stream = __webpack_require__(3),
          internals = {};
      module.exports = internals.Payload = function(payload, encoding) {
        Stream.Readable.call(this);
        for (var data = [].concat(payload || ""),
            size = 0,
            i = 0; i < data.length; ++i) {
          var chunk = data[i];
          size += chunk.length, data[i] = Buffer.isBuffer(chunk) ? chunk : new Buffer(chunk);
        }
        this._data = Buffer.concat(data, size), this._position = 0, this._encoding = encoding || "utf8";
      }, Hoek.inherits(internals.Payload, Stream.Readable), internals.Payload.prototype._read = function(size) {
        var chunk = this._data.slice(this._position, this._position + size);
        this.push(chunk, this._encoding), this._position = this._position + chunk.length, this._position >= this._data.length && this.push(null);
      };
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports, __webpack_require__) {
    ...
    module.exports = {
      set: Object.setPrototypeOf || ("__proto__" in {} ? function(test, buggy, set) {
        try {
          set = __webpack_require__(26)(Function.call, getDesc(Object.prototype, "__proto__").set, 2), set(test, []), buggy = !(test instanceof Array);
        } catch (e) {
          buggy = !0;
        }
    ...
    "use strict";
    var $at = __webpack_require__(200)(!0);
          ...
          var buffers = [],
              m = {
                update: function(data, enc) {
                  return Buffer.isBuffer(data) || (data = new Buffer(data, enc)), buffers.push(data), this;
                },
                digest: function(enc) {
                  var buf = Buffer.concat(buffers),
                      r = fn(buf);
                  return buffers = null, enc ? r.toString(enc) : r;
                }
              };
          return m;
        };
      }
      var createHash = __webpack_require__(287),
          md5 = toConstructor(__webpack_require__(216)),
          rmd160 = toConstructor(__webpack_require__(284));
 ...
 while (isglob(str));
    ...
    (function(process) {
      ...
      function setopts(self, pattern, options) {
        ...
        self.silent = !!options.silent, self.pattern = pattern, self.strict = options.strict !== !1, self.realpath = !!options.realpath, self.realpathCache = options.realpathCache || Object.create(null), self.follow = !!options.follow, self.dot = !!options.dot, self.mark = !!options.mark, self.nodir = !!options.nodir, self.nodir && (self.mark = !0), self.sync = !!options.sync, self.nounique = !!options.nounique, self.nonull = !!options.nonull, self.nosort = !!options.nosort, self.nocase = !!options.nocase, self.stat = !!options.stat, self.noprocess = !!options.noprocess, self.maxLength = options.maxLength || 1 / 0, self.cache = options.cache || Object.create(null), self.statCache = options.statCache || Object.create(null), self.symlinks = options.symlinks || Object.create(null), setupIgnores(self, options), self.changedCwd = !1;
        var cwd = process.cwd();
        ownProp(options, "cwd") ? (self.cwd = options.cwd, self.changedCwd = path.resolve(options.cwd) !== cwd) : self.cwd = cwd, self.root = options.root || path.resolve(self.cwd, "/"), self.root = path.resolve(self.root), "win32" === process.platform && (self.root = self.root.replace(/\\/g, "/")), self.nomount = !!options.nomount, options.nonegate = options.nonegate === !1 ? !1 : !0, options.nocomment = options.nocomment === !1 ? !1 : !0, deprecationWarning(options), self.minimatch = new Minimatch(pattern, options), self.options = self.minimatch.options;
      }
      function deprecationWarning(options) {
        if (!(options.nonegate && options.nocomment || process.noDeprecation === !0 || exports.deprecationWarned)) {
          var msg = "glob WARNING: comments and negation will be disabled in v6";
          if (process.throwDeprecation)
            throw new Error(msg);
          process.traceDeprecation ? console.trace(msg) : console.error(msg), exports.deprecationWarned = !0;
        }
      }
      function finish(self) {
        for (var nou = self.nounique,
            all = nou ? [] : Object.create(null),
            i = 0,
            l = self.matches.length; l > i; i++) {
        ...
        if (nou || (all = Object.keys(all)), self.nosort || (all = all.sort(self.nocase ? alphasorti : alphasort)), self.mark) {
      ...
      exports.alphasort = alphasort, exports.alphasorti = alphasorti, exports.setopts = setopts, exports.ownProp = ownProp, exports.makeAbs = makeAbs, exports.finish = finish, exports.mark = mark, exports.isIgnored = isIgnored, exports.childrenIgnored = childrenIgnored;
      var path = __webpack_require__(5),
          minimatch = __webpack_require__(55),
          isAbsolute = __webpack_require__(58),
    ...
    (function(process) {
      function glob(pattern, options, cb) {
        if ("function" == typeof options && (cb = options, options = {}), options || (options = {}), options.sync) {
          if (cb)
      ...
      function Glob(pattern, options, cb) {
        ...
        this.matches = new Array(n), "function" == typeof cb && (cb = once(cb), this.on("error", cb), this.on("end", function(matches) {
          cb(null, matches);
        }));
        var self = this,
            n = this.minimatch.set.length;
        if (this._processing = 0, this.matches = new Array(n), this._emitQueue = [], this._processQueue = [], this.paused = !1, this.noprocess)
          return this;
        if (0 === n)
          return done();
        for (var i = 0; n > i; i++)
      ...
      var fs = __webpack_require__(6),
          minimatch = __webpack_require__(55),
          inherits = (minimatch.Minimatch, __webpack_require__(4)),
          EE = __webpack_require__(15).EventEmitter,
          path = __webpack_require__(5),
          assert = __webpack_require__(41),
          isAbsolute = __webpack_require__(58),
          globSync = __webpack_require__(232),
          common = __webpack_require__(84),
          setopts = (common.alphasort, common.alphasorti, common.setopts),
          ownProp = common.ownProp,
          inflight = __webpack_require__(238),
          util = __webpack_require__(8),
      ...
      glob.glob = glob, glob.hasMagic = function(pattern, options_) {
        ...
        found.forEach(function(p, i) {
          p = self._makeAbs(p), fs.realpath(p, self.realpathCache, function(er, real) {
            er ? "stat" === er.syscall ? set[p] = !0 : self.emit("error", er) : set[real] = !0, 0 === --n && (self.matches[index] = set, cb());
          });
        });
        ...
        if (assert(this instanceof Glob), assert("function" == typeof cb), !this.aborted) {
          if (this._processing++, this.paused)
            return void this._processQueue.push([pattern, index, inGlobStar, cb]);
          for (var n = 0; "string" == typeof pattern[n]; )
            n++;
          var prefix;
          switch (n) {
            case pattern.length:
          ...
          null === prefix ? read = "." : isAbsolute(prefix) || isAbsolute(pattern.join("/")) ? (prefix && isAbsolute(prefix) || (prefix = "/" + prefix), read = prefix) : read = prefix;
        ...
        for (var pn = remain[0],
          ...
          if ("." !== e.charAt(0) || dotOk) {
            var m;
            m = negate && !prefix ? !e.match(pn) : e.match(pn), m && matchedEntries.push(e);
          }
        }
        ...
        if (1 === remain.length && !this.mark && !this.stat) {
          ...
          for (var i = 0; len > i; i++) {
            ...
            prefix && (e = "/" !== prefix ? prefix + "/" + e : prefix + e), "/" !== e.charAt(0) || this.nomount || (e = path.join(this.root, e)), this._emitMatch(index, e);
          }
          return cb();
        }
        remain.shift();
        ...
        if (!this.aborted && !this.matches[index][e] && !isIgnored(this, e)) {
          if (this.paused)
            return void this._emitQueue.push([index, e]);
          var abs = this._makeAbs(e);
          if (this.nodir) {
            var c = this.cache[abs];
            if ("DIR" === c || Array.isArray(c))
              return;
          }
        ...
        function lstatcb_(er, lstat) {
          ...
          self.symlinks[abs] = isSym, isSym || lstat.isDirectory() ? self._readdir(abs, !1, cb) : (self.cache[abs] = "FILE", cb());
        }
        if (!this.aborted) {
          if (this.follow)
          ...
          var lstatkey = "lstat\x00" + abs,
              self = this,
              lstatcb = inflight(lstatkey, lstatcb_);
          lstatcb && fs.lstat(abs, lstatcb);
        }
      }, Glob.prototype._readdir = function(abs, inGlobStar, cb) {
        if (!this.aborted && (cb = inflight("readdir\x00" + abs + "\x00" + inGlobStar, cb))) {
        ...
        "win32" === process.platform && (prefix = prefix.replace(/\\/g, "/")), this._emitMatch(index, prefix), cb();
      }, Glob.prototype._stat = function(f, cb) {
        function lstatcb_(er, lstat) {
          return lstat && lstat.isSymbolicLink() ? fs.stat(abs, function(er, stat) {
            er ? self._stat2(f, abs, null, lstat, cb) : self._stat2(f, abs, er, stat, cb);
          }) : void self._stat2(f, abs, er, lstat, cb);
        }
        ...
        if (!this.stat && ownProp(this.cache, abs)) {
          var c = this.cache[abs];
          if (Array.isArray(c) && (c = "DIR"), !needDir || "DIR" === c)
            return cb(null, c);
          if (needDir && "FILE" === c)
            return cb();
        }
        ...
        var self = this,
            statcb = inflight("stat\x00" + abs, lstatcb_);
        statcb && fs.lstat(abs, statcb);
      }, Glob.prototype._stat2 = function(f, abs, er, stat, cb) {
        if (er)
          return this.statCache[abs] = !1, cb();
        var needDir = "/" === f.slice(-1);
        if (this.statCache[abs] = stat, "/" === abs.slice(-1) && !stat.isDirectory())
    ...
    (function(Buffer) {
      ...
      var through = __webpack_require__(235),
          fs = __webpack_require__(13),
          path = __webpack_require__(5),
          File = __webpack_require__(66),
          convert = __webpack_require__(167),
          stripBom = __webpack_require__(64),
          PLUGIN_NAME = "gulp-sourcemap",
          urlRegex = /^(https?|webpack(-[^:]+)?):\/\//;
      module.exports.init = function(options) {
        function sourceMapInit(file, encoding, callback) {
          if (file.isNull() || file.sourceMap)
            return this.push(file), callback();
          if (file.isStream())
          ...
          if (options && options.loadMaps) {
            var sourcePath = "";
            if (sourceMap = convert.fromSource(fileContent))
              sourceMap = sourceMap.toObject(), sourcePath = path.dirname(file.path), fileContent = convert.removeComments(fileContent);
            else {
              var mapFile,
                  mapComment = convert.mapFileCommentRegex.exec(fileContent);
              mapComment ? (mapFile = path.resolve(path.dirname(file.path), mapComment[1] || mapComment[2]), fileContent = convert.removeMapFileComments(fileContent)) : mapFile = file.path + ".map", sourcePath = path.dirname(mapFile);
              try {
                sourceMap = JSON.parse(stripBom(fs.readFileSync(mapFile, "utf8")));
              } catch (e) {}
            }
            sourceMap && (sourceMap.sourcesContent = sourceMap.sourcesContent || [], sourceMap.sources.forEach(function(source, i) {
              if (source.match(urlRegex))
                return void(sourceMap.sourcesContent[i] = sourceMap.sourcesContent[i] || null);
              var absPath = path.resolve(sourcePath, source);
              if (sourceMap.sources[i] = unixStylePath(path.relative(file.base, absPath)), !sourceMap.sourcesContent[i]) {
                var sourceContent = null;
                if (sourceMap.sourceRoot) {
                  if (sourceMap.sourceRoot.match(urlRegex))
                    return void(sourceMap.sourcesContent[i] = null);
                ...
                if (absPath === file.path)
                  ...
                  try {
                    options.debug && console.log(PLUGIN_NAME + '-init: No source content for "' + source + '". Loading from file.'), sourceContent = stripBom(fs.readFileSync(absPath, "utf8"));
                  } catch (e) {
                    options.debug && console.warn(PLUGIN_NAME + "-init: source file not found: " + absPath);
                  }
          ...
          }), sourceMap.file = unixStylePath(file.relative), file.sourceMap = sourceMap, this.push(file), callback();
        }
        return through.obj(sourceMapInit);
      }, module.exports.write = function(destPath, options) {
        function sourceMapWrite(file, encoding, callback) {
          ...
          if (sourceMap.file = unixStylePath(file.relative), sourceMap.sources = sourceMap.sources.map(function(filePath) {
            return unixStylePath(filePath);
          }), "function" == typeof options.sourceRoot ? sourceMap.sourceRoot = options.sourceRoot(file) : sourceMap.sourceRoot = options.sourceRoot, options.includeContent) {
            ...
            for (var i = 0; i < file.sourceMap.sources.length; i++)
              if (!sourceMap.sourcesContent[i]) {
                ...
                try {
                  options.debug && console.log(PLUGIN_NAME + '-write: No source content for "' + sourceMap.sources[i] + '". Loading from file.'), sourceMap.sourcesContent[i] = stripBom(fs.readFileSync(sourcePath, "utf8"));
                } catch (e) {
                  options.debug && console.warn(PLUGIN_NAME + "-write: source file not found: " + sourcePath);
                }
              }
            void 0 === sourceMap.sourceRoot ? sourceMap.sourceRoot = "/source/" : null === sourceMap.sourceRoot && (sourceMap.sourceRoot = void 0);
          } else
          ...
          if (destPath) {
            ...
            if (options.sourceMappingURLPrefix) {
              var prefix = "";
              prefix = "function" == typeof options.sourceMappingURLPrefix ? options.sourceMappingURLPrefix(file) : options.sourceMappingURLPrefix, sourceMapPathRelative = prefix + path.join("/", sourceMapPathRelative);
            }
            comment = commentFormatter(unixStylePath(sourceMapPathRelative)), options.sourceMappingURL && "function" == typeof options.sourceMappingURL && (comment = commentFormatter(options.sourceMappingURL(file)));
          } else {
            var base64Map = new Buffer(JSON.stringify(sourceMap)).toString("base64");
            comment = commentFormatter("data:application/json;base64," + base64Map);
          }
          options.addComment && (file.contents = Buffer.concat([file.contents, new Buffer(comment)])), this.push(file), callback();
        }
        return void 0 === options && "[object Object]" === Object.prototype.toString.call(destPath) && (options = destPath, destPath = void 0), options = options || {}, void 0 === options.includeContent && (options.includeContent = !0), void 0 === options.addComment && (options.addComment = !0), through.obj(sourceMapWrite);
      };
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports) {
    "use strict";
    ...
    function baseGet(object, path, pathKey) {
      if (null != object) {
        ...
        for (var index = 0,
            length = path.length; null != object && length > index; )
    ...
    var baseIsEqual = __webpack_require__(256),
        bindCallback = __webpack_require__(257),
        isArray = __webpack_require__(29),
        pairs = __webpack_require__(262),
        reIsDeepProp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,
        reIsPlainProp = /^\w*$/,
        rePropName = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g,
        reEscapeChar = /\\(\\)?/g;
    ...
    function createBaseEach(eachFunc, fromRight) {
      return function(collection, iteratee) {
        ...
        for (var index = fromRight ? length : -1,
            iterable = toObject(collection); (fromRight ? index-- : ++index < length) && iteratee(iterable[index], index, iterable) !== !1; )
          ;
        return collection;
      };
    }
    function createBaseFor(fromRight) {
      return function(object, iteratee, keysFunc) {
        for (var iterable = toObject(object),
            props = keysFunc(object),
            length = props.length,
            index = fromRight ? length : -1; fromRight ? index-- : ++index < length; ) {
          var key = props[index];
    ...
    "use strict";
    var PassThrough = __webpack_require__(280);
    module.exports = function() {
      function add(source) {
        return Array.isArray(source) ? (source.forEach(add), this) : (sources.push(source), source.once("end", remove.bind(null, source)), source.pipe(output, {end: !1}), this);
      }
      function isEmpty() {
      ...
      var sources = [],
          output = new PassThrough({objectMode: !0});
    ...
    (function(process) {
      function mkdirP(p, opts, f, made) {
        "function" == typeof opts ? (f = opts, opts = {}) : opts && "object" == typeof opts || (opts = {mode: opts});
        var mode = opts.mode,
            xfs = opts.fs || fs;
      ...
      module.exports = mkdirP.mkdirp = mkdirP.mkdirP = mkdirP, mkdirP.sync = function sync(p, opts, made) {
        opts && "object" == typeof opts || (opts = {mode: opts});
        var mode = opts.mode,
            xfs = opts.fs || fs;
    ...
    function Multipart(boundary) {
      return !this instanceof Multipart ? new Multipart(boundary) : (this.boundary = boundary || Math.random().toString(36).slice(2), Sandwich.call(this, {
        head: "--" + this.boundary + CRNL,
        tail: CRNL + "--" + this.boundary + "--",
        separator: CRNL + "--" + this.boundary + CRNL
      }), this._add = this.add, void(this.add = this.addPart));
    }
    var Sandwich = __webpack_require__(285).SandwichStream,
        stream = __webpack_require__(3),
        inherits = __webpack_require__(4),
        CRNL = "\r\n";
    module.exports = Multipart, inherits(Multipart, Sandwich), Multipart.prototype.addPart = function(part) {
      part = part || {};
      ...
      partStream.write(CRNL), part.body instanceof stream.Stream ? part.body.pipe(partStream) : partStream.end(part.body), this._add(partStream);
    };
  }, function(module, exports, __webpack_require__) {
    function parse(opts) {
      function parseRow(row) {
        try {
          ...
          opts.strict && this.emit("error", new Error("Could not parse row " + row.slice(0, 50) + "..."));
        }
      }
      return opts = opts || {}, opts.strict = opts.strict !== !1, split(parseRow);
    }
    ...
    var through = __webpack_require__(65),
        ...
        EOL = __webpack_require__(98).EOL;
    ...
    var Transform = __webpack_require__(60),
        util = __webpack_require__(9);
    util.inherits = __webpack_require__(4), util.inherits(PassThrough, Transform), PassThrough.prototype._transform = function(chunk, encoding, cb) {
      cb(null, chunk);
    };
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      ...
      function ReadableState(options, stream) {
        Duplex = Duplex || __webpack_require__(22), options = options || {}, this.objectMode = !!options.objectMode, stream instanceof Duplex && (this.objectMode = this.objectMode || !!options.readableObjectMode);
        var hwm = options.highWaterMark,
            defaultHwm = this.objectMode ? 16 : 16384;
        this.highWaterMark = hwm || 0 === hwm ? hwm : defaultHwm, this.highWaterMark = ~~this.highWaterMark, this.buffer = [], this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = !1, this.endEmitted = !1, this.reading = !1, this.sync = !0, this.needReadable = !1, this.emittedReadable = !1, this.readableListening = !1, this.defaultEncoding = options.defaultEncoding || "utf8", this.ranOut = !1, this.awaitDrain = 0, this.readingMore = !1, this.decoder = null, this.encoding = null, options.encoding && (StringDecoder || (StringDecoder = __webpack_require__(23).StringDecoder), this.decoder = new StringDecoder(options.encoding), this.encoding = options.encoding);
      }
      function Readable(options) {
        return Duplex = Duplex || __webpack_require__(22), this instanceof Readable ? (this._readableState = new ReadableState(options, this), this.readable = !0, options && "function" == typeof options.read && (this._read = options.read), void Stream.call(this)) : new Readable(options);
      }
 ...
 while (null !== chunk && state.flowing);
      ...
      function fromList(n, state) {
        ...
        if (0 === length)
          ...
          ret = stringMode ? list.join("") : 1 === list.length ? list[0] : Buffer.concat(list, length), list.length = 0;
          ...
          for (var c = 0,
              i = 0,
              l = list.length; l > i && n > c; i++) {
            var buf = list[0],
                cpy = Math.min(n - c, buf.length);
            stringMode ? ret += buf.slice(0, cpy) : buf.copy(ret, c, 0, cpy), cpy < buf.length ? list[0] = buf.slice(cpy) : list.shift(), c += cpy;
          }
        }
        return ret;
      }
      ...
      var Stream,
          EElistenerCount = (__webpack_require__(15), function(emitter, type) {
      ...
      !function() {
        try {
          ...
          Stream || (Stream = __webpack_require__(15).EventEmitter);
        }
      }();
      var Buffer = __webpack_require__(1).Buffer,
          util = __webpack_require__(9);
      util.inherits = __webpack_require__(4);
      var debug,
          debugUtil = __webpack_require__(336);
      ...
      Readable.prototype.push = function(chunk, encoding) {
        ...
        return state.objectMode || "string" != typeof chunk || (encoding = encoding || state.defaultEncoding, encoding !== state.encoding && (chunk = new Buffer(chunk, encoding), encoding = "")), readableAddChunk(this, state, chunk, encoding, !1);
        ...
        return StringDecoder || (StringDecoder = __webpack_require__(23).StringDecoder), this._readableState.decoder = new StringDecoder(enc), this._readableState.encoding = enc, this;
      };
      var MAX_HWM = 8388608;
      Readable.prototype.read = function(n) {
        ...
        var state = this._readableState,
            nOrig = n;
        if (("number" != typeof n || n > 0) && (state.emittedReadable = !1), 0 === n && state.needReadable && (state.length >= state.highWaterMark || state.ended))
        ...
        function ondata(chunk) {
          ...
          !1 === ret && (1 !== state.pipesCount || state.pipes[0] !== dest || 1 !== src.listenerCount("data") || cleanedUp || (debug("false write response, pause", src._readableState.awaitDrain), src._readableState.awaitDrain++), src.pause());
        }
        function onerror(er) {
        ...
        var cleanedUp = !1;
        return src.on("data", ondata), dest._events && dest._events.error ? isArray(dest._events.error) ? dest._events.error.unshift(onerror) : dest._events.error = [onerror, dest._events.error] : dest.on("error", onerror), dest.once("close", onclose), dest.once("finish", onfinish), dest.emit("pipe", src), state.flowing || (debug("pipe resume"), src.resume()), dest;
        ...
        for (var i in stream)
          void 0 === this[i] && "function" == typeof stream[i] && (this[i] = function(method) {
            return function() {
    ...
    function WritableState(options, stream) {
      Duplex = Duplex || __webpack_require__(22), options = options || {}, this.objectMode = !!options.objectMode, stream instanceof Duplex && (this.objectMode = this.objectMode || !!options.writableObjectMode);
      var hwm = options.highWaterMark,
          defaultHwm = this.objectMode ? 16 : 16384;
    ...
    function Writable(options) {
      return Duplex = Duplex || __webpack_require__(22), this instanceof Writable || this instanceof Duplex ? (this._writableState = new WritableState(options, this), this.writable = !0, options && ("function" == typeof options.write && (this._write = options.write), "function" == typeof options.writev && (this._writev = options.writev)), void Stream.call(this)) : new Writable(options);
    }
    ...
    function decodeChunk(state, chunk, encoding) {
      return state.objectMode || state.decodeStrings === !1 || "string" != typeof chunk || (chunk = new Buffer(chunk, encoding)), chunk;
    }
    function writeOrBuffer(stream, state, chunk, encoding, cb) {
    ...
    function onwrite(stream, er) {
      ...
      if (onwriteStateUpdate(state), er)
        ...
        finished || state.corked || state.bufferProcessing || !state.bufferedRequest || clearBuffer(stream, state), sync ? processNextTick(afterWrite, stream, state, finished, cb) : afterWrite(stream, state, finished, cb);
      }
    }
    function afterWrite(stream, state, finished, cb) {
      finished || onwriteDrain(stream, state), state.pendingcb--, cb(), finishMaybe(stream, state);
    ...
    function clearBuffer(stream, state) {
      ...
      if (stream._writev && entry && entry.next) {
        for (var buffer = [],
            cbs = []; entry; )
          cbs.push(entry.callback), buffer.push(entry), entry = entry.next;
        state.pendingcb++, state.lastBufferedRequest = null, doWrite(stream, state, !0, state.length, buffer, "", function(err) {
          for (var i = 0; i < cbs.length; i++)
            state.pendingcb--, cbs[i](err);
        });
      } else {
        for (; entry; ) {
          var chunk = entry.chunk,
              ...
              cb = entry.callback,
              len = state.objectMode ? 1 : chunk.length;
          if (doWrite(stream, state, !1, len, chunk, encoding, cb), entry = entry.next, state.writing)
            break;
        }
    ...
    function endWritable(stream, state, cb) {
      state.ending = !0, finishMaybe(stream, state), cb && (state.finished ? processNextTick(cb) : stream.once("finish", cb)), state.ended = !0;
    }
    module.exports = Writable;
    var processNextTick = __webpack_require__(59),
        Buffer = __webpack_require__(1).Buffer;
    ...
    util.inherits = __webpack_require__(4);
    var Stream,
        internalUtil = {deprecate: __webpack_require__(309)};
    !function() {
      try {
        Stream = __webpack_require__(3);
      } catch (_) {} finally {
    ...
    exports = module.exports = __webpack_require__(100), exports.Stream = Stream || exports, exports.Readable = exports, exports.Writable = __webpack_require__(101), exports.Duplex = __webpack_require__(22), exports.Transform = __webpack_require__(60), exports.PassThrough = __webpack_require__(99);
  }, function(module, exports) {
    "use strict";
    module.exports = function(ele, num) {
      for (var arr = new Array(num),
          i = 0; num > i; i++)
        arr[i] = ele;
      return arr;
    };
    ...
    (function(process) {
      ...
      function Readable(options) {
        ...
        return this instanceof Readable ? (this._readableState = new ReadableState(options, this), this.readable = !0, void Stream.call(this)) : new Readable(options);
      }
      function readableAddChunk(stream, state, chunk, encoding, addToFront) {
        var er = chunkInvalid(state, chunk);
        if (er)
      ...
      function howMuchToRead(n, state) {
        return 0 === state.length && state.ended ? 0 : state.objectMode ? 0 === n ? 0 : 1 : isNaN(n) || util.isNull(n) ? state.flowing && state.buffer.length ? state.buffer[0].length : state.length : 0 >= n ? 0 : (n > state.highWaterMark && (state.highWaterMark = roundUpToNextPowerOf2(n)), n > state.length ? state.ended ? state.length : (state.needReadable = !0, 0) : n);
      }
      function chunkInvalid(state, chunk) {
        var er = null;
        return util.isBuffer(chunk) || util.isString(chunk) || util.isNullOrUndefined(chunk) || state.objectMode || (er = new TypeError("Invalid non-string/buffer chunk")), er;
      }
      function onEofChunk(stream, state) {
      ...
      function emitReadable(stream) {
        var state = stream._readableState;
        state.needReadable = !1, state.emittedReadable || (debug("emitReadable", state.flowing), state.emittedReadable = !0, state.sync ? process.nextTick(function() {
      ...
      function pipeOnDrain(src) {
        return function() {
          var state = src._readableState;
          debug("pipeOnDrain", state.awaitDrain), state.awaitDrain && state.awaitDrain--, 0 === state.awaitDrain && EE.listenerCount(src, "data") && (state.flowing = !0, flow(src));
        };
      }
      function resume(stream, state) {
 ...
 while (null !== chunk && state.flowing);
      ...
      function fromList(n, state) {
        ...
        if (0 === length)
          ...
          ret = stringMode ? list.join("") : Buffer.concat(list, length), list.length = 0;
        else if (n < list[0].length) {
          var buf = list[0];
          ret = buf.slice(0, n), list[0] = buf.slice(n);
        } else if (n === list[0].length)
      ...
      util.inherits = __webpack_require__(4);
      var StringDecoder,
          debug = __webpack_require__(337);
      debug = debug && debug.debuglog ? debug.debuglog("stream") : function() {}, util.inherits(Readable, Stream), Readable.prototype.push = function(chunk, encoding) {
        var state = this._readableState;
        return util.isString(chunk) && !state.objectMode && (encoding = encoding || state.defaultEncoding, encoding !== state.encoding && (chunk = new Buffer(chunk, encoding), encoding = "")), readableAddChunk(this, state, chunk, encoding, !1);
      }, Readable.prototype.unshift = function(chunk) {
        var state = this._readableState;
        return readableAddChunk(this, state, chunk, "", !0);
      }, Readable.prototype.setEncoding = function(enc) {
      ...
      Readable.prototype.read = function(n) {
        ...
        var state = this._readableState,
            nOrig = n;
        if ((!util.isNumber(n) || n > 0) && (state.emittedReadable = !1), 0 === n && state.needReadable && (state.length >= state.highWaterMark || state.ended))
          return debug("read: emitReadable", state.length, state.ended), 0 === state.length && state.ended ? endReadable(this) : emitReadable(this), null;
        if (n = howMuchToRead(n, state), 0 === n && state.ended)
          return 0 === state.length && endReadable(this), null;
        var doRead = state.needReadable;
        debug("need readable", doRead), (0 === state.length || state.length - n < state.highWaterMark) && (doRead = !0, debug("length less than watermark", doRead)), (state.ended || state.reading) && (doRead = !1, debug("reading or ended", doRead)), doRead && (debug("do read"), state.reading = !0, state.sync = !0, 0 === state.length && (state.needReadable = !0), this._read(state.highWaterMark), state.sync = !1), doRead && !state.reading && (n = howMuchToRead(nOrig, state));
        var ret;
        return ret = n > 0 ? fromList(n, state) : null, util.isNull(ret) && (state.needReadable = !0, n = 0), state.length -= n, 0 !== state.length || state.ended || (state.needReadable = !0), nOrig !== n && state.ended && 0 === state.length && endReadable(this), util.isNull(ret) || this.emit("data", ret), ret;
      }, Readable.prototype._read = function(n) {
        this.emit("error", new Error("not implemented"));
      }, Readable.prototype.pipe = function(dest, pipeOpts) {
        function onunpipe(readable) {
        ...
        function ondata(chunk) {
          debug("ondata");
          var ret = dest.write(chunk);
          !1 === ret && (debug("false write response, pause", src._readableState.awaitDrain), src._readableState.awaitDrain++, src.pause());
        }
        function onerror(er) {
        ...
        var ondrain = pipeOnDrain(src);
        return dest.on("drain", ondrain), src.on("data", ondata), dest._events && dest._events.error ? isArray(dest._events.error) ? dest._events.error.unshift(onerror) : dest._events.error = [onerror, dest._events.error] : dest.on("error", onerror), dest.once("close", onclose), dest.once("finish", onfinish), dest.emit("pipe", src), state.flowing || (debug("pipe resume"), src.resume()), dest;
      }, Readable.prototype.unpipe = function(dest) {
        var state = this._readableState;
        if (0 === state.pipesCount)
          return this;
        ...
        if ("data" === ev && !1 !== this._readableState.flowing && this.resume(), "readable" === ev && this.readable) {
          ...
          if (!state.readableListening)
            if (state.readableListening = !0, state.emittedReadable = !1, state.needReadable = !0, state.reading)
        ...
        var state = this._readableState;
        return state.flowing || (debug("resume"), state.flowing = !0, state.reading || (debug("resume read 0"), this.read(0)), resume(this, state)), this;
      }, Readable.prototype.pause = function() {
        return debug("call pause flowing=%j", this._readableState.flowing), !1 !== this._readableState.flowing && (debug("pause"), this._readableState.flowing = !1, this.emit("pause")), this;
      }, Readable.prototype.wrap = function(stream) {
        var state = this._readableState,
        ...
        stream.on("end", function() {
          ...
          if (debug("wrapped data"), state.decoder && (chunk = state.decoder.write(chunk)), chunk && (state.objectMode || chunk.length)) {
            var ret = self.push(chunk);
            ret || (paused = !0, stream.pause());
          }
        });
        for (var i in stream)
          util.isFunction(stream[i]) && util.isUndefined(this[i]) && (this[i] = function(method) {
            return function() {
              return stream[method].apply(stream, arguments);
            };
          }(i));
    ...
    (function(global) {
      var ClientRequest = __webpack_require__(297),
          extend = __webpack_require__(17),
          statusCodes = __webpack_require__(163),
          url = __webpack_require__(110),
          http = exports;
    ...
    function ctor(options, fn) {
      ...
      var Filter = through2.ctor(options, function(chunk, encoding, callback) {
        return this.options.wantStrings && (chunk = chunk.toString()), fn.call(this, chunk, this._index++) && this.push(chunk), callback();
      });
      return Filter.prototype._index = 0, Filter;
    }
    function objCtor(options, fn) {
      return "function" == typeof options && (fn = options, options = {}), options = xtend({
        objectMode: !0,
        highWaterMark: 16
      }, options), ctor(options, fn);
    }
    ...
    function obj(options, fn) {
      return "function" == typeof options && (fn = options, options = {}), options = xtend({
        objectMode: !0,
        highWaterMark: 16
      }, options), make(options, fn);
    }
    module.exports = make, module.exports.ctor = ctor, module.exports.objCtor = objCtor, module.exports.obj = obj;
    var through2 = __webpack_require__(300),
        xtend = __webpack_require__(17);
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      function Duplex(options) {
      ...
      var Readable = __webpack_require__(301),
          Writable = __webpack_require__(303);
      util.inherits(Duplex, Readable), forEach(objectKeys(Writable.prototype), function(method) {
        Duplex.prototype[method] || (Duplex.prototype[method] = Writable.prototype[method]);
      });
    }).call(exports, __webpack_require__(2));
    ...
    var punycode = __webpack_require__(308);
    ...
    Url.prototype.parse = function(url, parseQueryString, slashesDenoteHost) {
      ...
      if (!hostlessProtocol[proto] && (slashes || proto && !slashedProtocol[proto])) {
        for (var hostEnd = -1,
            i = 0; i < hostEndingChars.length; i++) {
        ...
        if (!ipv6Hostname)
          for (var hostparts = this.hostname.split(/\./),
              i = 0,
              l = hostparts.length; l > i; i++) {
        ...
        if (this.hostname.length > hostnameMaxLen ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), !ipv6Hostname) {
          for (var domainArray = this.hostname.split("."),
              newOut = [],
              i = 0; i < domainArray.length; ++i) {
            var s = domainArray[i];
      ...
      var protocol = this.protocol || "",
          ...
          host = !1,
          query = "";
      this.host ? host = auth + this.host : this.hostname && (host = auth + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (host += ":" + this.port)), this.query && isObject(this.query) && Object.keys(this.query).length && (query = querystring.stringify(this.query));
    ...
    (function(process) {
      ...
      function booleanOrFunc(v, file) {
        return "boolean" != typeof v && "function" != typeof v ? null : "boolean" == typeof v ? v : v(file);
      }
      function stringOrFunc(v, file) {
        return "string" != typeof v && "function" != typeof v ? null : "string" == typeof v ? v : v(file);
      }
      function prepareWrite(outFolder, file, opt, cb) {
        var options = assign({
          ...
          overwrite: !0
            ...
            overwrite = booleanOrFunc(options.overwrite, file);
        options.flag = overwrite ? "w" : "wx";
        var cwd = path.resolve(options.cwd),
            outFolderPath = stringOrFunc(outFolder, file);
        if (!outFolderPath)
        ...
        var writePath = path.resolve(basePath, file.relative),
            writeFolder = path.dirname(writePath);
        file.stat = file.stat || new fs.Stats, file.stat.mode = options.mode, file.flag = options.flag, file.cwd = cwd, file.base = basePath, file.path = writePath, mkdirp(writeFolder, options.dirMode, function(err) {
          return err ? cb(err) : void cb(null, writePath);
        });
      }
      var assign = __webpack_require__(97),
          path = __webpack_require__(5),
          mkdirp = __webpack_require__(94),
          fs = __webpack_require__(process.browser ? 6 : 13);
    ...
    (function(process) {
      ...
      function streamFile(file, opt, cb) {
        file.contents = fs.createReadStream(file.path), opt.stripBOM && (file.contents = file.contents.pipe(stripBom())), cb(null, file);
      }
      var fs = __webpack_require__(process.browser ? 6 : 13),
          stripBom = __webpack_require__(299);
    ...
    function cleanPath(path, base) {
      return path ? base ? ("/" != base[base.length - 1] && (base += "/"), path = path.replace(base, ""), path = path.replace(/[\/]+/g, "/")) : path : "";
    }
    var x = module.exports = {};
    x.randomString = randomString, x.cleanPath = cleanPath;
  }, function(module, exports, __webpack_require__) {
    ...
    function wrappy(fn, cb) {
      function wrapper() {
        for (var args = new Array(arguments.length),
            i = 0; i < args.length; i++)
          args[i] = arguments[i];
    ...
    function diff(arr, arrays) {
      ...
      if (1 === argsLen)
        return arr;
      for (argsLen > 2 && (arrays = flatten(slice.call(arguments, 1))); ++i < len; )
        ~arrays.indexOf(arr[i]) || res.push(arr[i]);
      return res;
    }
    ...
    (function(Buffer) {
      ...
      exports.escapeJavaScript = function(input) {
        ...
        for (var escaped = "",
          ...
          escaped += internals.isSafe(charCode) ? input[i] : internals.escapeJavaScriptChar(charCode);
        }
        return escaped;
        ...
        for (var escaped = "",
            i = 0; i < input.length; ++i) {
          var charCode = input.charCodeAt(i);
          escaped += internals.isSafe(charCode) ? input[i] : internals.escapeHtmlChar(charCode);
        }
        return escaped;
        ...
        if ("undefined" != typeof namedEscape)
          return namedEscape;
        if (charCode >= 256)
          return "&#" + charCode + ";";
        var hexValue = new Buffer(String.fromCharCode(charCode), "ascii").toString("hex");
        ...
        return "undefined" != typeof internals.safeCharCodes[charCode];
      }, internals.namedHtml = {
        38: "&amp;",
        60: "&lt;",
        62: "&gt;",
        ...
        for (var safe = {},
            i = 32; 123 > i; ++i)
          (i >= 97 || i >= 65 && 90 >= i || i >= 48 && 57 >= i || 32 === i || 46 === i || 44 === i || 45 === i || 58 === i || 95 === i) && (safe[i] = null);
        return safe;
      }();
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports, __webpack_require__) {
    ...
    internals.parseValues = function(str, options) {
      for (var obj = {},
        ...
        if (-1 === pos)
          obj[Utils.decode(part)] = "", options.strictNullHandling && (obj[Utils.decode(part)] = null);
        else {
          var key = Utils.decode(part.slice(0, pos)),
              val = Utils.decode(part.slice(pos + 1));
          Object.prototype.hasOwnProperty.call(obj, key) ? obj[key] = [].concat(obj[key]).concat(val) : obj[key] = val;
        }
      }
      return obj;
      ...
      var obj,
          root = chain.shift();
      if ("[]" === root)
        obj = [], obj = obj.concat(internals.parseObject(chain, val, options));
      else {
        obj = options.plainObjects ? (0, _create2["default"])(null) : {};
        var cleanRoot = "[" === root[0] && "]" === root[root.length - 1] ? root.slice(1, root.length - 1) : root,
            index = parseInt(cleanRoot, 10);
        !isNaN(index) && root !== cleanRoot && String(index) === cleanRoot && index >= 0 && options.parseArrays && index <= options.arrayLimit ? (obj = [], obj[index] = internals.parseObject(chain, val, options)) : obj[cleanRoot] = internals.parseObject(chain, val, options);
      }
      return obj;
    ...
    internals.stringify = function(object, prefix, generateArrayPrefix, strictNullHandling, skipNulls, encode, filter, sort, allowDots) {
      ...
      if ("string" == typeof obj || "number" == typeof obj || "boolean" == typeof obj)
        return encode ? [Utils.encode(prefix) + "=" + Utils.encode(obj)] : [prefix + "=" + obj];
      var values = [];
      ...
      for (var i = 0; i < objKeys.length; ++i) {
        var key = objKeys[i];
        skipNulls && null === obj[key] || (values = Array.isArray(obj) ? values.concat(internals.stringify(obj[key], generateArrayPrefix(prefix, key), generateArrayPrefix, strictNullHandling, skipNulls, encode, filter, sort, allowDots)) : values.concat(internals.stringify(obj[key], prefix + (allowDots ? "." + key : "[" + key + "]"), generateArrayPrefix, strictNullHandling, skipNulls, encode, filter, sort, allowDots)));
      }
      return values;
      ...
      var objKeys,
          ...
          obj = object,
          options = opts || {},
          delimiter = "undefined" == typeof options.delimiter ? internals.delimiter : options.delimiter,
          strictNullHandling = "boolean" == typeof options.strictNullHandling ? options.strictNullHandling : internals.strictNullHandling,
          skipNulls = "boolean" == typeof options.skipNulls ? options.skipNulls : internals.skipNulls,
          encode = "boolean" == typeof options.encode ? options.encode : internals.encode,
          sort = "function" == typeof options.sort ? options.sort : null,
          allowDots = "undefined" == typeof options.allowDots ? !1 : options.allowDots;
      "function" == typeof options.filter ? (filter = options.filter, obj = filter("", obj)) : Array.isArray(options.filter) && (objKeys = filter = options.filter);
      var keys = [];
      if ("object" !== ("undefined" == typeof obj ? "undefined" : (0, _typeof3["default"])(obj)) || null === obj)
        return "";
      var arrayFormat;
      ...
      objKeys || (objKeys = (0, _keys2["default"])(obj)), sort && objKeys.sort(sort);
      for (var i = 0; i < objKeys.length; ++i) {
        var key = objKeys[i];
        skipNulls && null === obj[key] || (keys = keys.concat(internals.stringify(obj[key], key, generateArrayPrefix, strictNullHandling, skipNulls, encode, filter, sort, allowDots)));
      }
    ...
    (function(Buffer) {
      "use strict";
      var Boom = __webpack_require__(67),
          Hoek = __webpack_require__(24),
          Stream = __webpack_require__(3),
          internals = {};
      module.exports = internals.Recorder = function(options) {
        Stream.Writable.call(this), this.settings = options, this.buffers = [], this.length = 0;
      }, Hoek.inherits(internals.Recorder, Stream.Writable), internals.Recorder.prototype._write = function(chunk, encoding, next) {
        return this.settings.maxBytes && this.length + chunk.length > this.settings.maxBytes ? this.emit("error", Boom.badRequest("Payload content length greater than maximum allowed: " + this.settings.maxBytes)) : (this.length = this.length + chunk.length, this.buffers.push(chunk), void next());
      }, internals.Recorder.prototype.collect = function() {
        var buffer = 0 === this.buffers.length ? new Buffer(0) : 1 === this.buffers.length ? this.buffers[0] : Buffer.concat(this.buffers, this.length);
        return buffer;
      };
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports, __webpack_require__) {
    ...
    module.exports = internals.Tap = function() {
      Stream.Transform.call(this), this.buffers = [];
    }, Hoek.inherits(internals.Tap, Stream.Transform), internals.Tap.prototype._transform = function(chunk, encoding, next) {
      this.buffers.push(chunk), next(null, chunk);
    }, internals.Tap.prototype.collect = function() {
      return new Payload(this.buffers);
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var Wreck = __webpack_require__(69);
    module.exports = function(send) {
      return function(files, opts, cb) {
        return "function" == typeof opts && void 0 === cb && (cb = opts, opts = {}), "string" == typeof files && files.startsWith("http") ? Wreck.request("GET", files, null, function(err, res) {
          return err ? cb(err) : void send("add", null, opts, res, cb);
        }) : send("add", null, opts, files, cb);
      };
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var argCommand = __webpack_require__(10).argCommand;
    module.exports = function(send) {
      return {
        get: argCommand(send, "block/get"),
        stat: argCommand(send, "block/stat"),
        put: function(file, cb) {
          return Array.isArray(file) ? cb(null, new Error("block.put() only accepts 1 file")) : send("block/put", null, null, file, cb);
        }
      };
    };
  }, function(module, exports, __webpack_require__) {
    ...
    "use strict";
    var command = __webpack_require__(10).command;
    module.exports = function(send) {
    ...
    module.exports = function(send) {
      return {
        ...
        set: function(key, value, opts, cb) {
          return "function" == typeof opts && (cb = opts, opts = {}), send("config", [key, value], opts, null, cb);
        },
        show: function(cb) {
          return send("config/show", null, null, null, !0, cb);
        },
    ...
    var _typeof2 = __webpack_require__(19),
        _typeof3 = _interopRequireDefault(_typeof2),
        _promise = __webpack_require__(31),
        _promise2 = _interopRequireDefault(_promise),
        argCommand = __webpack_require__(10).argCommand;
    module.exports = function(send) {
      return {
        findprovs: argCommand(send, "dht/findprovs"),
        get: function(key, opts, cb) {
          "function" != typeof opts || cb || (cb = opts, opts = null);
          var handleResult = function(done, err, res) {
            if (err)
              return done(err);
            if (!res)
            ...
            if (Array.isArray(res) && (res = res[0]), 5 === res.Type)
              done(null, res.Extra);
            else {
          ...
          if ("function" != typeof cb && "undefined" != typeof _promise2["default"]) {
            var _ret = function() {
            ...
            if ("object" === ("undefined" == typeof _ret ? "undefined" : (0, _typeof3["default"])(_ret)))
              return _ret.v;
          }
          return send("dht/get", key, opts, null, handleResult.bind(null, cb));
        },
        put: function(key, value, opts, cb) {
          return "function" != typeof opts || cb || (cb = opts, opts = null), send("dht/put", [key, value], opts, null, cb);
        }
      };
    };
  }, function(module, exports, __webpack_require__) {
    ...
    "use strict";
    module.exports = function(send) {
      return function(idParam, cb) {
        return "function" == typeof idParam && (cb = idParam, idParam = null), send("id", idParam, null, null, cb);
      };
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _promise = __webpack_require__(31),
        _promise2 = _interopRequireDefault(_promise),
        ndjson = __webpack_require__(96);
    module.exports = function(send) {
      return {tail: function(cb) {
          return "function" != typeof cb && "undefined" != typeof _promise2["default"] ? send("log/tail", null, {}, null, !1).then(function(res) {
            return res.pipe(ndjson.parse());
          }) : send("log/tail", null, {}, null, !1, function(err, res) {
            return err ? cb(err) : void cb(null, res.pipe(ndjson.parse()));
          });
        }};
    };
  }, function(module, exports, __webpack_require__) {
    ...
    "use strict";
    module.exports = function(send) {
      return function(ipfs, ipns, cb) {
        "function" == typeof ipfs ? (cb = ipfs, ipfs = null) : "function" == typeof ipns && (cb = ipns, ipns = null);
        var opts = {};
        return ipfs && (opts.f = ipfs), ipns && (opts.n = ipns), send("mount", null, opts, null, cb);
      };
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    module.exports = function(send) {
      return {
        ...
        put: function(file, encoding, cb) {
          return "function" == typeof encoding ? cb(null, new Error("Must specify an object encoding ('json' or 'protobuf')")) : send("object/put", encoding, null, file, cb);
        },
    ...
    module.exports = function(send) {
      return {
        add: function(hash, opts, cb) {
          return "function" == typeof opts && (cb = opts, opts = null), send("pin/add", hash, opts, null, cb);
        },
        remove: function(hash, opts, cb) {
          return "function" == typeof opts && (cb = opts, opts = null), send("pin/rm", hash, opts, null, cb);
        },
        list: function(type, cb) {
          "function" == typeof type && (cb = type, type = null);
          var opts = null;
          return type && (opts = {type: type}), send("pin/ls", null, opts, null, cb);
        }
      };
    };
  }, function(module, exports, __webpack_require__) {
    ...
    module.exports = function(send) {
      return function(id, cb) {
        return "function" != typeof cb && "undefined" != typeof _promise2["default"] ? send("ping", id, {n: 1}, null).then(function(res) {
          return res[1];
        }) : send("ping", id, {n: 1}, null, function(err, res) {
          return err ? cb(err, null) : void cb(null, res[1]);
        });
      };
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var cmds = __webpack_require__(10);
    module.exports = function(send) {
      var refs = cmds.argCommand(send, "refs");
      return refs.local = cmds.command(send, "refs/local"), refs;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var cmds = __webpack_require__(10);
    ...
    (function(Buffer) {
      ...
      function getFilesStream(files, opts) {
        if (!files)
          return null;
        var adder = new Merge,
            single = new stream.PassThrough({objectMode: !0});
        adder.add(single);
        for (var i = 0; i < files.length; i++) {
          ...
          if ("string" == typeof file) {
            var srcOpts = {
              buffer: !1,
              stripBOM: !1,
              followSymlinks: null != opts.followSymlinks ? opts.followSymlinks : !0
            };
            adder.add(vinylfs.src(file, srcOpts)), opts.recursive && adder.add(vinylfs.src(file + "/**/*", srcOpts));
          } else
            single.push(vinylFile(file));
        }
        return single.end(), adder.pipe(vmps());
      }
      function vinylFile(file) {
        ...
        return file.contents && file.path ? (f.path = file.path, f.cwd = file.cwd || f.cwd, f.base = file.base || f.base, f.contents = file.contents) : f.contents = file, f.contents = vinylContentsSafe(f.contents), new File(f);
      }
      ...
      var File = __webpack_require__(66),
          vinylfs = __webpack_require__(311),
          vmps = __webpack_require__(327),
          stream = __webpack_require__(3),
    ...
    (function(global) {
      ...
      function requireCommands() {
        return isNode ? __webpack_require__(6)("./api") : {
          add: __webpack_require__(125),
          block: __webpack_require__(126),
          cat: __webpack_require__(127),
          commands: __webpack_require__(128),
          config: __webpack_require__(129),
          dht: __webpack_require__(130),
          diag: __webpack_require__(131),
          id: __webpack_require__(132),
          log: __webpack_require__(133),
          ls: __webpack_require__(134),
          mount: __webpack_require__(135),
          name: __webpack_require__(136),
          object: __webpack_require__(137),
          pin: __webpack_require__(138),
          ping: __webpack_require__(139),
          refs: __webpack_require__(140),
          swarm: __webpack_require__(141),
          update: __webpack_require__(142),
      ...
      function loadCommands(send) {
        var files = requireCommands(),
            cmds = {};
        return (0, _keys2["default"])(files).forEach(function(file) {
    ...
    (function(global) {
      ...
      function onRes(buffer, cb) {
        return function(err, res) {
          ...
          var stream = !!res.headers["x-stream-output"],
              chunkedObjects = !!res.headers["x-chunked-output"],
              isJson = res.headers["content-type"] && 0 === res.headers["content-type"].indexOf("application/json");
          if (res.statusCode >= 400 || !res.statusCode) {
            var _ret = function() {
              var error = new Error("Server responded with " + res.statusCode);
              return {v: Wreck.read(res, {json: !0}, function(err, payload) {
                  return err ? cb(err) : (payload && (error.code = payload.Code, error.message = payload.Message), void cb(error));
                })};
            }();
            if ("object" === ("undefined" == typeof _ret ? "undefined" : (0, _typeof3["default"])(_ret)))
              return _ret.v;
          }
          return stream && !buffer ? cb(null, res) : chunkedObjects ? isJson ? parseChunkedJson(res, cb) : Wreck.read(res, null, cb) : void Wreck.read(res, {json: isJson}, cb);
        };
      }
      function requestAPI(config, path, args, qs, files, buffer, cb) {
        if (qs = qs || {}, Array.isArray(path) && (path = path.join("/")), args && !Array.isArray(args) && (args = [args]), args && (qs.arg = args), files && !Array.isArray(files) && (files = [files]), qs.r && (qs.recursive = qs.r, delete qs.r), !isNode && qs.recursive && "add" === path)
          return cb(new Error("Recursive uploads are not supported in the browser"));
        qs["stream-channels"] = !0;
        var stream = void 0;
        files && (stream = getFilesStream(files, qs)), delete qs.followSymlinks;
        ...
        if (isNode && (opts.headers["User-Agent"] = config["user-agent"]), files) {
          if (!stream.boundary)
            return cb(new Error("No boundary in multipart stream"));
          opts.headers["Content-Type"] = "multipart/form-data; boundary=" + stream.boundary, opts.downstreamRes = stream, opts.payload = stream;
        }
      ...
      var _promise = __webpack_require__(31),
          ...
          _typeof2 = __webpack_require__(19),
          _typeof3 = _interopRequireDefault(_typeof2),
          Wreck = __webpack_require__(69),
          Qs = __webpack_require__(120),
          ndjson = __webpack_require__(96),
          getFilesStream = __webpack_require__(145),
          isNode = !global.window;
      exports = module.exports = function(config) {
        return function(path, args, qs, files, buffer, cb) {
          return "function" == typeof buffer && (cb = buffer, buffer = !1), "function" != typeof cb && "undefined" != typeof _promise2["default"] ? new _promise2["default"](function(resolve, reject) {
            requestAPI(config, path, args, qs, files, buffer, function(err, res) {
              return err ? reject(err) : void resolve(res);
            });
          }) : requestAPI(config, path, args, qs, files, buffer, cb);
        };
      };
    }).call(exports, function() {
      return this;
    ...
    module.exports = {
      "default": __webpack_require__(172),
      __esModule: !0
    };
  }, function(module, exports, __webpack_require__) {
    module.exports = {
    ...
    function range(a, b, str) {
      var begs,
          ...
          i = ai;
      if (ai >= 0 && bi > 0) {
        for (begs = [], left = str.length; i < str.length && i >= 0 && !result; )
          i == ai ? (begs.push(i), ai = str.indexOf(a, i + 1)) : 1 == begs.length ? result = [begs.pop(), bi] : (beg = begs.pop(), left > beg && (left = beg, right = bi), bi = str.indexOf(b, i + 1)), i = bi > ai && ai >= 0 ? ai : bi;
    ...
    !function(exports) {
      ...
      function b64ToByteArray(b64) {
        ...
        for (i = 0, j = 0; l > i; i += 4, j += 3)
          tmp = decode(b64.charAt(i)) << 18 | decode(b64.charAt(i + 1)) << 12 | decode(b64.charAt(i + 2)) << 6 | decode(b64.charAt(i + 3)), push((16711680 & tmp) >> 16), push((65280 & tmp) >> 8), push(255 & tmp);
      ...
      function uint8ToBase64(uint8) {
        ...
        for (i = 0, length = uint8.length - extraBytes; length > i; i += 3)
          temp = (uint8[i] << 16) + (uint8[i + 1] << 8) + uint8[i + 2], output += tripletToBase64(temp);
        switch (extraBytes) {
          case 1:
    ...
    function expandTop(str) {
      return str ? expand(escapeBraces(str), !0).map(unescapeBraces) : [];
    }
    ...
    function expand(str, isTop) {
      ...
      var isNumericSequence = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(m.body),
          ...
          isOptions = /^(.*,)+(.+)?$/.test(m.body);
      if (!isSequence && !isOptions)
        return m.post.match(/,.*\}/) ? (str = m.pre + "{" + m.body + escClose + m.post, expand(str)) : [str];
      var n;
      if (isSequence)
        n = m.body.split(/\.\./);
      else if (n = parseCommaParts(m.body), 1 === n.length && (n = expand(n[0], !1).map(embrace), 1 === n.length)) {
      ...
      if (isSequence) {
        var x = numeric(n[0]),
            ...
            incr = 3 == n.length ? Math.abs(numeric(n[2])) : 1,
            test = lte,
            reverse = x > y;
    ...
    var concatMap = __webpack_require__(166),
        balanced = __webpack_require__(157);
    ...
    function braces(str, arr, options) {
      if ("" === str)
        return [];
      Array.isArray(arr) || (options = arr, arr = []);
      var opts = options || {};
      arr = arr || [], "undefined" == typeof opts.nodupes && (opts.nodupes = !0);
      var es6,
          fn = opts.fn;
      "function" == typeof opts && (fn = opts, opts = {}), patternRe instanceof RegExp || (patternRe = patternRegex());
      ...
      switch (m) {
        ...
        case "${":
          ...
          es6 = !0, str = tokens.before(str, es6Regex());
      }
      ...
      var segs,
          segsLength;
      if (-1 !== inner.indexOf(".."))
        segs = expand(inner, opts, fn) || inner.split(","), segsLength = segs.length;
      else {
        if ('"' === inner[0] || "'" === inner[0])
          return arr.concat(str.split(/['"]/).join(""));
        if (segs = inner.split(","), opts.makeRe)
          return braces(str.replace(outter, wrap(segs, "|")), opts);
        segsLength = segs.length, 1 === segsLength && opts.bash && (segs[0] = wrap(segs[0], "\\"));
      }
      for (var val,
          len = segs.length,
          i = 0; len--; ) {
        var path = segs[i++];
        if (/(\.[^.\/])/.test(path))
          return segsLength > 1 ? segs : [str];
        if (val = splice(str, outter, path), /\{[^{}]+?\}/.test(val))
          arr = braces(val, arr, opts);
        else if ("" !== val) {
          if (opts.nodupes && -1 !== arr.indexOf(val))
            continue;
    ...
    function exponential(str, options, fn) {
      "function" == typeof options && (fn = options, options = null);
      var res,
          opts = options || {},
          esc = "__ESC_EXP__",
          exp = 0,
      ...
      exp = parts.length - 1, res = fn(parts.join(esc), opts);
      for (var len = res.length,
          arr = [],
          i = 0; len--; ) {
        var ele = res[i++],
            idx = ele.indexOf(esc);
        if (-1 === idx)
          arr.push(ele);
        else if (ele = ele.split("__ESC_EXP__").join(""), ele && opts.nodupes !== !1)
          arr.push(ele);
        else {
    ...
    function wrap(val, ch) {
      return "|" === ch ? "(" + val.join(ch) + ")" : "," === ch ? "{" + val.join(ch) + "}" : "-" === ch ? "[" + val.join(ch) + "]" : "\\" === ch ? "\\{" + val + "\\}" : void 0;
    }
    ...
    function escapeBraces(str, arr, opts) {
      return /\{[^{]+\{/.test(str) ? (str = str.split("\\{").join("__LT_BRACE__"), str = str.split("\\}").join("__RT_BRACE__"), map(braces(str, arr, opts), function(ele) {
        return ele = ele.split("__LT_BRACE__").join("{"), ele.split("__RT_BRACE__").join("}");
      })) : arr.concat(str.split("\\").join(""));
    }
    function escapeDots(str, arr, opts) {
      return /[^\\]\..+\\\./.test(str) ? (str = str.split("\\.").join("__ESC_DOT__"), map(braces(str, arr, opts), function(ele) {
        return ele.split("__ESC_DOT__").join(".");
      })) : arr.concat(str.split("\\").join(""));
    }
    function escapePaths(str, arr, opts) {
      return str = str.split("/.").join("__ESC_PATH__"), map(braces(str, arr, opts), function(ele) {
        return ele.split("__ESC_PATH__").join("/.");
      });
    }
    function escapeCommas(str, arr, opts) {
      return /\w,/.test(str) ? (str = str.split("\\,").join("__ESC_COMMA__"), map(braces(str, arr, opts), function(ele) {
    ...
    var Stat = __webpack_require__(6).Stats;
        ...
        function clone(parent, circular, depth, prototype) {
          function _clone(parent, depth) {
            ...
            if (clone.__isArray(parent))
              ...
              child = new RegExp(parent.source, __getRegExpFlags(parent)), parent.lastIndex && (child.lastIndex = parent.lastIndex);
            else if (clone.__isDate(parent))
              child = new Date(parent.getTime());
            else {
              if (useBuffer && Buffer.isBuffer(parent))
                return child = new Buffer(parent.length), parent.copy(child), child;
    ...
    (function(Buffer) {
      ...
      function Converter(sm, opts) {
        opts = opts || {}, opts.isFileComment && (sm = readFromFileMap(sm, opts.commentFileDir)), opts.hasComment && (sm = stripComment(sm)), opts.isEncoded && (sm = decodeBase64(sm)), (opts.isJSON || opts.isEncoded) && (sm = JSON.parse(sm)), this.sourcemap = sm;
      }
      function convertFromLargeSource(content) {
        for (var line,
            lines = content.split("\n"),
            i = lines.length - 1; i > 0; i--)
          if (line = lines[i], ~line.indexOf("sourceMappingURL=data:"))
            return exports.fromComment(line);
      }
      var fs = __webpack_require__(6),
          path = __webpack_require__(5),
          commentRx = /^\s*\/(?:\/|\*)[@#]\s+sourceMappingURL=data:(?:application|text)\/json;(?:charset[:=]\S+;)?base64,(.*)$/gm,
          mapFileCommentRx = /(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^\*]+?)[ \t]*(?:\*\/){1}[ \t]*$)/gm;
      Converter.prototype.toJSON = function(space) {
        ...
        var base64 = this.toBase64(),
            data = "sourceMappingURL=data:application/json;base64," + base64;
        ...
        return new Converter(base64, {isEncoded: !0});
      }, exports.fromComment = function(comment) {
        return comment = comment.replace(/^\/\*/g, "//").replace(/\*\/$/g, ""), new Converter(comment, {
          isEncoded: !0,
          hasComment: !0
        });
        ...
        return commentRx.lastIndex = 0, m ? exports.fromComment(m.pop()) : null;
      }, exports.fromMapFileSource = function(content, dir) {
        var m = content.match(mapFileCommentRx);
        return mapFileCommentRx.lastIndex = 0, m ? exports.fromMapFileComment(m.pop(), dir) : null;
      }, exports.removeComments = function(src) {
        return commentRx.lastIndex = 0, src.replace(commentRx, "");
      }, exports.removeMapFileComments = function(src) {
        return mapFileCommentRx.lastIndex = 0, src.replace(mapFileCommentRx, "");
      }, Object.defineProperty(exports, "commentRegex", {get: function() {
          return commentRx.lastIndex = 0, commentRx;
        }}), Object.defineProperty(exports, "mapFileCommentRegex", {get: function() {
          return mapFileCommentRx.lastIndex = 0, mapFileCommentRx;
        }});
    }).call(exports, __webpack_require__(1).Buffer);
  }, function(module, exports, __webpack_require__) {
    ...
    __webpack_require__(205), module.exports = __webpack_require__(11).Object.assign;
  }, function(module, exports, __webpack_require__) {
    var $ = __webpack_require__(7);
    ...
    var $ = __webpack_require__(7);
    __webpack_require__(206), module.exports = function(it, key) {
      return $.getDesc(it, key);
    };
  }, function(module, exports, __webpack_require__) {
    var $ = __webpack_require__(7);
    __webpack_require__(207), module.exports = function(it) {
      return $.getNames(it);
    };
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(208), module.exports = __webpack_require__(11).Object.getPrototypeOf;
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(209), module.exports = __webpack_require__(11).Object.keys;
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(210), module.exports = __webpack_require__(11).Object.setPrototypeOf;
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(79), __webpack_require__(80), __webpack_require__(81), __webpack_require__(211), module.exports = __webpack_require__(11).Promise;
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(212), __webpack_require__(79), module.exports = __webpack_require__(11).Symbol;
  }, function(module, exports, __webpack_require__) {
    __webpack_require__(80), __webpack_require__(81), module.exports = __webpack_require__(12)("iterator");
  }, function(module, exports) {
    module.exports = function() {};
  }, function(module, exports, __webpack_require__) {
    var isObject = __webpack_require__(34),
    ...
    var $ = __webpack_require__(7),
        ...
        setToStringTag = __webpack_require__(36),
        IteratorPrototype = {};
    __webpack_require__(46)(IteratorPrototype, __webpack_require__(12)("iterator"), function() {
      return this;
    ...
    var head,
        ...
        flush = function() {
          var parent,
              domain,
              fn;
          for (isNode && (parent = process.domain) && (process.domain = null, parent.exit()); head; )
            domain = head.domain, fn = head.fn, domain && domain.enter(), fn(), domain && domain.exit(), head = head.next;
    ...
    if (isNode)
      ...
      notify = Promise && Promise.resolve ? function() {
    ...
    module.exports = __webpack_require__(33)(function() {
      ...
      for (var T = toObject(target),
          $$ = arguments,
          $$len = $$.length,
          index = 1,
          getKeys = $.getKeys,
          getSymbols = $.getSymbols,
          isEnum = $.isEnum; $$len > index; )
        for (var key,
            S = IObject($$[index++]),
    ...
    var toIObject = __webpack_require__(28);
    __webpack_require__(35)("getOwnPropertyDescriptor", function($getOwnPropertyDescriptor) {
    ...
    var Wrapper,
        ...
        anObject = __webpack_require__(20),
        aFunction = __webpack_require__(43),
        strictNew = __webpack_require__(199),
        ...
        USE_NATIVE = function() {
          ...
          var works = !1;
          try {
            if (works = P && P.resolve && testResolve(), setProto(P2, P), P2.prototype = $.create(P.prototype, {constructor: {value: P2}}), P2.resolve(5).then(function() {}) instanceof P2 || (works = !1), works && __webpack_require__(32)) {
        ...
        isUnhandled = function(promise) {
          ...
          if (record.h)
            return !1;
          for (; chain.length > i; )
            if (reaction = chain[i++], reaction.fail || !isUnhandled(reaction.promise))
              return !1;
          return !0;
        },
    ...
    USE_NATIVE || (P = function(executor) {
      ...
      then: function(onFulfilled, onRejected) {
        var reaction = new PromiseCapability(speciesConstructor(this, P)),
            ...
            record = this._d;
        return reaction.ok = "function" == typeof onFulfilled ? onFulfilled : !0, reaction.fail = "function" == typeof onRejected && onRejected, record.c.push(reaction), record.a && record.a.push(reaction), record.s && notify(record, !1), promise;
      },
      "catch": function(onRejected) {
        return this.then(void 0, onRejected);
      }
    })), $export($export.G + $export.W + $export.F * !USE_NATIVE, {Promise: P}), __webpack_require__(36)(P, PROMISE), __webpack_require__(197)(PROMISE), Wrapper = __webpack_require__(11)[PROMISE], $export($export.S + $export.F * !USE_NATIVE, PROMISE, {reject: function(r) {
        var capability = new PromiseCapability(this),
            $$reject = capability.reject;
        return $$reject(r), capability.promise;
      }}), $export($export.S + $export.F * (!USE_NATIVE || testResolve(!0)), PROMISE, {resolve: function(x) {
    ...
    var $ = __webpack_require__(7),
        ...
        setSymbolDesc = DESCRIPTORS && $fails(function() {
          return 7 != _create(setDesc({}, "a", {get: function() {
        ...
        $defineProperty = function(it, key, D) {
          return D && has(AllSymbols, key) ? (D.enumerable ? (has(it, HIDDEN) && it[HIDDEN][key] && (it[HIDDEN][key] = !1), D = _create(D, {enumerable: createDesc(0, !1)})) : (has(it, HIDDEN) || setDesc(it, HIDDEN, createDesc(1, {})), it[HIDDEN][key] = !0), setSymbolDesc(it, key, D)) : setDesc(it, key, D);
        },
        ...
        $getOwnPropertyNames = function(it) {
          for (var key,
              names = getNames(toIObject(it)),
              result = [],
              i = 0; names.length > i; )
            has(AllSymbols, key = names[i++]) || key == HIDDEN || result.push(key);
          return result;
        },
    ...
    }, $.create = $create, $.isEnum = $propertyIsEnumerable, $.getDesc = $getOwnPropertyDescriptor, $.setDesc = $defineProperty, $.setDescs = $defineProperties, $.getNames = $names.get = $getOwnPropertyNames, $.getSymbols = $getOwnPropertySymbols, DESCRIPTORS && !__webpack_require__(47) && redefine(ObjectProto, "propertyIsEnumerable", $propertyIsEnumerable, !0));
    var symbolStatics = {
      "for": function(key) {
    ...
    }), setter = !0, $export($export.G + $export.W, {Symbol: $Symbol}), $export($export.S, "Symbol", symbolStatics), $export($export.S + $export.F * !useNative, "Object", {
      create: $create,
    ...
    }), $JSON && $export($export.S + $export.F * (!useNative || buggyJSON), "JSON", {stringify: $stringify}), setToStringTag($Symbol, "Symbol"), setToStringTag(Math, "Math", !0), setToStringTag(global.JSON, "JSON", !0);
  }, function(module, exports, __webpack_require__) {
    (function(Buffer) {
      function Hmac(alg, key) {
        if (!(this instanceof Hmac))
          return new Hmac(alg, key);
        this._opad = opad, this._alg = alg;
        var blocksize = "sha512" === alg ? 128 : 64;
        key = this._key = Buffer.isBuffer(key) ? key : new Buffer(key), key.length > blocksize ? key = createHash(alg).update(key).digest() : key.length < blocksize && (key = Buffer.concat([key, zeroBuffer], blocksize));
        for (var ipad = this._ipad = new Buffer(blocksize),
      ...
      zeroBuffer.fill(0), module.exports = Hmac, Hmac.prototype.update = function(data, enc) {
    ...
    (function(Buffer) {
      function toArray(buf, bigEndian) {
        ...
        for (var arr = [],
            ...
            i = 0; i < buf.length; i += intSize)
          arr.push(fn.call(buf, i));
        return arr;
      }
      function toBuffer(arr, size, bigEndian) {
        for (var buf = new Buffer(size),
    ...
    (function(Buffer) {
      ...
      exports.createHash = __webpack_require__(82), exports.createHmac = __webpack_require__(213), exports.randomBytes = function(size, callback) {
      ...
      exports.pbkdf2 = p.pbkdf2, exports.pbkdf2Sync = p.pbkdf2Sync, each(["createCredentials", "createCipher", "createCipheriv", "createDecipher", "createDecipheriv", "createSign", "createVerify", "createDiffieHellman"], function(name) {
    ...
    var pbkdf2Export = __webpack_require__(274);
    module.exports = function(crypto, exports) {
      exports = exports || {};
      var exported = pbkdf2Export(crypto);
      return exports.pbkdf2 = exported.pbkdf2, exports.pbkdf2Sync = exported.pbkdf2Sync, exports;
    };
  }, function(module, exports, __webpack_require__) {
    (function(global, Buffer) {
      !function() {
        var g = ("undefined" == typeof window ? global : window) || {};
        _crypto = g.crypto || g.msCrypto || __webpack_require__(335), module.exports = function(size) {
          if (_crypto.getRandomValues) {
            var bytes = new Buffer(size);
            return _crypto.getRandomValues(bytes), bytes;
          }
    ...
    var once = __webpack_require__(57),
        ...
        eos = function(stream, opts, callback) {
          ...
          var ws = stream._writableState,
              ...
              readable = opts.readable || opts.readable !== !1 && stream.readable,
              writable = opts.writable || opts.writable !== !1 && stream.writable,
              onlegacyfinish = function() {
                stream.writable || onfinish();
              },
              onfinish = function() {
                writable = !1, readable || callback();
              },
              onend = function() {
                readable = !1, writable || callback();
              },
              onclose = function() {
                return (!readable || rs && rs.ended) && (!writable || ws && ws.ended) ? void 0 : callback(new Error("premature close"));
              },
              onrequest = function() {
    ...
    function brackets(str) {
      var negated = !1;
      -1 !== str.indexOf("[^") && (negated = !0, str = str.split("[^").join("[")), -1 !== str.indexOf("[!") && (negated = !0, str = str.split("[!").join("["));
      for (var a = str.split("["),
          b = str.split("]"),
          ...
          res = []; len--; ) {
        var inner = parts[i++];
        ("^[!" === inner || "[!" === inner) && (inner = "", negated = !0);
        var prefix = negated ? "^" : "",
            ch = POSIX[inner];
        ch ? res.push("[" + prefix + ch + "]") : inner && (/^\[?\w-\w\]?$/.test(inner) ? i === parts.length ? res.push("[" + prefix + inner) : 1 === i ? res.push(prefix + inner + "]") : res.push(prefix + inner) : 1 === i ? beg += inner : i === parts.length ? end += inner : res.push("[" + prefix + inner + "]"));
      }
      var result = res.join("|"),
          rlen = res.length || 1;
      return rlen > 1 && (result = "(?:" + result + ")", rlen = 1), beg && (rlen++, "[" === beg.charAt(0) && (imbalanced ? beg = "\\[" + beg.slice(1) : beg += "]"), result = beg + result), end && (rlen++, "]" === end.slice(-1) && (end = imbalanced ? end.slice(0, end.length - 1) + "\\]" : "[" + end), result += end), rlen > 1 && (result = result.split("][").join("]|["), -1 === result.indexOf("|") || /\(\?/.test(result) || (result = "(?:" + result + ")")), result = result.replace(/\[+=|=\]+/g, "\\b");
    }
    var POSIX = {
      alnum: "a-zA-Z0-9",
      alpha: "a-zA-Z",
    ...
    module.exports = brackets, brackets.makeRe = function(pattern) {
      try {
      ...
      for (var len = arr.length,
          i = 0,
          res = arr.slice(),
          re = brackets.makeRe(pattern); len > i; ) {
        var ele = arr[i++];
    ...
    module.exports = function(str, options, fn) {
      ...
      "function" == typeof options && (fn = options, options = {}), "boolean" == typeof options && (options = {}, options.makeRe = !0);
      var opts = options || {},
          args = str.split(".."),
          len = args.length;
      return len > 3 ? str : 1 === len ? args : ("boolean" == typeof fn && fn === !0 && (opts.makeRe = !0), args.push(opts), fill.apply(fill, args.concat(fn)));
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function assign(a, b) {
      for (var key in b)
        hasOwn(b, key) && (a[key] = b[key]);
    }
    ...
    var hasOwn = Object.prototype.hasOwnProperty,
        ...
        isPlainObject = function(obj) {
          if (!obj || "[object Object]" !== toStr.call(obj))
            return !1;
    ...
    module.exports = function extend() {
      var options,
          ...
          deep = !1;
      for ("boolean" == typeof target ? (deep = target, target = arguments[1] || {}, i = 2) : ("object" != typeof target && "function" != typeof target || null == target) && (target = {}); length > i; ++i)
        if (options = arguments[i], null != options)
          for (name in options)
            src = target[name], copy = options[name], target !== copy && (deep && copy && (isPlainObject(copy) || (copyIsArray = isArray(copy))) ? (copyIsArray ? (copyIsArray = !1, clone = src && isArray(src) ? src : []) : clone = src && isPlainObject(src) ? src : {}, target[name] = extend(deep, clone, copy)) : "undefined" != typeof copy && (target[name] = copy));
      return target;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function extglob(str, opts) {
      ...
      var o = {},
          i = 0;
      str = str.replace(/!\(([^\w*()])/g, "$1!("), str = str.replace(/([*\/])\.!\([*]\)/g, function(m, ch) {
        return escape("/" === ch ? "\\/[^.]+" : "[^.]+");
      });
      var key = str + String(!!opts.regex) + String(!!opts.contains) + String(!!opts.escape);
      if (cache.hasOwnProperty(key))
        return cache[key];
      re instanceof RegExp || (re = regex()), opts.negate = !1;
      for (var m; m = re.exec(str); ) {
        var prefix = m[1],
            inner = m[3];
        "!" === prefix && (opts.negate = !0);
        var id = "__EXTGLOB_" + i++ + "__";
        o[id] = wrap(inner, prefix, opts.escape), str = str.split(m[0]).join(id);
      }
      for (var keys = Object.keys(o),
          len = keys.length; len--; ) {
        var prop = keys[len];
        str = str.split(prop).join(o[prop]);
      }
      var result = opts.regex ? toRegex(str, opts.contains, opts.negate) : str;
      return result = result.split(".").join("\\."), cache[key] = result;
    }
    function wrap(inner, prefix, esc) {
      switch (esc && (inner = escape(inner)), prefix) {
        case "!":
          return "(?!" + inner + ")[^/]" + (esc ? "%%%~" : "*?");
        case "@":
          return "(?:" + inner + ")";
    ...
    function escape(str) {
      return str = str.split("*").join("[^/]%%%~"), str = str.split(".").join("\\.");
    }
    function regex() {
      return /(\\?[@?!+*$]\\?)(\(([^()]*?)\))/;
    }
    ...
    function toRegex(pattern, contains, isNegated) {
      var prefix = contains ? "^" : "",
          after = contains ? "$" : "";
      return pattern = "(?:" + pattern + ")" + after, isNegated && (pattern = prefix + negate(pattern)), new RegExp(prefix + pattern);
    }
    var re,
    ...
    function fillRange(a, b, step, options, fn) {
      ...
      "function" == typeof step && (fn = step, options = {}, step = null), "function" == typeof options && (fn = options, options = {}), isObject(step) && (options = step, step = "");
      var expand,
          regex = !1,
          sep = "",
          opts = options || {};
      "undefined" == typeof opts.silent && (opts.silent = !0), step = step || opts.step;
      var origA = a,
          origB = b;
      if (b = "-0" === b.toString() ? 0 : b, (opts.optimize || opts.makeRe) && (step = step ? step += "~" : step, expand = !0, regex = !0, sep = "~"), "string" == typeof step) {
        ...
        if (match) {
          ...
          ">" === m ? (step = step.substr(0, i) + step.substr(i + 1), expand = !0) : "|" === m ? (step = step.substr(0, i) + step.substr(i + 1), expand = !0, regex = !0, sep = m) : "~" === m && (step = step.substr(0, i) + step.substr(i + 1), expand = !0, regex = !0, sep = m);
      ...
      var isNum = isNumA,
          num = formatStep(step);
      isNum ? (a = +a, b = +b) : (a = a.charCodeAt(0), b = b.charCodeAt(0));
      var isDescending = a > b;
      (0 > a || 0 > b) && (expand = !1, regex = !1);
      var res,
          pad,
      ...
      if (regex && shouldExpand(a, b, num, isNum, padding, opts))
        return ("|" === sep || "~" === sep) && (sep = detectSeparator(a, b, num, isNum, isDescending)), wrap([origA, origB], sep, opts);
      for (; isDescending ? a >= b : b >= a; )
        padding && isNum && (pad = padding(a)), res = "function" == typeof fn ? fn(a, isNum, pad, ii++) : isNum ? formatPadding(a, pad) : regex && isInvalidChar(a) ? null : String.fromCharCode(a), null !== res && arr.push(res), isDescending ? a -= num : a += num;
      return !regex && !expand || opts.noexpand ? arr : (("|" === sep || "~" === sep) && (sep = detectSeparator(a, b, num, isNum, isDescending)), 1 === arr.length || 0 > a || 0 > b ? arr : wrap(arr, sep, opts));
    }
    function wrap(arr, sep, opts) {
      "~" === sep && (sep = "-");
      var str = arr.join(sep),
          pre = opts && opts.regexPrefix;
      return "|" === sep && (str = pre ? pre + str : str, str = "(" + str + ")"), "-" === sep && (str = pre && "^" === pre ? pre + str : str, str = "[" + str + "]"), [str];
    }
    function isCharClass(a, b, step, isNum, isDescending) {
      return isDescending ? !1 : isNum ? 9 >= a && 9 >= b : b > a ? 1 === step : !1;
    }
    function shouldExpand(a, b, num, isNum, padding, opts) {
      return isNum && (a > 9 || b > 9) ? !1 : !padding && 1 === num && b > a;
    }
    ...
    function formatPadding(ch, pad) {
      ...
      return pad && "-" === ch.toString().charAt(0) && (res = "-" + pad + ch.toString().substr(1)), res.toString();
    }
    ...
    var isObject = __webpack_require__(246),
        ...
        randomize = __webpack_require__(279),
        repeatStr = __webpack_require__(282),
        repeat = __webpack_require__(103);
    ...
    (function(Buffer) {
      ...
      function ctor(options, transform) {
        function FirstChunk(options2) {
          return this instanceof FirstChunk ? (Transform.call(this, options2), this._firstChunk = !0, this._transformCalled = !1, void(this._minSize = options.minSize)) : new FirstChunk(options2);
        }
        if (util.inherits(FirstChunk, Transform), "function" == typeof options && (transform = options, options = {}), "function" != typeof transform)
          throw new Error("transform function required");
        return FirstChunk.prototype._transform = function(chunk, enc, cb) {
          return this._enc = enc, this._firstChunk ? (this._firstChunk = !1, null == this._minSize ? (transform.call(this, chunk, enc, cb), void(this._transformCalled = !0)) : (this._buffer = chunk, void cb())) : null == this._minSize ? (this.push(chunk), void cb()) : this._buffer.length < this._minSize ? (this._buffer = Buffer.concat([this._buffer, chunk]), void cb()) : this._buffer.length >= this._minSize ? (transform.call(this, this._buffer.slice(), enc, function() {
            this.push(chunk), cb();
          }.bind(this)), this._transformCalled = !0, void(this._buffer = !1)) : (this.push(chunk), void cb());
        }, FirstChunk.prototype._flush = function(cb) {
          return this._buffer ? void(this._transformCalled ? (this.push(this._buffer), cb()) : transform.call(this, this._buffer.slice(), this._enc, cb)) : void cb();
        }, FirstChunk;
      }
      var util = __webpack_require__(8),
    ...
    "use strict";
    module.exports = function(o, fn, thisArg) {
      for (var key in o)
        if (fn.call(thisArg, o[key], key, o) === !1)
          break;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    module.exports = function(o, fn, thisArg) {
      forIn(o, function(val, key) {
        return hasOwn.call(o, key) ? fn.call(thisArg, o[key], key, o) : void 0;
      });
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    (function(process) {
      ...
      function globIsSingular(glob) {
        ...
        return 1 !== globSet.length ? !1 : globSet[0].every(function(value) {
          return "string" == typeof value;
        });
      }
      var through2 = __webpack_require__(65),
          Combine = __webpack_require__(272),
          unique = __webpack_require__(307),
          glob = __webpack_require__(85),
          micromatch = __webpack_require__(263),
          resolveGlob = __webpack_require__(305),
          globParent = __webpack_require__(83),
          path = __webpack_require__(5),
          ...
          gs = {
            createStream: function(ourGlob, negatives, opt) {
              function filterNegatives(filename, enc, cb) {
                ...
                negatives.every(matcha) ? cb(null, filename) : cb();
              }
              ourGlob = resolveGlob(ourGlob, opt);
              var ourOpt = extend({}, opt);
              delete ourOpt.root;
              var globber = new glob.Glob(ourGlob, ourOpt),
                  basePath = opt.base || globParent(ourGlob) + path.sep,
                  stream = through2.obj(opt, negatives.length ? filterNegatives : void 0),
                  found = !1;
              return globber.on("error", stream.emit.bind(stream, "error")), globber.once("end", function() {
                opt.allowEmpty !== !0 && !found && globIsSingular(globber) && stream.emit("error", new Error("File not found with singular glob: " + ourGlob)), stream.end();
              }), globber.on("match", function(filename) {
                found = !0, stream.write({
                  cwd: opt.cwd,
                  base: basePath,
                  path: filename
                });
            ...
            create: function(globs, opt) {
              ...
              opt || (opt = {}), "string" != typeof opt.cwd && (opt.cwd = process.cwd()), "boolean" != typeof opt.dot && (opt.dot = !1), "boolean" != typeof opt.silent && (opt.silent = !0), "boolean" != typeof opt.nonull && (opt.nonull = !1), "boolean" != typeof opt.cwdbase && (opt.cwdbase = !1), opt.cwdbase && (opt.base = opt.cwd), Array.isArray(globs) || (globs = [globs]);
              var positives = [],
                  negatives = [],
                  ourOpt = extend({}, opt);
              if (delete ourOpt.root, globs.forEach(function(glob, index) {
                if ("string" != typeof glob && !(glob instanceof RegExp))
                  throw new Error("Invalid glob at index " + index);
                var globArray = isNegative(glob) ? negatives : positives;
                if (globArray === negatives && "string" == typeof glob) {
              ...
              if (1 === positives.length)
                return streamFromPositive(positives[0]);
              var streams = positives.map(streamFromPositive),
                  aggregate = new Combine(streams),
                  uniqueStream = unique("path"),
                  returnStream = aggregate.pipe(uniqueStream);
              return aggregate.on("error", function(err) {
    ...
    (function(process) {
      function globSync(pattern, options) {
        if ("function" == typeof options || 3 === arguments.length)
      ...
      var fs = __webpack_require__(6),
          minimatch = __webpack_require__(55),
          path = (minimatch.Minimatch, __webpack_require__(85).Glob, __webpack_require__(8), __webpack_require__(5)),
          assert = __webpack_require__(41),
          isAbsolute = __webpack_require__(58),
          common = __webpack_require__(84),
          setopts = (common.alphasort, common.alphasorti, common.setopts),
      ...
      GlobSync.prototype._finish = function() {
        ...
        if (entries) {
          ...
          if (0 !== len)
            if (1 !== remain.length || this.mark || this.stat) {
              ...
              for (var i = 0; len > i; i++) {
                var e = matchedEntries[i];
                prefix && (e = "/" !== prefix.slice(-1) ? prefix + "/" + e : prefix + e), "/" !== e.charAt(0) || this.nomount || (e = path.join(this.root, e)), this.matches[index][e] = !0;
              }
            }
        }
        ...
        var isSym = lstat.isSymbolicLink();
        return this.symlinks[abs] = isSym, isSym || lstat.isDirectory() ? entries = this._readdir(abs, !1) : this.cache[abs] = "FILE", entries;
        ...
        var c = stat.isDirectory() ? "DIR" : "FILE";
        return this.cache[abs] = this.cache[abs] || c, needDir && "DIR" !== c ? !1 : c;
    ...
    (function(process) {
      function legacy(fs) {
        function ReadStream(path, options) {
          ...
          for (var keys = Object.keys(options),
              index = 0,
              length = keys.length; length > index; index++) {
            var key = keys[index];
          ...
          return null !== this.fd ? void process.nextTick(function() {
            self._read();
          }) : void fs.open(this.path, this.flags, this.mode, function(err, fd) {
            return err ? (self.emit("error", err), void(self.readable = !1)) : (self.fd = fd, self.emit("open", fd), void self._read());
          });
        }
        function WriteStream(path, options) {
          ...
          this.busy = !1, this._queue = [], null === this.fd && (this._open = fs.open, this._queue.push([this._open, this.path, this.flags, this.mode, void 0]), this.flush());
        }
        return {
    ...
    (function(process) {
      function patch(fs) {
        constants.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && patchLchmod(fs), fs.lutimes || patchLutimes(fs), fs.chown = chownFix(fs.chown), fs.fchown = chownFix(fs.fchown), fs.lchown = chownFix(fs.lchown), fs.chmod = chownFix(fs.chmod), fs.fchmod = chownFix(fs.fchmod), fs.lchmod = chownFix(fs.lchmod), fs.chownSync = chownFixSync(fs.chownSync), fs.fchownSync = chownFixSync(fs.fchownSync), fs.lchownSync = chownFixSync(fs.lchownSync), fs.chmodSync = chownFix(fs.chmodSync), fs.fchmodSync = chownFix(fs.fchmodSync), fs.lchmodSync = chownFix(fs.lchmodSync), fs.lchmod || (fs.lchmod = function(path, mode, cb) {
          process.nextTick(cb);
        }, fs.lchmodSync = function() {}), fs.lchown || (fs.lchown = function(path, uid, gid, cb) {
          process.nextTick(cb);
        }, fs.lchownSync = function() {}), "win32" === process.platform && (fs.rename = function(fs$rename) {
          return function(from, to, cb) {
            var start = Date.now();
            fs$rename(from, to, function CB(er) {
              return er && ("EACCES" === er.code || "EPERM" === er.code) && Date.now() - start < 1e3 ? fs$rename(from, to, CB) : void(cb && cb(er));
            });
          };
        }(fs.rename)), fs.read = function(fs$read) {
          return function(fd, buffer, offset, length, position, callback_) {
            var callback;
            if (callback_ && "function" == typeof callback_) {
              var eagCounter = 0;
              callback = function(er, _, __) {
                return er && "EAGAIN" === er.code && 10 > eagCounter ? (eagCounter++, fs$read.call(fs, fd, buffer, offset, length, position, callback)) : void callback_.apply(this, arguments);
              };
            }
            return fs$read.call(fs, fd, buffer, offset, length, position, callback);
          };
        }(fs.read), fs.readSync = function(fs$readSync) {
          return function(fd, buffer, offset, length, position) {
            for (var eagCounter = 0; ; )
              try {
                return fs$readSync.call(fs, fd, buffer, offset, length, position);
              } catch (er) {
                if ("EAGAIN" === er.code && 10 > eagCounter) {
                  eagCounter++;
                  continue;
                }
                throw er;
      ...
      function patchLchmod(fs) {
        fs.lchmod = function(path, mode, callback) {
          callback = callback || noop, fs.open(path, constants.O_WRONLY | constants.O_SYMLINK, mode, function(err, fd) {
            return err ? void callback(err) : void fs.fchmod(fd, mode, function(err) {
      ...
      function patchLutimes(fs) {
        constants.hasOwnProperty("O_SYMLINK") ? (fs.lutimes = function(path, at, mt, cb) {
          fs.open(path, constants.O_SYMLINK, function(er, fd) {
            return cb = cb || noop, er ? cb(er) : void fs.futimes(fd, at, mt, function(er) {
      ...
      function chownFix(orig) {
        return orig ? function(target, uid, gid, cb) {
          return orig.call(fs, target, uid, gid, function(er, res) {
            chownErOk(er) && (er = null), cb(er, res);
          });
        } : orig;
      }
      ...
      function chownErOk(er) {
        ...
        return !nonroot || "EINVAL" !== er.code && "EPERM" !== er.code ? !1 : !0;
      }
    ...
    var http = __webpack_require__(106),
        https = module.exports;
    for (var key in http)
      http.hasOwnProperty(key) && (https[key] = http[key]);
    https.request = function(params, cb) {
      return params || (params = {}), params.scheme = "https", params.protocol = "https:", http.request.call(this, params, cb);
    };
  }, function(module, exports) {
    ...
    ip.toBuffer = function(ip, buff, offset) {
      ...
      if (this.isV4Format(ip))
        result = buff || new Buffer(offset + 4), ip.split(/\./g).map(function(byte) {
        ...
        for (i = 0; i < sections.length; i++) {
          var v4Buffer,
              isv4 = this.isV4Format(sections[i]);
          isv4 && (v4Buffer = this.toBuffer(sections[i]), sections[i] = v4Buffer.slice(0, 2).toString("hex")), v4Buffer && ++i < 8 && sections.splice(i, 0, v4Buffer.slice(2, 4).toString("hex"));
        }
        if ("" === sections[0])
          for (; sections.length < 8; )
            sections.unshift("0");
      ...
      offset = ~~offset, length = length || buff.length - offset;
      var result = [];
      if (4 === length) {
        for (var i = 0; length > i; i++)
        ...
        result = result.join(":"), result = result.replace(/(^|:)0(:0)*:0(:|$)/, "$1::$3"), result = result.replace(/:{3,4}/, "::");
      }
      return result;
    };
    ...
    ip.isV4Format = function(ip) {
      ...
      var len = 4;
      "ipv6" === family && (len = 16);
      for (var buff = new Buffer(len),
          i = 0,
          n = buff.length; n > i; ++i) {
        var bits = 8;
        8 > prefixlen && (bits = prefixlen), prefixlen -= bits, buff[i] = ~(255 >> bits);
      }
      ...
      else if (4 === mask.length)
        for (var i = 0; i < mask.length; i++)
          result[i] = addr[addr.length - 4 + i] & mask[i];
      else {
        for (var i = 0; i < result.length - 6; i++)
          result[i] = 0;
        result[10] = 255, result[11] = 255;
        for (var i = 0; i < addr.length; i++)
      ...
      var cidrParts = cidrString.split("/"),
          addr = cidrParts[0];
      if (2 !== cidrParts.length)
        throw new Error("invalid CIDR subnet: " + addr);
      var mask = ip.fromPrefixLen(parseInt(cidrParts[1], 10));
      return ip.mask(addr, mask);
    }, ip.subnet = function(addr, mask) {
      for (var networkAddress = ip.toLong(ip.mask(addr, mask)),
          maskBuffer = ip.toBuffer(mask),
          maskLength = 0,
          i = 0; i < maskBuffer.length; i++)
        if (255 === maskBuffer[i])
          maskLength += 8;
        else
          for (var octet = 255 & maskBuffer[i]; octet; )
            octet = octet << 1 & 255, maskLength++;
      var numberOfAddresses = Math.pow(2, 32 - maskLength);
      return {
        networkAddress: ip.fromLong(networkAddress),
        firstAddress: 2 >= numberOfAddresses ? ip.fromLong(networkAddress) : ip.fromLong(networkAddress + 1),
        lastAddress: 2 >= numberOfAddresses ? ip.fromLong(networkAddress + numberOfAddresses - 1) : ip.fromLong(networkAddress + numberOfAddresses - 2),
      ...
      for (var offset = buff.length - other.length,
          i = offset; i < buff.length; ++i)
      ...
      return /^(::f{4}:)?10\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$/.test(addr) || /^(::f{4}:)?192\.168\.([0-9]{1,3})\.([0-9]{1,3})$/.test(addr) || /^(::f{4}:)?172\.(1[6-9]|2\d|30|31)\.([0-9]{1,3})\.([0-9]{1,3})$/.test(addr) || /^(::f{4}:)?127\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$/.test(addr) || /^(::f{4}:)?169\.254\.([0-9]{1,3})\.([0-9]{1,3})$/.test(addr) || /^fc00:/i.test(addr) || /^fe80:/i.test(addr) || /^::1$/.test(addr) || /^::$/.test(addr);
    }, ip.isPublic = function(addr) {
      return !ip.isPrivate(addr);
    }, ip.isLoopback = function(addr) {
      return /^(::f{4}:)?127\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})/.test(addr) || /^fe80::1$/.test(addr) || /^::1$/.test(addr) || /^::$/.test(addr);
    }, ip.loopback = function(family) {
      if (family = _normalizeFamily(family), "ipv4" !== family && "ipv6" !== family)
      ...
      var all = Object.keys(interfaces).map(function(nic) {
        var addresses = interfaces[nic].filter(function(details) {
          return details.family = details.family.toLowerCase(), details.family !== family || ip.isLoopback(details.address) ? !1 : name ? "public" === name ? !ip.isPrivate(details.address) : ip.isPrivate(details.address) : !0;
        });
    ...
    module.exports = function(str) {
      if (46 === str.charCodeAt(0) && -1 === str.indexOf("/", 1))
        return !0;
      var last = str.lastIndexOf("/");
      return -1 !== last ? 46 === str.charCodeAt(last + 1) : !1;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    module.exports = function(a, b) {
      ...
      var key,
          ...
          numKeysB = 0;
      for (key in b)
        if (numKeysB++, !isPrimitive(b[key]) || !a.hasOwnProperty(key) || a[key] !== b[key])
          return !1;
      for (key in a)
        numKeysA++;
    ...
    isStream.writable = function(stream) {
      return isStream(stream) && stream.writable !== !1 && "function" == typeof stream._write && "object" == typeof stream._writableState;
    }, isStream.readable = function(stream) {
      return isStream(stream) && stream.readable !== !1 && "function" == typeof stream._read && "object" == typeof stream._readableState;
    ...
    exports = module.exports = function(bytes) {
      for (var i = 0; i < bytes.length; )
        if (9 == bytes[i] || 10 == bytes[i] || 13 == bytes[i] || 32 <= bytes[i] && bytes[i] <= 126)
          i += 1;
        else if (194 <= bytes[i] && bytes[i] <= 223 && 128 <= bytes[i + 1] && bytes[i + 1] <= 191)
          i += 2;
        else if (224 == bytes[i] && 160 <= bytes[i + 1] && bytes[i + 1] <= 191 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191 || (225 <= bytes[i] && bytes[i] <= 236 || 238 == bytes[i] || 239 == bytes[i]) && 128 <= bytes[i + 1] && bytes[i + 1] <= 191 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191 || 237 == bytes[i] && 128 <= bytes[i + 1] && bytes[i + 1] <= 159 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191)
          i += 3;
        else {
          if (!(240 == bytes[i] && 144 <= bytes[i + 1] && bytes[i + 1] <= 191 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191 && 128 <= bytes[i + 3] && bytes[i + 3] <= 191 || 241 <= bytes[i] && bytes[i] <= 243 && 128 <= bytes[i + 1] && bytes[i + 1] <= 191 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191 && 128 <= bytes[i + 3] && bytes[i + 3] <= 191 || 244 == bytes[i] && 128 <= bytes[i + 1] && bytes[i + 1] <= 143 && 128 <= bytes[i + 2] && bytes[i + 2] <= 191 && 128 <= bytes[i + 3] && bytes[i + 3] <= 191))
            return !1;
          i += 4;
        }
      return !0;
    ...
    function every(arr) {
      for (var len = arr.length; len--; )
        if ("string" != typeof arr[len] || arr[len].length <= 0)
          return !1;
      return !0;
    }
    module.exports = function(glob) {
      return "string" == typeof glob && glob.length > 0 ? !0 : Array.isArray(glob) ? 0 !== glob.length && every(glob) : !1;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var isArray = __webpack_require__(40);
    module.exports = function(o) {
      return null != o && "object" == typeof o && !isArray(o);
    };
  }, function(module, exports) {
    module.exports = {
      O_RDONLY: 0,
    ...
    module.exports = {
      ...
      contributors: ["Travis Person <travis.person@gmail.com>", "Jeromy Jonson <why@ipfs.io>", "David Dias <daviddias@ipfs.io>", "Juan Benet <juanbenet@ipfs.io>", "Friedel Ziegelmayer <dignifiedquire@gmail.com>"],
      license: "MIT",
      bugs: {url: "https://github.com/ipfs/js-ipfs-api/issues"},
      homepage: "https://github.com/ipfs/js-ipfs-api"
    };
  }, function(module, exports, __webpack_require__) {
    var json = "undefined" != typeof JSON ? JSON : __webpack_require__(250);
    module.exports = function(obj, opts) {
      opts || (opts = {}), "function" == typeof opts && (opts = {cmp: opts});
      var space = opts.space || "";
      "number" == typeof space && (space = Array(space + 1).join(" "));
      var cycles = "boolean" == typeof opts.cycles ? opts.cycles : !1,
          replacer = opts.replacer || function(key, value) {
            return value;
          },
      ...
      return function stringify(parent, key, node, level) {
        ...
        if (node && node.toJSON && "function" == typeof node.toJSON && (node = node.toJSON()), node = replacer.call(parent, key, node), void 0 !== node) {
          ...
          seen.push(node);
          for (var keys = objectKeys(node).sort(cmp && cmp(node)),
              out = [],
              i = 0; i < keys.length; i++) {
            var key = keys[i],
        ...
        objectKeys = Object.keys || function(obj) {
          var has = Object.prototype.hasOwnProperty || function() {
            return !0;
              ...
              keys = [];
          for (var key in obj)
            has.call(obj, key) && keys.push(key);
          return keys;
        };
  }, function(module, exports, __webpack_require__) {
    exports.parse = __webpack_require__(251), exports.stringify = __webpack_require__(252);
  }, function(module, exports) {
    var at,
        ch,
        text,
        ...
        object = function() {
          ...
          if ("{" === ch) {
            if (next("{"), white(), "}" === ch)
              return next("}"), object;
            for (; ch; ) {
              if (key = string(), white(), next(":"), Object.hasOwnProperty.call(object, key) && error('Duplicate key "' + key + '"'), object[key] = value(), white(), "}" === ch)
                return next("}"), object;
              next(","), white();
            }
          }
        ...
        case "object":
          ...
          if (rep && "object" == typeof rep)
            for (length = rep.length, i = 0; length > i; i += 1)
              k = rep[i], "string" == typeof k && (v = str(k, value), v && partial.push(quote(k) + (gap ? ": " : ":") + v));
          else
            for (k in value)
    ...
    function arrayMap(array, iteratee) {
      for (var index = -1,
          length = array.length,
          result = Array(length); ++index < length; )
    ...
    function micromatch(files, patterns, opts) {
      if (!files || !patterns)
        return [];
      if (opts = opts || {}, "undefined" == typeof opts.cache && (opts.cache = !0), !Array.isArray(patterns))
        return match(files, patterns, opts);
      for (var len = patterns.length,
          i = 0,
          omit = [],
          keep = []; len--; ) {
        var glob = patterns[i++];
        "string" == typeof glob && 33 === glob.charCodeAt(0) ? omit.push.apply(omit, match(files, glob.slice(1), opts)) : keep.push.apply(keep, match(files, glob, opts));
      }
      return utils.diff(keep, omit);
    }
    function match(files, pattern, opts) {
      if ("string" !== utils.typeOf(files) && !Array.isArray(files))
        throw new Error(msg("match", "files", "a string or array"));
      files = utils.arrayify(files), opts = opts || {};
      var negate = opts.negate || !1,
          orig = pattern;
      "string" == typeof pattern && (negate = "!" === pattern.charAt(0), negate && (pattern = pattern.slice(1)), opts.nonegate === !0 && (negate = !1));
      for (var _isMatch = matcher(pattern, opts),
          len = files.length,
          i = 0,
          res = []; len > i; ) {
        var file = files[i++],
      ...
      if (0 === res.length) {
        ...
        (opts.nonull || opts.nullglob) && res.push(utils.unescapeGlob(orig));
      }
      return negate && (res = utils.diff(files, res)), opts.ignore && opts.ignore.length && (pattern = opts.ignore, opts = utils.omit(opts, ["ignore"]), res = utils.diff(res, micromatch(res, pattern, opts))), opts.nodupes ? utils.unique(res) : res;
    }
    function filter(patterns, opts) {
      if (!Array.isArray(patterns) && "string" != typeof patterns)
        throw new TypeError(msg("filter", "patterns", "a string or array"));
      patterns = utils.arrayify(patterns);
      for (var len = patterns.length,
          i = 0,
          patternMatchers = Array(len); len > i; )
      ...
      return function(fp) {
        ...
        var len = patternMatchers.length,
            i = 0,
            res = !0;
        for (fp = utils.unixify(fp, opts); len > i; ) {
    ...
    function isMatch(fp, pattern, opts) {
      ...
      return fp = utils.unixify(fp, opts), "object" === utils.typeOf(pattern) ? matcher(fp, pattern) : matcher(pattern, opts)(fp);
    }
    function contains(fp, pattern, opts) {
      if ("string" != typeof fp)
        throw new TypeError(msg("contains", "pattern", "a string"));
      return opts = opts || {}, opts.contains = "" !== pattern, fp = utils.unixify(fp, opts), opts.contains && !utils.isGlob(pattern) ? -1 !== fp.indexOf(pattern) : matcher(pattern, opts)(fp);
    }
    function any(fp, patterns, opts) {
      ...
      for (fp = utils.unixify(fp, opts); len--; ) {
    ...
    function matchKeys(obj, glob, options) {
      if ("object" !== utils.typeOf(obj))
        throw new TypeError(msg("matchKeys", "first argument", "an object"));
      var fn = matcher(glob, options),
          res = {};
      for (var key in obj)
        obj.hasOwnProperty(key) && fn(key) && (res[key] = obj[key]);
      return res;
    }
    function matcher(pattern, opts) {
      ...
      if (pattern = utils.unixify(pattern, opts), !utils.isGlob(pattern))
        return utils.matchPath(pattern, opts);
      var re = makeRe(pattern, opts);
      return opts && opts.matchBase ? utils.hasFilename(re, opts) : function(fp) {
        return fp = utils.unixify(fp, opts), re.test(fp);
      };
    }
    function toRegex(glob, options) {
      var opts = Object.create(options || {}),
          flags = opts.flags || "";
      opts.nocase && -1 === flags.indexOf("i") && (flags += "i");
      var parsed = expand(glob, opts);
      opts.negated = opts.negated || parsed.negated, opts.negate = opts.negated, glob = wrapGlob(parsed.pattern, opts);
      var re;
      try {
        return re = new RegExp(glob, flags);
      } catch (err) {
        if (err.reason = "micromatch invalid regex: (" + re + ")", opts.strict)
    ...
    function wrapGlob(glob, opts) {
      var prefix = opts && !opts.contains ? "^" : "",
          after = opts && !opts.contains ? "$" : "";
      return glob = "(?:" + glob + ")" + after, opts && opts.negate ? prefix + ("(?!^" + glob + ").*$") : prefix + glob;
    }
    function makeRe(glob, opts) {
      if ("string" !== utils.typeOf(glob))
    ...
    var expand = __webpack_require__(265),
        utils = __webpack_require__(54);
    micromatch.any = any, micromatch.braces = micromatch.braceExpand = utils.braces, micromatch.contains = contains, micromatch.expand = expand, micromatch.filter = filter, micromatch.isMatch = isMatch, micromatch.makeRe = makeRe, micromatch.match = match, micromatch.matcher = matcher, micromatch.matchKeys = matchKeys, module.exports = micromatch;
  }, function(module, exports) {
    "use strict";
    function reverse(object, prepender) {
      return Object.keys(object).reduce(function(reversed, key) {
        var newKey = prepender ? prepender + key : key;
        return reversed[object[key]] = newKey, reversed;
      }, {});
    }
    var unesc,
        temp,
    ...
    chars.escapeRegex = {
      ...
      "[": "__UNESC_LTBRACK__",
      "]": "__UNESC_RTBRACK__"
    }, chars.UNESC = unesc || (unesc = reverse(chars.ESC, "\\")), chars.ESC_TEMP = {
      "?": "__TEMP_QMRK__",
      "@": "__TEMP_AMPE__",
      "!": "__TEMP_EXCL__",
      "*": "__TEMP_STAR__",
      ...
      "[": "__TEMP_LTBRACK__",
      "]": "__TEMP_RTBRACK__"
    }, chars.TEMP = temp || (temp = reverse(chars.ESC_TEMP)), module.exports = chars;
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function expand(pattern, options) {
      ...
      if (!utils.isGlob(pattern))
        return glob.pattern = glob.pattern.replace(/([\/.])/g, "\\$1"), glob;
      if (glob.pattern = glob.pattern.replace(/(\+)(?!\()/g, "\\$1"), glob.pattern = glob.pattern.split("$").join("\\$"), "boolean" != typeof opts.braces && "boolean" != typeof opts.nobraces && (opts.braces = !0), ".*" === glob.pattern)
        return {
          pattern: "\\." + star,
          tokens: tok,
          options: opts
      ...
      glob.parse();
      var tok = glob.tokens;
      return tok.is.negated = opts.negated, opts.dotfiles !== !0 && !tok.is.dotfile || opts.dot === !1 || (opts.dotfiles = !0, opts.dot = !0), opts.dotdirs !== !0 && !tok.is.dotdir || opts.dot === !1 || (opts.dotdirs = !0, opts.dot = !0), /[{,]\./.test(glob.pattern) && (opts.makeRe = !1, opts.dot = !0), opts.nonegate !== !0 && (opts.negated = glob.negated), "." === glob.pattern.charAt(0) && "/" !== glob.pattern.charAt(1) && (glob.pattern = "\\" + glob.pattern), glob.track("before braces"), tok.is.braces && glob.braces(), glob.track("after braces"), glob.track("before extglob"), tok.is.extglob && glob.extglob(), glob.track("after extglob"), glob.track("before brackets"), tok.is.brackets && glob.brackets(), glob.track("after brackets"), glob._replace("[!", "[^"), glob._replace("(?", "(%~"), glob._replace(/\[\]/, "\\[\\]"), glob._replace("/[", "/" + (opts.dot ? dotfiles : nodot) + "[", !0), glob._replace("/?", "/" + (opts.dot ? dotfiles : nodot) + "[^/]", !0), glob._replace("/.", "/(?=.)\\.", !0), glob._replace(/^(\w):([\\\/]+?)/gi, "(?=.)$1:$2", !0), -1 !== glob.pattern.indexOf("[^") && (glob.pattern = negateSlash(glob.pattern)), opts.globstar !== !1 && "**" === glob.pattern ? glob.pattern = globstar(opts.dot) : (glob._replace(/(\/\*)+/g, function(match) {
        var len = match.length / 2;
        return 1 === len ? match : "(?:\\/*){" + len + "}";
      }), glob.pattern = balance(glob.pattern, "[", "]"), glob.escape(glob.pattern), tok.is.globstar && (glob.pattern = collapse(glob.pattern, "/**"), glob.pattern = collapse(glob.pattern, "**/"), glob._replace("/**/", "(?:/" + globstar(opts.dot) + "/|/)", !0), glob._replace(/\*{2,}/g, "**"), glob._replace(/(\w+)\*(?!\/)/g, "$1[^/]*?", !0), glob._replace(/\*\*\/\*(\w)/g, globstar(opts.dot) + "\\/" + (opts.dot ? dotfiles : nodot) + "[^/]*?$1", !0), opts.dot !== !0 && glob._replace(/\*\*\/(.)/g, "(?:**\\/|)$1"), ("" !== tok.path.dirname || /,\*\*|\*\*,/.test(glob.orig)) && glob._replace("**", globstar(opts.dot), !0)), glob._replace(/\/\*$/, "\\/" + oneStar(opts.dot), !0), glob._replace(/(?!\/)\*$/, star, !0), glob._replace(/([^\/]+)\*/, "$1" + oneStar(!0), !0), glob._replace("*", oneStar(opts.dot), !0), glob._replace("?.", "?\\.", !0), glob._replace("?:", "?:", !0), glob._replace(/\?+/g, function(match) {
        var len = match.length;
        return 1 === len ? qmark : qmark + "{" + len + "}";
      }), glob._replace(/\.([*\w]+)/g, "\\.$1"), glob._replace(/\[\^[\\\/]+\]/g, qmark), glob._replace(/\/+/g, "\\/"), glob._replace(/\\{2,}/g, "\\")), glob.unescape(glob.pattern), glob._replace("__UNESC_STAR__", "*"), glob._replace("?.", "?\\."), glob._replace("[^\\/]", qmark), glob.pattern.length > 1 && /^[\[?*]/.test(glob.pattern) && (glob.pattern = (opts.dot ? dotfiles : nodot) + glob.pattern), glob;
    }
    function collapse(str, ch) {
      var res = str.split(ch),
          isFirst = "" === res[0],
          isLast = "" === res[res.length - 1];
      return res = res.filter(Boolean), isFirst && res.unshift(""), isLast && res.push(""), res.join(ch);
    }
    function negateSlash(str) {
      return str.replace(/\[\^([^\]]*?)\]/g, function(match, inner) {
        return -1 === inner.indexOf("/") && (inner = "\\/" + inner), "[^" + inner + "]";
      });
    }
    function balance(str, a, b) {
      var aarr = str.split(a),
          alen = aarr.join("").length,
          blen = str.split(b).join("").length;
      return alen !== blen ? (str = aarr.join("\\" + a), str.split(b).join("\\" + b)) : str;
    }
    ...
    var chars = __webpack_require__(264),
        utils = __webpack_require__(54),
        Glob = module.exports = function Glob(pattern, options) {
          return this instanceof Glob ? (this.options = options || {}, this.pattern = pattern, this.history = [], this.tokens = {}, void this.init(pattern)) : new Glob(pattern, options);
        };
    Glob.prototype.init = function(pattern) {
      this.orig = pattern, this.negated = this.isNegated(), this.options.track = this.options.track || !1, this.options.makeRe = !0;
      ...
      return 33 === this.pattern.charCodeAt(0) ? (this.pattern = this.pattern.slice(1), !0) : !1;
    }, Glob.prototype.braces = function() {
      if (this.options.nobraces !== !0 && this.options.nobrace !== !0) {
        var a = this.pattern.match(/[\{\(\[]/g),
            b = this.pattern.match(/[\}\)\]]/g);
        a && b && a.length !== b.length && (this.options.makeRe = !1);
        var expanded = utils.braces(this.pattern, this.options);
        this.pattern = expanded.join("|");
      }
    }, Glob.prototype.brackets = function() {
      this.options.nobrackets !== !0 && (this.pattern = utils.brackets(this.pattern));
    }, Glob.prototype.extglob = function() {
      this.options.noextglob !== !0 && utils.isExtglob(this.pattern) && (this.pattern = utils.extglob(this.pattern, {escape: !0}));
    }, Glob.prototype.parse = function(pattern) {
      return this.tokens = utils.parseGlob(pattern || this.pattern, !0), this.tokens;
    }, Glob.prototype._replace = function(a, b, escape) {
      this.track('before (find): "' + a + '" (replace with): "' + b + '"'), escape && (b = esc(b)), a && b && "string" == typeof a ? this.pattern = this.pattern.split(a).join(b) : this.pattern = this.pattern.replace(a, b), this.track("after");
      ...
      this.pattern = str.replace(re, function($0, $1) {
        var o = chars.ESC,
            ch = o && o[$1];
        return ch ? ch : /[a-z]/i.test($0) ? $0.split("\\").join("") : $0;
    ...
    (function(Buffer) {
      function stringToStringTuples(str) {
        ...
        if (1 === parts.length && "" === parts[0])
          return [];
        for (var p = 0; p < parts.length; p++) {
          var part = parts[p],
              proto = protocols(part);
          if (0 === proto.size)
            return [part];
          if (p++, p >= parts.length)
      ...
      function stringTuplesToString(tuples) {
        ...
        return map(tuples, function(tup) {
          ...
          parts.push(proto.name), tup.length > 1 && parts.push(tup[1]);
        }), "/" + parts.join("/");
      }
      function stringTuplesToTuples(tuples) {
        return map(tuples, function(tup) {
          var proto = protoFromTuple(tup);
          return tup.length > 1 ? [proto.code, convert.toBuffer(proto.code, tup[1])] : [proto.code];
        });
      }
      function tuplesToStringTuples(tuples) {
        return map(tuples, function(tup) {
          var proto = protoFromTuple(tup);
          return tup.length > 1 ? [proto.code, convert.toString(proto.code, tup[1])] : [proto.code];
        });
      }
      function tuplesToBuffer(tuples) {
        return fromBuffer(Buffer.concat(map(tuples, function(tup) {
          var proto = protoFromTuple(tup),
              buf = new Buffer([proto.code]);
          return tup.length > 1 && (buf = Buffer.concat([buf, tup[1]])), buf;
        })));
      }
      ...
      function bufferToString(buf) {
        var a = bufferToTuples(buf),
            b = tuplesToStringTuples(a);
        return stringTuplesToString(b);
      }
      function stringToBuffer(str) {
        str = cleanPath(str);
        var a = stringToStringTuples(str),
            b = stringTuplesToTuples(a);
      ...
      function protoFromTuple(tup) {
        ...
        if (tup.length > 1 && 0 === proto.size)
          throw ParseError("tuple has address but protocol size is 0");
        return proto;
      }
      var map = __webpack_require__(53),
          filter = __webpack_require__(259),
          convert = __webpack_require__(268),
          protocols = __webpack_require__(56);
      module.exports = {
    ...
    (function(Buffer) {
      function Convert(proto, a) {
        return a instanceof Buffer ? Convert.toString(proto, a) : Convert.toBuffer(proto, a);
      }
      function port2buf(port) {
        var buf = new Buffer(2);
        return buf.writeUInt16BE(port, 0), buf;
      }
      function buf2port(buf) {
        return buf.readUInt16BE(0);
      }
      var ip = __webpack_require__(239),
          protocols = __webpack_require__(56);
      module.exports = Convert, Convert.toString = function(proto, buf) {
        switch (proto = protocols(proto), proto.code) {
          case 4:
          case 41:
      ...
      }, Convert.toBuffer = function(proto, str) {
        switch (proto = protocols(proto), proto.code) {
          case 4:
          case 41:
    ...
    (function(Buffer) {
      function Multiaddr(addr) {
        ...
        if (addr || (addr = ""), addr instanceof Buffer)
          this.buffer = codec.fromBuffer(addr);
        else if ("string" == typeof addr || addr instanceof String)
          this.buffer = codec.fromString(addr);
        else {
          if (!(addr.buffer && addr.protos && addr.protoCodes))
      ...
      var map = __webpack_require__(53),
          extend = __webpack_require__(17),
          codec = __webpack_require__(267),
          bufeq = __webpack_require__(161),
          protocols = __webpack_require__(56),
          NotImplemented = new Error("Sorry, Not Implemented Yet.");
      exports = module.exports = Multiaddr, exports.Buffer = Buffer, Multiaddr.prototype.toString = function() {
        return codec.bufferToString(this.buffer);
      }, Multiaddr.prototype.toOptions = function() {
        var opts = {},
            parsed = this.toString().split("/");
        return opts.family = "ip4" === parsed[1] ? "ipv4" : "ipv6", opts.host = parsed[2], opts.port = parsed[4], opts;
      }, Multiaddr.prototype.inspect = function() {
        return "<Mutliaddr " + this.buffer.toString("hex") + " - " + codec.bufferToString(this.buffer) + ">";
      }, Multiaddr.prototype.protos = function() {
      ...
      }, Multiaddr.prototype.protoCodes = function() {
        for (var codes = [],
            i = 0; i < this.buffer.length; i++) {
          var code = 0 + this.buffer[i],
              size = protocols(code).size / 8;
          i += size, codes.push(code);
        }
        return codes;
      }, Multiaddr.prototype.protoNames = function() {
        return map(this.protos(), function(proto) {
          return proto.name;
        });
      }, Multiaddr.prototype.tuples = function() {
        return codec.bufferToTuples(this.buffer);
      }, Multiaddr.prototype.stringTuples = function() {
        var t = codec.bufferToTuples(this.buffer);
        return codec.tuplesToStringTuples(t);
      }, Multiaddr.prototype.encapsulate = function(addr) {
        return addr = Multiaddr(addr), Multiaddr(this.toString() + addr.toString());
      }, Multiaddr.prototype.decapsulate = function(addr) {
        addr = addr.toString();
        var s = this.toString(),
            i = s.lastIndexOf(addr);
        if (0 > i)
          throw new Error("Address " + this + " does not contain subaddress: " + addr);
        return Multiaddr(s.slice(0, i));
      }, Multiaddr.prototype.equals = function(addr) {
        return bufeq(this.buffer, addr.buffer);
      }, Multiaddr.prototype.nodeAddress = function() {
        if (!this.isThinWaistAddress())
          throw new Error('Multiaddr must be "thin waist" address for nodeAddress.');
        var codes = this.protoCodes(),
            parts = this.toString().split("/").slice(1);
        return {
          family: 41 === codes[0] ? "IPv6" : "IPv4",
          address: parts[1],
          port: parts[3]
        };
      }, Multiaddr.fromNodeAddress = function(addr, transport) {
        if (!addr)
          throw new Error("requires node address object");
        if (!transport)
          throw new Error("requires transport protocol");
        var ip = "IPv6" === addr.family ? "ip6" : "ip4";
        return Multiaddr("/" + [ip, addr.address, transport, addr.port].join("/"));
      }, Multiaddr.prototype.isThinWaistAddress = function(addr) {
        var protos = (addr || this).protos();
        return 2 !== protos.length ? !1 : 4 !== protos[0].code && 41 !== protos[0].code ? !1 : 6 !== protos[1].code && 17 !== protos[1].code ? !1 : !0;
      }, Multiaddr.prototype.fromStupidString = function(str) {
    ...
    module.exports = function(str, stripTrailing) {
      ...
      return str = str.replace(/[\\\/]+/g, "/"), stripTrailing !== !1 && (str = str.replace(/\/$/, "")), str;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var isObject = __webpack_require__(88),
        forOwn = __webpack_require__(229);
    module.exports = function(obj, keys) {
      ...
      var fn,
          ...
          res = {};
      "function" == typeof last && (fn = keys.pop());
      var isFunction = "function" == typeof fn;
      return keys.length || isFunction ? (forOwn(obj, function(value, key) {
        -1 === keys.indexOf(key) && (isFunction ? fn(value, key, obj) && (res[key] = value) : res[key] = value);
      }), res) : obj;
    };
  }, function(module, exports, __webpack_require__) {
    function addStream(streams, stream) {
      ...
      var self = this;
      stream._buffer = [], stream.on("readable", function() {
        var chunk = stream.read();
        null !== chunk && (this === streams[0] ? self.push(chunk) : this._buffer.push(chunk));
      }), stream.on("end", function() {
        for (var stream = streams[0]; stream && stream._readableState.ended; stream = streams[0]) {
          for (; stream._buffer.length; )
            self.push(stream._buffer.shift());
          streams.shift();
        }
        streams.length || self.push(null);
      }), stream.on("error", this.emit.bind(this, "error")), streams.push(stream);
    }
    function OrderedStreams(streams, options) {
      if (!(this instanceof OrderedStreams))
        return new OrderedStreams(streams, options);
      if (streams = streams || [], options = options || {}, options.objectMode = !0, Readable.call(this, options), Array.isArray(streams) || (streams = [streams]), !streams.length)
        return this.push(null);
      var addStream_bind = addStream.bind(this, []);
      streams.forEach(function(item) {
        Array.isArray(item) ? item.forEach(addStream_bind) : addStream_bind(item);
      });
    }
    var Readable = __webpack_require__(102),
        isReadable = __webpack_require__(243).readable,
        util = __webpack_require__(8);
    util.inherits(OrderedStreams, Readable), OrderedStreams.prototype._read = function() {}, module.exports = OrderedStreams;
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function dotdir(base) {
      return -1 !== base.indexOf("/.") ? !0 : "." === base.charAt(0) && "/" !== base.charAt(1) ? !0 : !1;
    }
    function has(is, glob, ch) {
      return is && -1 !== glob.indexOf(ch);
    }
    function escape(str) {
      var re = /\{([^{}]*?)}|\(([^()]*?)\)|\[([^\[\]]*?)\]/g;
      return str.replace(re, function(outter, braces, parens, brackets) {
        var inner = braces || parens || brackets;
        return inner ? outter.split(inner).join(esc(inner)) : outter;
      });
    }
    function esc(str) {
      return str = str.split("/").join("__SLASH__"), str = str.split(".").join("__DOT__");
    }
    function unescape(str) {
      return str = str.split("__SLASH__").join("/"), str = str.split("__DOT__").join(".");
    }
    var isGlob = __webpack_require__(39),
        findBase = __webpack_require__(230),
        extglob = __webpack_require__(38),
        dotfile = __webpack_require__(241),
        cache = module.exports.cache = {};
    module.exports = function(glob) {
      if (cache.hasOwnProperty(glob))
        return cache[glob];
      var tok = {};
      tok.orig = glob, tok.is = {}, glob = escape(glob);
      var parsed = findBase(glob);
      tok.is.glob = parsed.isGlob, tok.glob = parsed.glob, tok.base = parsed.base;
      var segs = /([^\/]*)$/.exec(glob);
      tok.path = {}, tok.path.dirname = "", tok.path.basename = segs[1] || "", tok.path.dirname = glob.split(tok.path.basename).join("") || "";
      var basename = (tok.path.basename || "").split(".") || "";
      tok.path.filename = basename[0] || "", tok.path.extname = basename.slice(1).join(".") || "", tok.path.ext = "", isGlob(tok.path.dirname) && !tok.path.basename && (/\/$/.test(tok.glob) || (tok.path.basename = tok.glob), tok.path.dirname = tok.base), -1 !== glob.indexOf("/") || tok.is.globstar || (tok.path.dirname = "", tok.path.basename = tok.orig);
      var dot = tok.path.basename.indexOf(".");
      if (-1 !== dot && (tok.path.filename = tok.path.basename.slice(0, dot), tok.path.extname = tok.path.basename.slice(dot)), "." === tok.path.extname.charAt(0)) {
        var exts = tok.path.extname.split(".");
        tok.path.ext = exts[exts.length - 1];
      }
      tok.glob = unescape(tok.glob), tok.path.dirname = unescape(tok.path.dirname), tok.path.basename = unescape(tok.path.basename), tok.path.filename = unescape(tok.path.filename), tok.path.extname = unescape(tok.path.extname);
      var is = glob && tok.is.glob;
      return tok.is.negated = glob && "!" === glob.charAt(0), tok.is.extglob = glob && extglob(glob), tok.is.braces = has(is, glob, "{"), tok.is.brackets = has(is, glob, "[:"), tok.is.globstar = has(is, glob, "**"), tok.is.dotfile = dotfile(tok.path.basename) || dotfile(tok.path.filename), tok.is.dotdir = dotdir(tok.path.dirname), cache[glob] = tok;
    };
  }, function(module, exports, __webpack_require__) {
    (function(Buffer) {
      module.exports = function(crypto) {
        function pbkdf2(password, salt, iterations, keylen, digest, callback) {
          if ("function" == typeof digest && (callback = digest, digest = void 0), "function" != typeof callback)
        ...
        function pbkdf2Sync(password, salt, iterations, keylen, digest) {
          ...
          digest = digest || "sha1", Buffer.isBuffer(password) || (password = new Buffer(password)), Buffer.isBuffer(salt) || (salt = new Buffer(salt));
          var hLen,
              r,
              T,
              l = 1,
          ...
          for (var i = 1; l >= i; i++) {
            ...
            if (!hLen && (hLen = U.length, T = new Buffer(hLen), l = Math.ceil(keylen / hLen), r = keylen - (l - 1) * hLen, keylen > (Math.pow(2, 32) - 1) * hLen))
              throw new TypeError("keylen exceeds maximum length");
            U.copy(T, 0, 0, hLen);
            for (var j = 1; iterations > j; j++) {
              U = crypto.createHmac(digest, password).update(U).digest();
              for (var k = 0; hLen > k; k++)
                T[k] ^= U[k];
            }
    ...
    exports.before = function(str, re) {
      return str.replace(re, function(match) {
        var id = randomize();
        return cache[id] = match, "__ID" + id + "__";
      });
    ...
    "use strict";
    exports.decode = exports.parse = __webpack_require__(276), exports.encode = exports.stringify = __webpack_require__(277);
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function randomatic(pattern, length, options) {
      ...
      var custom = !1;
      1 === arguments.length && ("string" == typeof pattern ? length = pattern.length : isNumber(pattern) && (options = {}, length = pattern, pattern = "*")), "object" === typeOf(length) && length.hasOwnProperty("chars") && (options = length, pattern = options.chars, length = pattern.length, custom = !0);
      var opts = options || {},
          mask = "",
          res = "";
      for (-1 !== pattern.indexOf("?") && (mask += opts.chars), -1 !== pattern.indexOf("a") && (mask += type.lower), -1 !== pattern.indexOf("A") && (mask += type.upper), -1 !== pattern.indexOf("0") && (mask += type.number), -1 !== pattern.indexOf("!") && (mask += type.special), -1 !== pattern.indexOf("*") && (mask += type.all), custom && (mask += pattern); length--; )
        res += mask.charAt(parseInt(Math.random() * mask.length, 10));
      return res;
    }
    var isNumber = __webpack_require__(89),
        typeOf = __webpack_require__(51);
    ...
    function regexCache(fn, str, opts) {
      var regex,
          ...
          key = "_default_";
      if (!str && !opts)
        return "function" != typeof fn ? fn : basic[key] || (basic[key] = fn());
      var isString = "string" == typeof str;
      if (isString) {
        if (!opts)
        ...
        opts = str;
      return cached = cache[key], cached && equal(cached.opts, opts) ? cached.regex : (memo(key, opts, regex = fn(str, opts)), regex);
    }
    ...
    var equal = (__webpack_require__(90), __webpack_require__(242));
    module.exports = regexCache;
    var cache = module.exports.cache = {},
        basic = module.exports.basic = {};
  }, function(module, exports) {
    "use strict";
    function repeat(str, num) {
      ...
      for ((cache !== str || "undefined" == typeof cache) && (cache = str, res = ""); max > res.length && num > 0 && (1 & num && (res += str), num >>= 1); )
        str += str;
    ...
    (function(Buffer) {
      ...
      function ripemd160(message) {
        ...
        m[nBitsLeft >>> 5] |= 128 << 24 - nBitsLeft % 32, m[(nBitsLeft + 64 >>> 9 << 4) + 14] = 16711935 & (nBitsTotal << 8 | nBitsTotal >>> 24) | 4278255360 & (nBitsTotal << 24 | nBitsTotal >>> 8);
    ...
    __webpack_require__(3).PassThrough;
    SandwichStream.prototype = Object.create(Readable.prototype, {constructor: SandwichStream}), SandwichStream.prototype._read = function() {
      this._streamsActive || (this._streamsActive = !0, this._pushHead(), this._streamNextStream());
      ...
      this._streamsAdded = !0, this._streams.push(newStream), newStream.on("error", this._substreamOnError.bind(this));
    }, SandwichStream.prototype._substreamOnError = function(error) {
      this._errorsEmitted = !0, this.emit("error", error);
    }, SandwichStream.prototype._pushHead = function() {
      this._head && this.push(this._head);
    }, SandwichStream.prototype._streamNextStream = function() {
      this._nextStream() ? this._bindCurrentStreamEvents() : (this._pushTail(), this.push(null));
    }, SandwichStream.prototype._nextStream = function() {
      return this._currentStream = this._streams.shift(), void 0 !== this._currentStream;
    }, SandwichStream.prototype._bindCurrentStreamEvents = function() {
      this._currentStream.on("readable", this._currentStreamOnReadable.bind(this)), this._currentStream.on("end", this._currentStreamOnEnd.bind(this));
      ...
      this._pushSeparator(), this._streamNextStream();
    }, SandwichStream.prototype._pushSeparator = function() {
      this._streams.length > 0 && this._separator && this.push(this._separator);
    }, SandwichStream.prototype._pushTail = function() {
      this._tail && this.push(this._tail);
    }, sandwichStream.SandwichStream = SandwichStream, module.exports = sandwichStream;
  }, function(module, exports) {
    module.exports = function(Buffer) {
      function Hash(blockSize, finalSize) {
        this._block = new Buffer(blockSize), this._finalSize = finalSize, this._blockSize = blockSize, this._len = 0, this._s = 0;
      }
      return Hash.prototype.init = function() {
        ...
        for (var l = this._len += data.length,
            s = this._s = this._s || 0,
            f = 0,
            buffer = this._block; l > s; ) {
          for (var t = Math.min(data.length, f + this._blockSize - s % this._blockSize),
              ch = t - f,
              i = 0; ch > i; i++)
            buffer[s % this._blockSize + i] = data[i + f];
          s += ch, f += ch, s % this._blockSize === 0 && this._update(buffer);
        }
        return this._s = s, this;
      }, Hash.prototype.digest = function(enc) {
        var l = 8 * this._len;
        this._block[this._len % this._blockSize] = 128, this._block.fill(0, this._len % this._blockSize + 1), l % (8 * this._blockSize) >= 8 * this._finalSize && (this._update(this._block), this._block.fill(0)), this._block.writeInt32BE(l, this._blockSize - 4);
    ...
    var exports = module.exports = function(alg) {
      ...
      return new Alg;
        ...
        Buffer = __webpack_require__(1).Buffer,
        Hash = __webpack_require__(286)(Buffer);
    exports.sha1 = __webpack_require__(288)(Buffer, Hash), exports.sha256 = __webpack_require__(289)(Buffer, Hash), exports.sha512 = __webpack_require__(290)(Buffer, Hash);
  }, function(module, exports, __webpack_require__) {
    ...
    module.exports = function(Buffer, Hash) {
      ...
      var A = 0,
          ...
          POOL = [];
      return inherits(Sha1, Hash), Sha1.prototype.init = function() {
        return this._a = 1732584193, this._b = 4023233417, this._c = 2562383102, this._d = 271733878, this._e = 3285377520, Hash.prototype.init.call(this), this;
      }, Sha1.prototype._POOL = POOL, Sha1.prototype._update = function(X) {
        var a,
            b,
            c,
            d,
            ...
            _d,
            _e;
        a = _a = this._a, b = _b = this._b, c = _c = this._c, d = _d = this._d, e = _e = this._e;
        for (var w = this._w,
            j = 0; 80 > j; j++) {
          var W = w[j] = 16 > j ? X.readInt32BE(4 * j) : rol(w[j - 3] ^ w[j - 8] ^ w[j - 14] ^ w[j - 16], 1),
              t = add(add(rol(a, 5), sha1_ft(j, b, c, d)), add(add(e, W), sha1_kt(j)));
          e = d, d = c, c = rol(b, 30), b = a, a = t;
        }
        this._a = add(a, _a), this._b = add(b, _b), this._c = add(c, _c), this._d = add(d, _d), this._e = add(e, _e);
      }, Sha1.prototype._hash = function() {
        POOL.length < 100 && POOL.push(this);
        var H = new Buffer(20);
        return H.writeInt32BE(0 | this._a, A), H.writeInt32BE(0 | this._b, B), H.writeInt32BE(0 | this._c, C), H.writeInt32BE(0 | this._d, D), H.writeInt32BE(0 | this._e, E), H;
      }, Sha1;
    };
  }, function(module, exports, __webpack_require__) {
    var inherits = __webpack_require__(8).inherits;
    module.exports = function(Buffer, Hash) {
      ...
      var K = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298],
          W = new Array(64);
      return inherits(Sha256, Hash), Sha256.prototype.init = function() {
        ...
        var a,
            ...
            T2,
            W = this._w;
        a = 0 | this._a, b = 0 | this._b, c = 0 | this._c, d = 0 | this._d, e = 0 | this._e, f = 0 | this._f, g = 0 | this._g, h = 0 | this._h;
        for (var j = 0; 64 > j; j++) {
          var w = W[j] = 16 > j ? M.readInt32BE(4 * j) : Gamma1256(W[j - 2]) + W[j - 7] + Gamma0256(W[j - 15]) + W[j - 16];
          T1 = h + Sigma1256(e) + Ch(e, f, g) + K[j] + w, T2 = Sigma0256(a) + Maj(a, b, c), h = g, g = f, f = e, e = d + T1, d = c, c = b, b = a, a = T1 + T2;
        }
    ...
    module.exports = function(Buffer, Hash) {
      ...
      var K = [1116352408, 3609767458, 1899447441, 602891725, 3049323471, 3964484399, 3921009573, 2173295548, 961987163, 4081628472, 1508970993, 3053834265, 2453635748, 2937671579, 2870763221, 3664609560, 3624381080, 2734883394, 310598401, 1164996542, 607225278, 1323610764, 1426881987, 3590304994, 1925078388, 4068182383, 2162078206, 991336113, 2614888103, 633803317, 3248222580, 3479774868, 3835390401, 2666613458, 4022224774, 944711139, 264347078, 2341262773, 604807628, 2007800933, 770255983, 1495990901, 1249150122, 1856431235, 1555081692, 3175218132, 1996064986, 2198950837, 2554220882, 3999719339, 2821834349, 766784016, 2952996808, 2566594879, 3210313671, 3203337956, 3336571891, 1034457026, 3584528711, 2466948901, 113926993, 3758326383, 338241895, 168717936, 666307205, 1188179964, 773529912, 1546045734, 1294757372, 1522805485, 1396182291, 2643833823, 1695183700, 2343527390, 1986661051, 1014477480, 2177026350, 1206759142, 2456956037, 344077627, 2730485921, 1290863460, 2820302411, 3158454273, 3259730800, 3505952657, 3345764771, 106217008, 3516065817, 3606008344, 3600352804, 1432725776, 4094571909, 1467031594, 275423344, 851169720, 430227734, 3100823752, 506948616, 1363258195, 659060556, 3750685593, 883997877, 3785050280, 958139571, 3318307427, 1322822218, 3812723403, 1537002063, 2003034995, 1747873779, 3602036899, 1955562222, 1575990012, 2024104815, 1125592928, 2227730452, 2716904306, 2361852424, 442776044, 2428436474, 593698344, 2756734187, 3733110249, 3204031479, 2999351573, 3329325298, 3815920427, 3391569614, 3928383900, 3515267271, 566280711, 3940187606, 3454069534, 4118630271, 4000239992, 116418474, 1914138554, 174292421, 2731055270, 289380356, 3203993006, 460393269, 320620315, 685471733, 587496836, 852142971, 1086792851, 1017036298, 365543100, 1126000580, 2618297676, 1288033470, 3409855158, 1501505948, 4234509866, 1607167915, 987167468, 1816402316, 1246189591],
          W = new Array(160);
      return inherits(Sha512, Hash), Sha512.prototype.init = function() {
        ...
        var a,
            ...
            hl,
            W = this._w;
        a = 0 | this._a, b = 0 | this._b, c = 0 | this._c, d = 0 | this._d, e = 0 | this._e, f = 0 | this._f, g = 0 | this._g, h = 0 | this._h, al = 0 | this._al, bl = 0 | this._bl, cl = 0 | this._cl, dl = 0 | this._dl, el = 0 | this._el, fl = 0 | this._fl, gl = 0 | this._gl, hl = 0 | this._hl;
        for (var i = 0; 80 > i; i++) {
          var Wi,
              Wil,
              j = 2 * i;
          if (16 > i)
            Wi = W[j] = M.readInt32BE(4 * j), Wil = W[j + 1] = M.readInt32BE(4 * j + 4);
          else {
            var x = W[j - 30],
                xl = W[j - 30 + 1],
            ...
            var gamma1 = S(x, xl, 19) ^ S(xl, x, 29) ^ x >>> 6,
                ...
                Wi16 = W[j - 32],
                Wi16l = W[j - 32 + 1];
            Wil = gamma0l + Wi7l, Wi = gamma0 + Wi7 + (gamma0l >>> 0 > Wil >>> 0 ? 1 : 0), Wil += gamma1l, Wi = Wi + gamma1 + (gamma1l >>> 0 > Wil >>> 0 ? 1 : 0), Wil += Wi16l, Wi = Wi + Wi16 + (Wi16l >>> 0 > Wil >>> 0 ? 1 : 0), W[j] = Wi, W[j + 1] = Wil;
          }
          var maj = Maj(a, b, c),
              majl = Maj(al, bl, cl),
          ...
          t1l += chl, t1 = t1 + ch + (chl >>> 0 > t1l >>> 0 ? 1 : 0), t1l += Kil, t1 = t1 + Ki + (Kil >>> 0 > t1l >>> 0 ? 1 : 0), t1l += Wil, t1 = t1 + Wi + (Wil >>> 0 > t1l >>> 0 ? 1 : 0);
          var t2l = sigma0l + majl,
              t2 = sigma0h + maj + (sigma0l >>> 0 > t2l >>> 0 ? 1 : 0);
          h = g, hl = gl, g = f, gl = fl, f = e, fl = el, el = dl + t1l | 0, e = d + t1 + (dl >>> 0 > el >>> 0 ? 1 : 0) | 0, d = c, dl = cl, c = b, cl = bl, b = a, bl = al, al = t1l + t2l | 0, a = t1 + t2 + (t1l >>> 0 > al >>> 0 ? 1 : 0) | 0;
        }
        this._al = this._al + al | 0, this._bl = this._bl + bl | 0, this._cl = this._cl + cl | 0, this._dl = this._dl + dl | 0, this._el = this._el + el | 0, this._fl = this._fl + fl | 0, this._gl = this._gl + gl | 0, this._hl = this._hl + hl | 0, this._a = this._a + a + (this._al >>> 0 < al >>> 0 ? 1 : 0) | 0, this._b = this._b + b + (this._bl >>> 0 < bl >>> 0 ? 1 : 0) | 0, this._c = this._c + c + (this._cl >>> 0 < cl >>> 0 ? 1 : 0) | 0, this._d = this._d + d + (this._dl >>> 0 < dl >>> 0 ? 1 : 0) | 0, this._e = this._e + e + (this._el >>> 0 < el >>> 0 ? 1 : 0) | 0, this._f = this._f + f + (this._fl >>> 0 < fl >>> 0 ? 1 : 0) | 0, this._g = this._g + g + (this._gl >>> 0 < gl >>> 0 ? 1 : 0) | 0, this._h = this._h + h + (this._hl >>> 0 < hl >>> 0 ? 1 : 0) | 0;
      }, Sha512.prototype._hash = function() {
        function writeInt64BE(h, l, offset) {
          H.writeInt32BE(h, offset), H.writeInt32BE(l, offset + 4);
        }
        var H = new Buffer(64);
        return writeInt64BE(this._a, this._al, 0), writeInt64BE(this._b, this._bl, 8), writeInt64BE(this._c, this._cl, 16), writeInt64BE(this._d, this._dl, 24), writeInt64BE(this._e, this._el, 32), writeInt64BE(this._f, this._fl, 40), writeInt64BE(this._g, this._gl, 48), writeInt64BE(this._h, this._hl, 56), H;
      }, Sha512;
    };
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function transform(chunk, enc, cb) {
      var i,
          list = chunk.toString("utf8").split(this.matcher),
          remaining = list.pop();
      for (list.length >= 1 ? push(this, this.mapper(this._last + list.shift())) : remaining = this._last + remaining, i = 0; i < list.length; i++)
        push(this, this.mapper(list[i]));
      this._last = remaining, cb();
    }
    function flush(cb) {
      this._last && push(this, this.mapper(this._last)), cb();
    }
    ...
    function split(matcher, mapper, options) {
      "object" != typeof matcher || matcher instanceof RegExp || (options = matcher, matcher = null), "function" == typeof matcher && (mapper = matcher, matcher = null), options = options || {};
      var stream = through(options, transform, flush);
      return stream._readableState.objectMode = !0, stream._last = "", stream.matcher = matcher || /\r?\n/, stream.mapper = mapper || noop, stream;
    }
    var through = __webpack_require__(65);
    ...
    exports = module.exports = __webpack_require__(105), exports.Stream = __webpack_require__(3), exports.Readable = exports, exports.Writable = __webpack_require__(63), exports.Duplex = __webpack_require__(16), exports.Transform = __webpack_require__(62), exports.PassThrough = __webpack_require__(104);
  }, function(module, exports, __webpack_require__) {
    ...
    (function(Buffer, global, process) {
      ...
      var capability = __webpack_require__(107),
          inherits = __webpack_require__(4),
          response = __webpack_require__(298),
          stream = __webpack_require__(3),
          toArrayBuffer = __webpack_require__(306),
          IncomingMessage = response.IncomingMessage,
          rStates = response.readyStates,
          ClientRequest = module.exports = function(opts) {
            var self = this;
            stream.Writable.call(self), self._opts = opts, self._body = [], self._headers = {}, opts.auth && self.setHeader("Authorization", "Basic " + new Buffer(opts.auth).toString("base64")), Object.keys(opts.headers).forEach(function(name) {
              self.setHeader(name, opts.headers[name]);
            });
            var preferBinary;
            if ("prefer-streaming" === opts.mode)
              preferBinary = !1;
            else if ("allow-wrong-content-type" === opts.mode)
              preferBinary = !capability.overrideMimeType;
            else {
              if (opts.mode && "default" !== opts.mode && "prefer-fast" !== opts.mode)
      ...
      inherits(ClientRequest, stream.Writable), ClientRequest.prototype.setHeader = function(name, value) {
        ...
        if (!self._destroyed) {
          ...
          if (("POST" === opts.method || "PUT" === opts.method || "PATCH" === opts.method) && (body = capability.blobConstructor ? new global.Blob(self._body.map(function(buffer) {
          ...
          }), {type: (headersObj["content-type"] || {}).value || ""}) : Buffer.concat(self._body).toString()), "fetch" === self._mode) {
            ...
            "responseType" in xhr && (xhr.responseType = self._mode.split(":")[0]), "withCredentials" in xhr && (xhr.withCredentials = !!opts.withCredentials), "text" === self._mode && "overrideMimeType" in xhr && xhr.overrideMimeType("text/plain; charset=x-user-defined"), Object.keys(headersObj).forEach(function(name) {
        ...
        var self = this;
        statusValid(self._xhr) && !self._destroyed && (self._response || self._connect(), self._response._onXHRProgress());
      }, ClientRequest.prototype._connect = function() {
        var self = this;
        self._destroyed || (self._response = new IncomingMessage(self._xhr, self._fetchResponse, self._mode), self.emit("response", self._response));
          ...
          IncomingMessage = exports.IncomingMessage = function(xhr, response, mode) {
            ...
            if (stream.Readable.call(self), self._mode = mode, self.headers = {}, self.rawHeaders = [], self.trailers = {}, self.rawTrailers = [], self.on("end", function() {
              ...
              for (var header,
                ...
                self.headers[header[0].toLowerCase()] = header[1], self.rawHeaders.push(header[0], header[1]);
              ...
              if (headers.forEach(function(header) {
                ...
                if (matches) {
                  ...
                  void 0 !== self.headers[key] ? self.headers[key] += ", " + matches[2] : self.headers[key] = matches[2], self.rawHeaders.push(matches[1], matches[2]);
                }
        ...
        switch (self._mode) {
          ...
          case "text":
            ...
            if (response.length > self._pos) {
              ...
              if ("x-user-defined" === self._charset) {
                for (var buffer = new Buffer(newData.length),
          ...
          case "ms-stream":
            ...
            reader.onprogress = function() {
              reader.result.byteLength > self._pos && (self.push(new Buffer(new Uint8Array(reader.result.slice(self._pos)))), self._pos = reader.result.byteLength);
    ...
    }).call(exports, __webpack_require__(2), __webpack_require__(1).Buffer, function() {
      return this;
    }());
  }, function(module, exports, __webpack_require__) {
    "use strict";
    var firstChunk = __webpack_require__(227),
        stripBom = __webpack_require__(64);
    module.exports = function() {
      return firstChunk({minSize: 3}, function(chunk, enc, cb) {
        this.push(stripBom(chunk)), cb();
      });
    };
  }, function(module, exports, __webpack_require__) {
    (function(process) {
    ...
    (function(process) {
      ...
      function readableAddChunk(stream, state, chunk, encoding, addToFront) {
        ...
        if (er)
          stream.emit("error", er);
        else if (null === chunk || void 0 === chunk)
          state.reading = !1, state.ended || onEofChunk(stream, state);
        else if (state.objectMode || chunk && chunk.length > 0)
          if (state.ended && !addToFront) {
            var e = new Error("stream.push() after EOF");
            ...
            !state.decoder || addToFront || encoding || (chunk = state.decoder.write(chunk)), state.length += state.objectMode ? 1 : chunk.length, addToFront ? state.buffer.unshift(chunk) : (state.reading = !1, state.buffer.push(chunk)), state.needReadable && emitReadable(stream), maybeReadMore(stream, state);
        else
          addToFront || (state.reading = !1);
        return needMoreData(state);
      }
      ...
      function howMuchToRead(n, state) {
        return 0 === state.length && state.ended ? 0 : state.objectMode ? 0 === n ? 0 : 1 : null === n || isNaN(n) ? state.flowing && state.buffer.length ? state.buffer[0].length : state.length : 0 >= n ? 0 : (n > state.highWaterMark && (state.highWaterMark = roundUpToNextPowerOf2(n)), n > state.length ? state.ended ? state.length : (state.needReadable = !0, 0) : n);
      }
      function chunkInvalid(state, chunk) {
        var er = null;
        return Buffer.isBuffer(chunk) || "string" == typeof chunk || null === chunk || void 0 === chunk || state.objectMode || (er = new TypeError("Invalid non-string/buffer chunk")), er;
      ...
      function maybeReadMore_(stream, state) {
        for (var len = state.length; !state.reading && !state.flowing && !state.ended && state.length < state.highWaterMark && (stream.read(0), len !== state.length); )
          len = state.length;
        state.readingMore = !1;
      }
      function pipeOnDrain(src) {
      ...
      function flow(src) {
        ...
        for (state.awaitDrain = 0; state.pipesCount && null !== (chunk = src.read()); )
          if (1 === state.pipesCount ? write(state.pipes, 0, null) : forEach(state.pipes, write), src.emit("data", chunk), state.awaitDrain > 0)
            return;
        return 0 === state.pipesCount ? (state.flowing = !1, void(EE.listenerCount(src, "data") > 0 && emitDataEvents(src))) : void(state.ranOut = !0);
      }
      ...
      function emitDataEvents(stream, startPaused) {
        ...
        var paused = startPaused || !1,
            readable = !1;
        stream.readable = !0, stream.pipe = Stream.prototype.pipe, stream.on = stream.addListener = Stream.prototype.on, stream.on("readable", function() {
          readable = !0;
          for (var c; !paused && null !== (c = stream.read()); )
            stream.emit("data", c);
      ...
      util.inherits(Readable, Stream), Readable.prototype.push = function(chunk, encoding) {
        var state = this._readableState;
        return "string" != typeof chunk || state.objectMode || (encoding = encoding || state.defaultEncoding, encoding !== state.encoding && (chunk = new Buffer(chunk, encoding), encoding = "")), readableAddChunk(this, state, chunk, encoding, !1);
      }, Readable.prototype.unshift = function(chunk) {
        var state = this._readableState;
        return readableAddChunk(this, state, chunk, "", !0);
      }, Readable.prototype.setEncoding = function(enc) {
        StringDecoder || (StringDecoder = __webpack_require__(23).StringDecoder), this._readableState.decoder = new StringDecoder(enc), this._readableState.encoding = enc;
      };
      var MAX_HWM = 8388608;
      Readable.prototype.read = function(n) {
        var state = this._readableState;
        ...
        function cleanup() {
          dest.removeListener("close", onclose), dest.removeListener("finish", onfinish), dest.removeListener("drain", ondrain), dest.removeListener("error", onerror), dest.removeListener("unpipe", onunpipe), src.removeListener("end", onend), src.removeListener("end", cleanup), (!dest._writableState || dest._writableState.needDrain) && ondrain();
        }
        function onerror(er) {
        ...
        state.endEmitted ? process.nextTick(endFn) : src.once("end", endFn), dest.on("unpipe", onunpipe);
        var ondrain = pipeOnDrain(src);
        return dest.on("drain", ondrain), dest._events && dest._events.error ? isArray(dest._events.error) ? dest._events.error.unshift(onerror) : dest._events.error = [onerror, dest._events.error] : dest.on("error", onerror), dest.once("close", onclose), dest.once("finish", onfinish), dest.emit("pipe", src), state.flowing || (this.on("readable", pipeOnReadable), state.flowing = !0, process.nextTick(function() {
          flow(src);
        })), dest;
      }, Readable.prototype.unpipe = function(dest) {
        var state = this._readableState;
        if (0 === state.pipesCount)
          return this;
        if (1 === state.pipesCount)
          return dest && dest !== state.pipes ? this : (dest || (dest = state.pipes), state.pipes = null, state.pipesCount = 0, this.removeListener("readable", pipeOnReadable), state.flowing = !1, dest && dest.emit("unpipe", this), this);
        if (!dest) {
          var dests = state.pipes,
              len = state.pipesCount;
          state.pipes = null, state.pipesCount = 0, this.removeListener("readable", pipeOnReadable), state.flowing = !1;
          for (var i = 0; len > i; i++)
            dests[i].emit("unpipe", this);
          return this;
        }
        ...
        if ("data" !== ev || this._readableState.flowing || emitDataEvents(this), "readable" === ev && this.readable) {
          var state = this._readableState;
          state.readableListening || (state.readableListening = !0, state.emittedReadable = !1, state.needReadable = !0, state.reading ? state.length && emitReadable(this, state) : this.read(0));
        }
        return res;
      }, Readable.prototype.addListener = Readable.prototype.on, Readable.prototype.resume = function() {
        ...
        for (var i in stream)
          "function" == typeof stream[i] && "undefined" == typeof this[i] && (this[i] = function(method) {
            return function() {
              return stream[method].apply(stream, arguments);
            };
          }(i));
    ...
    function Transform(options) {
      ...
      var stream = (this._transformState = new TransformState(options, this), this);
    ...
    function done(stream, er) {
      if (er)
        return stream.emit("error", er);
      var ws = stream._writableState,
          ts = (stream._readableState, stream._transformState);
      if (ws.length)
        throw new Error("calling transform done when ws.length != 0");
      if (ts.transforming)
        throw new Error("calling transform done when still transforming");
    ...
    (function(process) {
      ...
      function WritableState(options, stream) {
        options = options || {};
        var hwm = options.highWaterMark;
        this.highWaterMark = hwm || 0 === hwm ? hwm : 16384, this.objectMode = !!options.objectMode, this.highWaterMark = ~~this.highWaterMark, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1;
        var noDecode = options.decodeStrings === !1;
        this.decodeStrings = !noDecode, this.defaultEncoding = options.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(er) {
          onwrite(stream, er);
      ...
      function writeOrBuffer(stream, state, chunk, encoding, cb) {
        ...
        state.length += len;
        var ret = state.length < state.highWaterMark;
        return ret || (state.needDrain = !0), state.writing ? state.buffer.push(new WriteReq(chunk, encoding, cb)) : doWrite(stream, state, len, chunk, encoding, cb), ret;
      }
      function doWrite(stream, state, len, chunk, encoding, cb) {
        state.writelen = len, state.writecb = cb, state.writing = !0, state.sync = !0, stream._write(chunk, encoding, state.onwrite), state.sync = !1;
      }
      function onwriteError(stream, state, sync, er, cb) {
        sync ? process.nextTick(function() {
          cb(er);
      ...
      function onwrite(stream, er) {
        ...
        if (onwriteStateUpdate(state), er)
          ...
          var finished = needFinish(stream, state);
          finished || state.bufferProcessing || !state.buffer.length || clearBuffer(stream, state), sync ? process.nextTick(function() {
            afterWrite(stream, state, finished, cb);
          }) : afterWrite(stream, state, finished, cb);
        }
      }
      function afterWrite(stream, state, finished, cb) {
        finished || onwriteDrain(stream, state), cb(), finished && finishMaybe(stream, state);
      }
      function onwriteDrain(stream, state) {
        0 === state.length && state.needDrain && (state.needDrain = !1, stream.emit("drain"));
      }
      ...
      util.inherits(Writable, Stream), Writable.prototype.pipe = function() {
        ...
        var state = this._writableState,
            ret = !1;
        return "function" == typeof encoding && (cb = encoding, encoding = null), Buffer.isBuffer(chunk) ? encoding = "buffer" : encoding || (encoding = state.defaultEncoding), "function" != typeof cb && (cb = function() {}), state.ended ? writeAfterEnd(this, state, cb) : validChunk(this, state, chunk, cb) && (ret = writeOrBuffer(this, state, chunk, encoding, cb)), ret;
      }, Writable.prototype._write = function(chunk, encoding, cb) {
        cb(new Error("not implemented"));
      }, Writable.prototype.end = function(chunk, encoding, cb) {
        var state = this._writableState;
        "function" == typeof chunk ? (cb = chunk, chunk = null, encoding = null) : "function" == typeof encoding && (cb = encoding, encoding = null), "undefined" != typeof chunk && null !== chunk && this.write(chunk, encoding), state.ending || state.finished || endWritable(this, state, cb);
      };
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    ...
    (function(process) {
      "use strict";
      var path = __webpack_require__(5),
          extend = __webpack_require__(222);
      module.exports = function(glob, options) {
        ...
        var prefix = glob.charAt(0),
            suffix = glob.slice(-1),
            isNegative = "!" === prefix;
        return isNegative && (glob = glob.slice(1)), glob = opts.root && "/" === glob.charAt(0) ? path.join(path.resolve(opts.root), "." + glob) : path.resolve(opts.cwd, glob), "/" === suffix && "/" !== glob.slice(-1) && (glob += "/"), isNegative ? "!" + glob : glob;
      };
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    var Buffer = __webpack_require__(1).Buffer;
    module.exports = function(buf) {
      if (buf instanceof Uint8Array) {
        if (0 === buf.byteOffset && buf.byteLength === buf.buffer.byteLength)
          return buf.buffer;
        if ("function" == typeof buf.buffer.slice)
          return buf.buffer.slice(buf.byteOffset, buf.byteOffset + buf.byteLength);
      }
      if (Buffer.isBuffer(buf)) {
        for (var arrayCopy = new Uint8Array(buf.length),
            len = buf.length,
            i = 0; len > i; i++)
          arrayCopy[i] = buf[i];
    ...
    (function(global) {
      ...
      function unique(propName, keyStore) {
        ...
        var keyfn = stringify;
        return "string" == typeof propName ? keyfn = prop(propName) : "function" == typeof propName && (keyfn = propName), filter(function(data) {
          var key = keyfn(data);
          return keyStore.has(key) ? !1 : (keyStore.add(key), !0);
        });
      }
      var ES6Set,
          filter = __webpack_require__(108).obj,
          stringify = __webpack_require__(249);
      ES6Set = "function" == typeof global.Set ? global.Set : function() {
        this.keys = [], this.has = function(val) {
          return -1 !== this.keys.indexOf(val);
      ...
      !function(root) {
        ...
        function ucs2decode(string) {
          for (var value,
              ...
              output = [],
              counter = 0,
              length = string.length; length > counter; )
            value = string.charCodeAt(counter++), value >= 55296 && 56319 >= value && length > counter ? (extra = string.charCodeAt(counter++), 56320 == (64512 & extra) ? output.push(((1023 & value) << 10) + (1023 & extra) + 65536) : (output.push(value), counter--)) : output.push(value);
          return output;
        }
        ...
        function decode(input) {
          var out,
              ...
              n = initialN,
              bias = initialBias;
          for (basic = input.lastIndexOf(delimiter), 0 > basic && (basic = 0), j = 0; basic > j; ++j)
            input.charCodeAt(j) >= 128 && error("not-basic"), output.push(input.charCodeAt(j));
          for (index = basic > 0 ? basic + 1 : 0; inputLength > index; ) {
            for (oldi = i, w = 1, k = base; index >= inputLength && error("invalid-input"), digit = basicToDigit(input.charCodeAt(index++)), (digit >= base || digit > floor((maxInt - i) / w)) && error("overflow"), i += digit * w, t = bias >= k ? tMin : k >= bias + tMax ? tMax : k - bias, !(t > digit); k += base)
        ...
        function encode(input) {
          var n,
              ...
              qMinusT,
              output = [];
          for (input = ucs2decode(input), inputLength = input.length, n = initialN, delta = 0, bias = initialBias, j = 0; inputLength > j; ++j)
            currentValue = input[j], 128 > currentValue && output.push(stringFromCharCode(currentValue));
          for (handledCPCount = basicLength = output.length, basicLength && output.push(delimiter); inputLength > handledCPCount; ) {
            for (m = maxInt, j = 0; inputLength > j; ++j)
              currentValue = input[j], currentValue >= n && m > currentValue && (m = currentValue);
            for (handledCPCountPlusOne = handledCPCount + 1, m - n > floor((maxInt - delta) / handledCPCountPlusOne) && error("overflow"), delta += (m - n) * handledCPCountPlusOne, n = m, j = 0; inputLength > j; ++j)
              if (currentValue = input[j], n > currentValue && ++delta > maxInt && error("overflow"), currentValue == n) {
                for (q = delta, k = base; t = bias >= k ? tMin : k >= bias + tMax ? tMax : k - bias, !(t > q); k += base)
    ...
    }).call(exports, __webpack_require__(334)(module), function() {
      return this;
    }());
  }, function(module, exports) {
    (function(global) {
    ...
    module.exports = {
      ...
      dest: __webpack_require__(312),
      symlink: __webpack_require__(325)
    };
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      "use strict";
      function dest(outFolder, opt) {
        function saveFile(file, enc, cb) {
          prepareWrite(outFolder, file, opt, function(err, writePath) {
            return err ? cb(err) : void writeContents(writePath, file, cb);
          });
        }
        opt || (opt = {});
        ...
        var mapStream = sourcemaps.write(opt.sourcemaps.path, opt.sourcemaps),
            outputStream = duplexify.obj(mapStream, saveStream);
        return mapStream.pipe(saveStream), outputStream;
      }
      var through2 = __webpack_require__(30),
          sourcemaps = process.browser ? null : __webpack_require__(87),
          duplexify = __webpack_require__(37),
          prepareWrite = __webpack_require__(111),
          writeContents = __webpack_require__(313);
      module.exports = dest;
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    "use strict";
    function writeContents(writePath, file, cb) {
      ...
      function written(err) {
        return isErrorFatal(err) ? complete(err) : !file.stat || "number" != typeof file.stat.mode || file.symlink ? complete() : void fs.stat(writePath, function(err, st) {
          if (err)
            return complete(err);
          var currentMode = st.mode & parseInt("0777", 8),
              expectedMode = file.stat.mode & parseInt("0777", 8);
          return currentMode === expectedMode ? complete() : void fs.chmod(writePath, expectedMode, complete);
        });
      }
      function isErrorFatal(err) {
        return err ? "EEXIST" === err.code && "wx" === file.flag ? !1 : !0 : !1;
      }
      return file.isDirectory() ? writeDir(writePath, file, written) : file.isStream() ? writeStream(writePath, file, written) : file.symlink ? writeSymbolicLink(writePath, file, written) : file.isBuffer() ? writeBuffer(writePath, file, written) : file.isNull() ? complete() : void 0;
    }
    var fs = __webpack_require__(6),
        writeDir = __webpack_require__(315),
        writeStream = __webpack_require__(316),
        writeBuffer = __webpack_require__(314),
        writeSymbolicLink = __webpack_require__(317);
    ...
    var mkdirp = __webpack_require__(94);
    ...
    (function(process) {
      ...
      function writeStream(writePath, file, cb) {
        ...
        function complete(err) {
          file.contents.removeListener("error", cb), outStream.removeListener("error", cb), outStream.removeListener("finish", success), cb(err);
        }
        var opt = {
          mode: file.stat.mode,
          flag: file.flag
        },
            outStream = fs.createWriteStream(writePath, opt);
        file.contents.once("error", complete), outStream.once("error", complete), outStream.once("finish", success), file.contents.pipe(outStream);
      }
      var streamFile = __webpack_require__(112),
          fs = __webpack_require__(process.browser ? 6 : 13);
    ...
    (function(process) {
      ...
      function writeSymbolicLink(writePath, file, cb) {
        fs.symlink(file.symlink, writePath, function(err) {
          return err && "EEXIST" !== err.code ? cb(err) : void cb(null, file);
        });
      }
      var fs = __webpack_require__(process.browser ? 6 : 13);
    ...
    module.exports = function(d) {
      var isValid = "number" == typeof d || d instanceof Number || d instanceof Date;
      if (!isValid)
    ...
    (function(process) {
      ...
      function bufferFile(file, opt, cb) {
        fs.readFile(file.path, function(err, data) {
          return err ? cb(err) : (opt.stripBOM ? file.contents = stripBom(data) : file.contents = data, void cb(null, file));
        });
      }
      var fs = __webpack_require__(process.browser ? 6 : 13),
          stripBom = __webpack_require__(64);
    ...
    function getContents(opt) {
      return through2.obj(function(file, enc, cb) {
        return file.isDirectory() ? readDir(file, opt, cb) : file.stat && file.stat.isSymbolicLink() ? readSymbolicLink(file, opt, cb) : opt.buffer !== !1 ? bufferFile(file, opt, cb) : streamFile(file, opt, cb);
      });
    }
    var through2 = __webpack_require__(30),
        readDir = __webpack_require__(321),
        readSymbolicLink = __webpack_require__(322),
        bufferFile = __webpack_require__(319),
        streamFile = __webpack_require__(112);
    ...
    (function(process) {
      ...
      function readLink(file, opt, cb) {
        fs.readlink(file.path, function(err, target) {
          return err ? cb(err) : (file.symlink = target, cb(null, file));
        });
      }
      var fs = __webpack_require__(process.browser ? 6 : 13);
    ...
    (function(process) {
      ...
      function src(glob, opt) {
        ...
        var globStream = gs.create(glob, options),
            outputStream = globStream.pipe(resolveSymlinks(options)).pipe(through.obj(createFile));
        return null != options.since && (outputStream = outputStream.pipe(filterSince(options.since))), options.read !== !1 && (outputStream = outputStream.pipe(getContents(options))), options.passthrough === !0 && (inputPass = through.obj(), outputStream = duplexify.obj(inputPass, merge(outputStream, inputPass))), options.sourcemaps === !0 && (outputStream = outputStream.pipe(sourcemaps.init({loadMaps: !0}))), globStream.on("error", outputStream.emit.bind(outputStream, "error")), outputStream;
      }
      var assign = __webpack_require__(97),
          through = __webpack_require__(30),
          gs = __webpack_require__(231),
          File = __webpack_require__(66),
          duplexify = __webpack_require__(37),
          merge = __webpack_require__(93),
          sourcemaps = process.browser ? null : __webpack_require__(87),
          filterSince = __webpack_require__(318),
          isValidGlob = __webpack_require__(245),
          getContents = __webpack_require__(320),
          resolveSymlinks = __webpack_require__(324);
      module.exports = src;
    }).call(exports, __webpack_require__(2));
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      ...
      function resolveSymlinks(options) {
        function resolveFile(globFile, enc, cb) {
          fs.lstat(globFile.path, function(err, stat) {
            return err ? cb(err) : (globFile.stat = stat, stat.isSymbolicLink() && options.followSymlinks ? void fs.realpath(globFile.path, function(err, filePath) {
              return err ? cb(err) : (globFile.base = path.dirname(filePath), globFile.path = filePath, void resolveFile(globFile, enc, cb));
            }) : cb(null, globFile));
          });
        }
      ...
      function symlink(outFolder, opt) {
        function linkFile(file, enc, cb) {
          var srcPath = file.path,
              symType = file.isDirectory() ? "dir" : "file";
          prepareWrite(outFolder, file, opt, function(err, writePath) {
            return err ? cb(err) : void fs.symlink(srcPath, writePath, symType, function(err) {
              return err && "EEXIST" !== err.code ? cb(err) : void cb(null, file);
            });
          });
        }
    ...
    function collect(stream, cb) {
      function get(name) {
        return files.named[name] || (files.named[name] = {children: []}), files.named[name];
      }
      var files = {
        paths: [],
        named: {},
      ...
      stream.on("data", function(file) {
        if (null === cb)
          return void stream.on("data", function() {});
        if (file.path) {
          var fo = get(file.path);
          fo.file = file;
          var po = get(Path.dirname(file.path));
          fo !== po && po.children.push(fo), files.paths.push(file.path);
        } else
          files.unnamed.push({
            file: file,
            children: []
        ...
        cb && cb(null, files), cb = null;
      });
    }
    var Path = __webpack_require__(5);
    module.exports = collect;
  }, function(module, exports, __webpack_require__) {
    var flat = __webpack_require__(328),
        tree = __webpack_require__(329),
        x = module.exports = tree;
    x.flat = flat, x.tree = tree;
  }, function(module, exports, __webpack_require__) {
    function v2mpFlat(opts) {
      opts = opts || {}, opts.boundary = opts.boundary || randomString();
      var w = new stream.Writable({objectMode: !0}),
          r = new stream.PassThrough({objectMode: !0}),
          mp = new Multipart(opts.boundary);
      ...
      return out.boundary = opts.boundary, out;
    }
    function writePart(mp, file, cb) {
      var c = file.contents;
      null === c && (c = emptyStream()), mp.addPart({
        body: file.contents,
        headers: headersForFile(file)
      }), cb(null);
    }
    function emptyStream() {
      var s = new stream.PassThrough({objectMode: !0});
      return s.write(null), s;
    }
    function headersForFile(file) {
      var fpath = common.cleanPath(file.path, file.base),
          h = {};
      return h["Content-Disposition"] = 'file; filename="' + fpath + '"', file.isDirectory() ? h["Content-Type"] = "text/directory" : h["Content-Type"] = "application/octet-stream", h;
    }
    function randomString() {
      return Math.random().toString(36).slice(2) + Math.random().toString(36).slice(2) + Math.random().toString(36).slice(2) + Math.random().toString(36).slice(2);
    }
    var Multipart = __webpack_require__(95),
        duplexify = __webpack_require__(37),
        stream = __webpack_require__(3),
        common = __webpack_require__(113);
    randomString = common.randomString, module.exports = v2mpFlat;
  }, function(module, exports, __webpack_require__) {
    function v2mpTree(opts) {
      opts = opts || {}, opts.boundary = opts.boundary || randomString();
      var r = new stream.PassThrough({objectMode: !0}),
          w = new stream.PassThrough({objectMode: !0}),
          out = duplexify.obj(w, r);
      return out.boundary = opts.boundary, collect(w, function(err, files) {
        if (err)
          return void r.emit("error", err);
        try {
          var mp = streamForCollection(opts.boundary, files);
          out.multipartHdr = "Content-Type: multipart/mixed; boundary=" + mp.boundary, opts.writeHeader && (r.write(out.multipartHdr + "\r\n"), r.write("\r\n")), mp.pipe(r);
        } catch (e) {
          r.emit("error", e);
        }
      }), out;
    ...
    function streamForCollection(boundary, files) {
      ...
      if (0 == parts.length) {
        ...
        return s.boundary = boundary, s;
      }
      for (var mp = new Multipart(boundary),
          i = 0; i < parts.length; i++)
        mp.addPart(parts[i]);
      return mp;
    }
    ...
    function streamForPath(files, path) {
      ...
      if (o.file)
        return o.done ? null : (o.done = !0, streamForWrapped(files, o));
    }
    function streamForWrapped(files, f) {
      return f.file.isDirectory() ? multipartForDir(files, f) : f.file.contents;
    }
    function multipartForDir(files, dir) {
      if (dir.boundary = randomString(), !dir.children || dir.children.length < 1)
        return streamForString("--" + dir.boundary + "--\r\n");
      for (var mp = new Multipart(dir.boundary),
          i = 0; i < dir.children.length; i++) {
    ...
    function headersForFile(o) {
      var fpath = common.cleanPath(o.file.path, o.file.base),
          h = {};
      return h["Content-Disposition"] = 'file; filename="' + fpath + '"', o.file.isDirectory() ? h["Content-Type"] = "multipart/mixed; boundary=" + o.boundary : h["Content-Type"] = "application/octet-stream", h;
    }
    var Multipart = __webpack_require__(95),
        duplexify = __webpack_require__(37),
        stream = __webpack_require__(3),
        collect = (__webpack_require__(5), __webpack_require__(326)),
        common = __webpack_require__(113),
    ...
    module.exports = function(buf) {
      ...
      return buf.copy(out), out;
    };
  }, function(module, exports, __webpack_require__) {
    var isStream = __webpack_require__(114);
    module.exports = function(stream) {
      if (isStream(stream)) {
        var streamType = stream.constructor.name;
        return "Stream" === streamType && (streamType = ""), "<" + streamType + "Stream>";
      }
    };
  }, function(module, exports, __webpack_require__) {
