  ...
  require = (function e(t, n, r) {
    ...
    32: [function(require, module, exports) {
      ...
      if (typeof Meteor !== 'undefined' && Meteor.isServer) {
        ...
        XMLHttpRequest = require('../lib/utils/browser-xhr').XMLHttpRequest;
      }
    ...
    35: [function(require, module, exports) {
      ...
      Jsonrpc.prototype.isValidResponse = function(response) {
        return !!response && !response.error && response.jsonrpc === '2.0' && typeof response.id === 'number' && response.result !== undefined;
      };
