...
class CampaignStepFiveComponent extends Component {
  constructor(props) {
    super(props);
  }
...
const CampaignStepFive = connect(mapStateToProps)(CampaignStepFiveComponent);

export default CampaignStepFive;
